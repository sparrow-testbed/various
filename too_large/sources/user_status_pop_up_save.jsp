...
//  	String password             = JSPUtil.paramCheck(JSPUtil.CheckInjection(request.getParameter("password")    ));
...
//	String E2E_password		  	= JSPUtil.paramCheck(JSPUtil.CheckInjection(request.getParameter("E2E_password")    ));
...
//	String phone_no             = JSPUtil.paramCheck(JSPUtil.CheckInjection(request.getParameter("phone_no_1"))) + JSPUtil.paramCheck(JSPUtil.CheckInjection(request.getParameter("phone_no_2"))) + JSPUtil.paramCheck(JSPUtil.CheckInjection(request.getParameter("phone_no_3")));
...
//	String mobile_no            = JSPUtil.paramCheck(JSPUtil.CheckInjection(request.getParameter("mobile_no_1"))) + JSPUtil.paramCheck(JSPUtil.CheckInjection(request.getParameter("mobile_no_2"))) + JSPUtil.paramCheck(JSPUtil.CheckInjection(request.getParameter("mobile_no_3")));
	String mobile_no            = JSPUtil.paramCheck(JSPUtil.CheckInjection(request.getParameter("mobile_no_0")));
//	String fax_no               = JSPUtil.paramCheck(JSPUtil.CheckInjection(request.getParameter("fax_no_1"))) + JSPUtil.paramCheck(JSPUtil.CheckInjection(request.getParameter("fax_no_2"))) + JSPUtil.paramCheck(JSPUtil.CheckInjection(request.getParameter("fax_no_3")));
	...
	String language             = "KO";//JSPUtil.paramCheck(JSPUtil.CheckInjection(request.getParameter("language")              ));
	...
	String country              = "KR";//JSPUtil.paramCheck(JSPUtil.CheckInjection(request.getParameter("country")               ));
	...
	String uc_yn                = JSPUtil.paramCheck(JSPUtil.CheckInjection(request.getParameter("uc_yn")     ));
...
*/
	...
	SepoaOut value = ServiceConnector.doService(info, "AD_132", "TRANSACTION","setUserInfoUpdate", obj);
