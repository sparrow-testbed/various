...
<%
	...
	String gb = request.getParameter("gb");//1:전자입찰,2:전자구매
...
$(document).ready(function(){
	...
	<%if("login_fail".equals(prev_url)){%>
		...
		window.location.href = "/common/idpwd_local.jsp";
...
<BODY topmargin="10" leftmargin="0" style="text-align:center;"" onload="cookie_Cehck();">
...
<input type="hidden" name="login_type"       id="login_type"          value="BD"  />
<table width="420" border="0" cellspacing="10" cellpadding="0" bgcolor="#0083ca" style="width:420px; height:337px">
  <tr>
    <td bgcolor="#FFFFFF"><table width="400" style="height:182px" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="258" align="center" style="height:54px"><br />          <img src="../images/intro/login_title.gif" width="350" height="49" /></td>
      </tr>
      <tr>
        <td style="height:15px"></td>
      </tr>
      <tr>
        <td align="center" valign="top" style="height:107px"><table width="350" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td colspan="2" style="background:#ececec; height:2px"></td>
          </tr>
          <tr>
            <td height="15" colspan="2"><font color="red" style="font-size:9px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;* 비밀번호는 대소문자를 구분하여 입력해주십시오.</font></td>
          </tr>
          <tr>
            <td width="56" height="40" align="right"><img src="../images/intro/txt_id.gif" width="43" height="12" /></td>
            <td height="29" align="right"><input type="text" name="user_id" id="user_id"  style="width:290px; height:25px" onkeyup="check_cookie();" onkeydown="enter_event('id');" data-enc="on" /></td>
          </tr>
          <tr>
            <td height="40" align="right"><img src="../images/intro/txt_pw.gif" width="54" height="12" /></td>
            <td height="29" align="right"><input type="password" name="password" id="password" style="width:290px; height:25px"  onkeydown="enter_event('pass');" data-enc="on" /></td>
          </tr>
          <tr>
            <td height="29" align="right">&nbsp;</td>
            <td height="29" align="left"><input name="cookie_set" id="cookie_set"  type="checkbox" class="radio" onClick="imgChange();" />
              <img src="../images/intro/txt_saveid.gif" width="69" height="13" valign="absmiddle" /></td>
          </tr>
          <%
       //서버에만 적용
      ...
      /*	for(int i=0; i<sf1.getRowCount(); i++){
      		String[] ip_from = sf1.getValue("IP_FROM", i).replace(".","#").split("#");
      		String[] ip_to = sf1.getValue("IP_TO", i).replace(".","#").split("#");
      		
      		int start_ip = Integer.parseInt(ip_from[ip_from.length-1]);
      		int end_ip   = Integer.parseInt(ip_to[ip_to.length-1]);
      		for(int j = start_ip ; j <= end_ip ; j++){
      			String check_ip =  ip_from[0] + ip_from[1] + ip_from[2] + String.valueOf(j);
	  	...
	  	if(ip_flag && (!ip.equals("0:0:0:0:0:0:0:1")&&!ip.equals("127001"))){
	  		%>
	  			<tr>
			        <td width="187" height="25"><!-- <img src="../images/intro/txt_cert.gif" width="48" height="16">  -->
      ...
      <tr>
        <td align="center" valign="top" style="height:30px"><img src="../images/intro/btn_login.gif" width="350" height="49" style="cursor:hand;" onclick="goLogin()" /></td>
      </tr>
      <tr>
