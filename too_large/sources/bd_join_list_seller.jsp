...
<%
	...
	multilang_id.addElement("SBD_006");
	multilang_id.addElement("BUTTON");
	multilang_id.addElement("MESSAGE");
	
	HashMap text = MessageUtil.getMessage(info,multilang_id);
	
	String screen_id = "SBD_006";
...
<%--         var url =  "<%=POASRM_CONTEXT_NAME%>/sourcing/bd_ann_detail.jsp";	 --%>
        var url =  "<%=POASRM_CONTEXT_NAME%>/sourcing/bd_ann_d_"+ann_version+".jsp";
...
//     }
	...
	f.target                   = "_self"; 
	f.method                   = "post";   
	f.action = "bd_join_seller_insert.jsp";
	f.submit();
}
