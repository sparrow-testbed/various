...
<%
	...
	SepoaOut value = ServiceConnector.doService(info, "MT_014", "TRANSACTION","getQuery_RPT_POP_New", obj);
							...
							<table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#dedede">
								<tr>
									<td width="100%">
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td width="18%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;제목</td>
											...
											<tr>
												<td width="18%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;고객의소리 구분</td>
												<td width="25%" class="data_td">
													<%=GONGJI_GUBUN_DESC%>
												</td>

												<td width="10%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;공급사</td>
...
<%--												
 ...
 --%>
												<td width="9%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;<%=text.get("MT_014.VIEW_COUNT")%></td>
												<td width="8%" class="data_td">
													<%=VIEW_COUNT%>
												</td>
											</tr>
											<tr>
