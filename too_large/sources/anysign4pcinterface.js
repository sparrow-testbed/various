...
document.write("<script type=\"text/javascript\" src=\"" + "/js/lib/jquery-1.10.2.min.js\"></scr"+"ipt>"); // keyboard apply (inca)
document.write("<script type=\"text/javascript\" src=\"" + "/pluginfree/js/nppfs-1.13.0.js\"></scr"+"ipt>"); // keyboard apply (inca)
function AnySignInitialize ()
{
	...
	var aAllowNativeInput = false;     // keyboard apply (inca)
	...
	var aIncaNOSv10Enable = true;         // keyboard apply (inca)
							 ...
							 aUserCallback)
{
	...
	npPfsStartup(document.form, false, true, false, false, "npkencrypt", "on");  // keyboard apply (inca)
