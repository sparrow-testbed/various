...
<%
	...
	multilang_id.addElement("RQ_244");
	multilang_id.addElement("BUTTON");
	multilang_id.addElement("MESSAGE");
	
	HashMap text = MessageUtil.getMessage(info,multilang_id);
	
	String screen_id = "RQ_244";
	String grid_obj  = "GridObj";
	boolean isSelectScreen = false;

	String WISEHUB_PROCESS_ID="RQ_244";
...
function doSelect() {
	...
	G_SERVLETURL = "<%=POASRM_CONTEXT_NAME%>/servlets/dt.rfq.rfq_pp_dis7";
...
<%-- <s:grid screen_id="RQ_244" grid_obj="GridObj" grid_box="gridbox"/> --%>
