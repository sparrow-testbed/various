...
function getChild(){
	...
	//var pItemNoColValue = "511005";//GD_GetCellValueIndex(GridObj, rowIndex, pItemNoColIndex);
	//var seqColValue     = "1";//GD_GetCellValueIndex(GridObj, rowIndex, seqColIndex);
	
	inputParam = "P_ITEM_NO=<%=pItemNo%>";
	...
	for(i = 0; i < rowCount; i++){
		...
		if(selectedColValue == true){
			...
			opener.setCatalog2(
				...
				,image_file_path,pSeqColValue,"<%=prSeq%>" ,wid, hgt
			);
	...
	<table width="99%" border="0" cellspacing="0" cellpadding="0" >
		<tr>
			<td class='title_page' height="20" align="left" valign="bottom">
				<span class='location_end'>BOM자품 추가</span>
			</td>
		</tr>
	</table>
...
<br/>
<br/>
<div id="gridbox_1" name="gridbox_1" width="100%"  height="400px"  style="background-color:white;"></div>
<s:footer/>
</body>
</html>