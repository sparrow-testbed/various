...
<%
	...
	multilang_id.addElement("MA_011_1");
	multilang_id.addElement("BUTTON");
	multilang_id.addElement("MESSAGE");
	
	HashMap text = MessageUtil.getMessage(info,multilang_id);
	
	String screen_id = "MA_011_1";
...
<!-- PROCESS ID 선언 -->
<% String WISEHUB_PROCESS_ID="MA_011_1";%>
<!-- 사용 언어 설정 -->
...
function setHeader() {
	...
	GridObj1.SetColCellRadio("Check", true);
	/* WiseGrid1 세팅 종료 */
...
<s:grid screen_id="MA_011_1" grid_obj="GridObj" grid_box="gridbox"/>
<s:footer/>
</body>
</html>
