...
<%
	...
	String        pg_no          = this.nvl(request.getParameter("dataStore_page"), "1");
    ...
    value11 = ServiceConnector.doService(info, "CO_004", "CONNECTION", "getQuery_dataStore_ICOMMACH_ICT", obj);
...
function setPage_Change(page, type){
	...
	var dataStore_page = document.getElementById("dataStore_page");
	
	dataStore_page.value = page;
	
	notfrm.submit();
}

function goNews(seq){
	var url = "/admin/dataStore_list_popup_new_index_ict.jsp?seq=" + seq;

	CodeSearchCommon(url,'dataStore_list_popup_new','0','0','700','600');
}
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td width="100%" height="25">
											<img src="/images/title_faq.gif" alt="FAQ"/>
										</td>
									</tr>
									<tr>
...
%>
								...
								<input type="hidden" name="dataStore_page" id="dataStore_page" value="<%=pg_no%>">
...
<% 
	out.println(getPage_html(tot_cnt, pg_row, Integer.parseInt(pg_no), "D")); //페이지 번호
%> 
										</TD>
									</TR>
								</table>
