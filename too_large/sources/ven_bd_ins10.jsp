...
<%
	...
	multilang_id.addElement("SU_003");
	multilang_id.addElement("BUTTON");
	multilang_id.addElement("MESSAGE");
	
	HashMap text = MessageUtil.getMessage(info,multilang_id);
	
	String screen_id = "SU_003";
...
--%>
<% String WISEHUB_PROCESS_ID="SU_003";%>
<%-- 사용 언어 설정 --%>
...
<!--
	var G_SERVLETURL         = "<%=POASRM_CONTEXT_NAME%>/servlets/supply.admin.info.ven_bd_ins10";
    var idx_sel;
    var idx_title;
    var idx_desc1;
    var idx_desc2;
    ...
    function setHeader()
    {
// 		GridObj.AddHeader("flag_h"		,""				,"t_text"		,1010	,0	,true);
// 		GridObj.SetDateFormat(         "date1", 	"yyyy/MM/dd");
// 		GridObj.SetDateFormat(         "date2", 	"yyyy/MM/dd");
...
//     	var row = GridObj.GetRowCount();
//     	GridObj.AddRow();
//     	GD_SetCellValueIndex(GridObj,row,idx_sel,"true&", "&")			//ChekcBox "True"로 Set
         //InsertRows(count);
	...
	function NextPage()
	{
		parent.up.MM_showHideLayers('m1','','show','m2','','show','m3','','show','m4','','show','m5','','hide','m6','','show','m11','','hide','m22','','hide','m33','','hide','m44','','hide','m55','','show','m66','','hide');
		parent.up.goPage('sc');
	}
	
function BackPage()
{
	parent.up.MM_showHideLayers('m1','','show','m2','','show','m3','','hide','m4','','show','m5','','show','m6','','show','m7','','show','m11','','hide','m22','','hide','m33','','show','m44','','hide','m55','','hide','m66','','hide','m77','','hide');
	parent.up.goPage('pj');
}
//-->
</script>
...
<%-- <s:grid screen_id="SU_003" grid_obj="GridObj" grid_box="gridbox"/> --%>
