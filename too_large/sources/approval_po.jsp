...
<form name="form1" method="post">
  ...
  <td width="1%" valign="top" ></td>
    <td width="40%" valign="top" ><table width="90%" height="92" border="0" cellpadding="0" cellspacing="0">
	  		...
	  		<tr>
        		<td class="title"> 계&nbsp;약&nbsp;번&nbsp;호&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;<%=doc_no%></td>
      		</tr>
      		<tr>
      		...
      		<tr>
        		<td class="title"> 발&nbsp;&nbsp;&nbsp;&nbsp;주&nbsp;&nbsp;&nbsp;&nbsp;명&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;<%=subject%></td>
      		</tr>
      <tr>
        <td height="1" bgcolor="#000000"></td>
      </tr>
...
APP_STATUS    = "";
//////////////////ClipReport4 조립부 시작///////////////////////////////////////////////////////////
_rptAprvData.append("발 주 품 의");

_rptAprvData.append(_RD);	

_rptAprvData.append("발 주 번 호");
...
<iframe id="ctFrm" name="ctFrm" src="/procure/po_approval_detail.jsp?po_no=<%=doc_no %>" style="width: 100%;height: 700px; border: 0px;" frameborder="0" scrolling="auto"></iframe>
