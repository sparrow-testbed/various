...
<%
	...
	multilang_id.addElement("STA041");
	multilang_id.addElement("BUTTON");
	multilang_id.addElement("MESSAGE");
	
	HashMap text = MessageUtil.getMessage(info,multilang_id);
	
	String screen_id = "STA041";
...
<% String WISEHUB_PROCESS_ID="STA041";%>
...
//<!--
var G_SERVLETURL   = "<%=POASRM_CONTEXT_NAME%>/servlets/statistics.sta_bd_lis41";
...
function setHeader() 
{
    ...
    INDEX_PR_NO             	= GridObj.GetColHDIndex("ID");   
    INDEX_ADD_USER_ID       	= GridObj.GetColHDIndex("ISSUED_DATE");   
    INDEX_SIGN_STATUS       	= GridObj.GetColHDIndex("VENDOR_NAME_LOC");
    INDEX_CTRL_CODE         	= GridObj.GetColHDIndex("IRS_NO");
    INDEX_PR_PROCEEDING_FLAG	= GridObj.GetColHDIndex("SUBJECT");    
    INDEX_PR_STATUS    			= GridObj.GetColHDIndex("PO_AMT");
    INDEX_RETURN_REASON			= GridObj.GetColHDIndex("CONTRACT_TO_DATE");
    INDEX_PR_SEQ				= GridObj.GetColHDIndex("PRINT_CNT");
    INDEX_PR_TYPE               = GridObj.GetColHDIndex("PRESENT");
}
 ...
 */
 function doPdf(){
	...
	for(var i = 0 ; i < GridObj.GetRowCount() ; i++){
		...
		if(GridObj.cells(GridObj.getRowId(i), GridObj.GetColHDIndex("SELECTED")).getValue() == "1"){
	...
	document.form1.target = "ifr_pdf";
    document.form1.action = "sta_bd_ins41_pdf.jsp?co_no=" + GridObj.cells(rowId, GridObj.GetColHDIndex("CO_NO")).getValue();
    document.form1.submit();
    return;	

// 	document.form1.method = "POST";
// 	document.form1.target = "ifr_pdf";
//     document.form1.action = "sta_bd_ins41_pdf.jsp?co_no=";
//     document.form1.submit();
	//url = "/kr/statistics/sta_bd_ins41_pdf.jsp";
...
//     }
    ...
    document.forms[0].start_add_date.value = del_Slash( document.forms[0].start_add_date.value );
    document.forms[0].end_add_date.value   = del_Slash( document.forms[0].end_add_date.value   );
    
    mode = "getStaPubList";//dt.rfq.ebd_bd_lis3
...
// form1.user_name.value = USER_NAME;
...
<td width="100%">
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
			...
			<td width="15%" class="title_td">공급업체</td>
			<td class="data_td">
                <a href="javascript:pStaCompList()">
                	<img src="<%=G_IMG_ICON%>" align="absmiddle" border="0" alt="">
                </a>
                <input type="text" id="vendor_name" name="vendor_name" onkeydown='entKeyDown()'  size="10" readonly value=''>
			</td>
        	<td width="15%" class="title_td">발행일자</td>
            <td class="data_td">
    		...
    		<td height="30" align="right">
            	<TABLE cellpadding="0">
                	<TR>
                        ...
                        <TD><script language="javascript">btn("javascript:doPdf()","PDF 출력")   			</script></TD>  
                    </TR>
                </TABLE>
            </td>
        </tr>
...
<s:grid screen_id="STA041" grid_obj="GridObj" grid_box="gridbox"/>
<s:footer/>
</body>
</html>
