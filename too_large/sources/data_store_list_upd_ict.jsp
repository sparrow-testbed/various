...
<%
	//HTML에 쓰일 변수들
	String TITLE = String.valueOf(text.get("I_MT_014.MSG_0105"));//"자료실 수정";
%>
...
function Update()
{
    ...
    F.action = "data_store_wk_upd_ict.jsp?SEQ=<%=SEQ%>";
...
function Cancel()
{
    if(!confirm("<%=text.get("I_MT_014.MSG_0104")%>"))//취소 하시겠습니까?
   	...
   	location.href = "data_store_list_ict.jsp";
}
...
<%
	...
	SepoaOut value = ServiceConnector.doService(info, "I_MT_014", "CONNECTION","getQuery_dataStore_POP_New", obj);
