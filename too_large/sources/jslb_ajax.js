...
//
	...
	function sendRequest(callback,data,method,url,async,sload,user,password)
	{
		...
		//open 메소드
		//alert("method="+method+",url="+url+",async="+async+",user="+user+",password="+password);
		//method=POST,url=/servlets/sepoa.svl.util.SepoaAjaxCombo?timeStamp=1384158796820,async=true,user=undefined,password=undefined
		//method=POST,url=/servlets/sepoa.svl.util.SepoaAjaxCombo?timeStamp=1384158841190,async=true,user=undefined,password=undefined
		//method=POST,url=/servlets/sepoa.svl.util.SepoaAjaxCombo?timeStamp=1384158851082,async=false,user=undefined,password=undefined
		...
		function setEncHeader(oj){
			...
			//원본 var contentTypeUrlenc = 'application/x-www-form-urlencoded; charset=UTF-8';
	...
	function sendRequestForm(callback,objForm, data,method,url,async,sload,user,password)
	{
		//XMLHttpRequest 오브젝트 생성
		var oj = createHttpRequest();
		if( oj == null ) return null;
		...
		//참고 http://jsgt.org/ajax/ref/test/response/responsetext/try1.php
		if(opera || safari || mozes){
			oj.onload = function () { callback(oj, objForm); }
		} else {
