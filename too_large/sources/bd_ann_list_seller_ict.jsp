...
<%
	...
	multilang_id.addElement("I_SBD_001");
	multilang_id.addElement("BUTTON");
	multilang_id.addElement("MESSAGE");
	
	HashMap text = MessageUtil.getMessage(info,multilang_id);
	
	String screen_id = "I_SBD_001";
...
var G_SERVLETURL   = "<%=POASRM_CONTEXT_NAME%>/servlets/ict.sepoa.svl.sourcing.bd_ann_list_seller_ict";
								...
								<tr>
									...
									<td width=35%" class="data_td">
										<select name="bd_status_text" id="bd_status_text" class="inputsubmit">
											...
											<option value="ACUC" <%=selected %>>공문중</option>
											<option value="CC">공문취소</option>
										</select>
									</td>
									<td width="15%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">
										&nbsp;&nbsp;입찰구분
...
<%-- <s:grid screen_id="I_SBD_001" grid_obj="GridObj" grid_box="gridbox"/> --%>
