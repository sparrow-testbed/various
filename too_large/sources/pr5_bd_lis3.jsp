...
function fnSelect(){
	...
	var rowArray       = rowObject.value.split(",");
...
function fnSelectCallback(oj){
	...
	if(resultArrayLength == 1){
		...
		opener.setPo2(vendorCode, vendorName, unitPrice, rowIndex);
	}
}
...
<s:header popup="true">
	<form name="form1" action="">
		...
		<input type="hidden" name="row"     id="row"     value="<%=request.getParameter("row") %>" />
