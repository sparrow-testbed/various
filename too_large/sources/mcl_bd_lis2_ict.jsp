...
<%
	...
	multilang_id.addElement("I_MA_011");
...
<% 
	String WISEHUB_PROCESS_ID="I_MA_011";
	...
	String type    = "M040_ICT";
	String control = "M041_ICT";
	String class1  = "M042_ICT";
	String class2  = "M122_ICT";
    ...
    String userStyle = "style='display:none'";
    
    // MUP190700001 WFIS관리자IT
    if( "MUP190700001".equals(info.getSession("MENU_PROFILE_CODE"))){
    	userStyle = "";	
    }
...
function Init() {
	...
	<% if( !"MUP190700001".equals(info.getSession("MENU_PROFILE_CODE")) ){ /* MUP190700001 WFIS관리자IT */ %>
	GridObj_1.setColTypes("ch,ro,ro,edtxt,edtxt,edtxt,edtxt,edtxt,edtxt,edtxt,edtxt");
	<% } %>
	GridObj_1.setSizes();
	GridObj_2_setGridDraw();
	<% if( !"MUP190700001".equals(info.getSession("MENU_PROFILE_CODE")) ){ /* MUP190700001 WFIS관리자IT */ %>
	GridObj_2.setColTypes("ch,ro,ro,ro,ro,edtxt,ro,ro,ro,ro,ro,ro,ro,ro");
	<% } %>
	GridObj_2.setSizes();
...
function GridObj_1_doSelectParams(){
	...
	inputParam = "type=M040_ICT&test=1";
...
function GridObj_1_doSelect() {
	var servletURL = "/servlets/ict.admin.basic.material.mty_lis1_ict";
...
function lineInsertTr(){
	...
	$.post(
		"<%=POASRM_CONTEXT_NAME%>/servlets/ict.admin.basic.material.mcl_bd_lis1_hidden_ict",
		{
			type      : "M041_ICT",
			item_type : top, 
			mode      : "getQuery"
...
function CreateTL(){
	...
	$.post(
		"<%=POASRM_CONTEXT_NAME%>/servlets/ict.admin.basic.material.mty_wk_ins1_ict",
		{
			type      : "M040_ICT",
			item_type : matCode, 
			mode      : "getCode"
...
function createTr(){
	...
	$.post(
		"<%=POASRM_CONTEXT_NAME%>/servlets/ict.admin.basic.material.mct_wk_ins1_ict",
		{
			control      : "<%=control %>",
...
function createBr(){
	...
	$.post(
		"<%=POASRM_CONTEXT_NAME%>/servlets/ict.admin.basic.material.mcl_wk_ins1_ict",
		{
			class1     : "<%=class1 %>",
...
function createBl(){
	...
	$.post(
		"<%=POASRM_CONTEXT_NAME%>/servlets/ict.admin.basic.material.mcl_wk_ins2_ict",
		{
			mclass2     : "<%=class2 %>",
...
function ChangeTl(){
	...
	var body       = document.getElementsByTagName("body")[0];
	var cols_ids   = GridObj_1_getColIds();
	var servletURL = "/servlets/ict.admin.basic.material.mty_upd1_ict";
	var params;
...
function changeTr(){
	...
	var servletURL = "/servlets/ict.admin.basic.material.mct_upd1_ict";
	var params;
...
function changeBr(){
	...
	var servletURL = "/servlets/ict.admin.basic.material.mcl_upd1_ict";
	var params;
...
function changeBl(){
	...
	var servletURL = "/servlets/ict.admin.basic.material.mcl_upd2_ict";
	var params;
...
function SaveTl(){
	...
	var body       = document.getElementsByTagName("body")[0];
	var cols_ids   = GridObj_1_getColIds();
	var servletURL = "/servlets/ict.admin.basic.material.mty_ins1_ict";
	var params;
...
function saveTr(){
	...
	var body       = document.getElementsByTagName("body")[0];
	var cols_ids   = GridObj_2_getColIds();
	var servletURL = "/servlets/ict.admin.basic.material.mct_ins1_ict";
	var params;
...
function saveBr(){
	...
	var body       = document.getElementsByTagName("body")[0];
	var cols_ids   = GridObj_3_getColIds();
	var servletURL = "/servlets/ict.admin.basic.material.mcl_ins1_ict";
	var params;
...
function saveBl(){
	...
	var body       = document.getElementsByTagName("body")[0];
	var cols_ids   = GridObj_4_getColIds();
	var servletURL = "/servlets/ict.admin.basic.material.mcl_ins2_ict";
	var params;
...
function DeleteTl(){
	...
	var body       = document.getElementsByTagName("body")[0];
	var cols_ids   = GridObj_1_getColIds();
	var servletURL = "/servlets/ict.admin.basic.material.mty_del1_ict";
	var params;
...
function deleteTr(){
	...
	var body       = document.getElementsByTagName("body")[0];
	var cols_ids   = GridObj_2_getColIds();
	var servletURL = "/servlets/ict.admin.basic.material.mct_del1_ict";
	var params;
...
function deleteBr(){
	...
	var body       = document.getElementsByTagName("body")[0];
	var cols_ids   = GridObj_3_getColIds();
	var servletURL = "/servlets/ict.admin.basic.material.mcl_del1_ict";
	var params;
...
function deleteBl(){
	...
	var body       = document.getElementsByTagName("body")[0];
	var cols_ids   = GridObj_4_getColIds();
	var servletURL = "/servlets/ict.admin.basic.material.mcl_del2_ict";
	var params;
...
function deleteWg(){
	...
	var servletURL = "/servlets/ict.admin.basic.material.maa_del1_ict";
	var params;
...
function check_flag222222(gridNm, result) {
	...
	if(result == "Y") {
		...
		if(anw == true) {
			servletURL = "/servlets/ict.admin.basic.material.mty_del1_ict";
...
function check_flag(result) {
	...
	if(result == "Y") {
		...
		var body       = document.getElementsByTagName("body")[0];
		var cols_ids   = GridObj_5_getColIds();
		var servletURL = "/servlets/ict.admin.basic.material.maa_ins1_ict";
		var params;
...
function check_count(code1, code2, str){
	...
	if(str == 'TL'){
		//document.forms[0].action = "/ict/kr/admin/basic/material/cut_wk_lis1.jsp?de_type=<%=control %>&code1="+code1+"&code2="+code2;
		...
		document.forms[0].action = "/ict/kr/admin/basic/material/maa_wk_lis2.jsp?company_code="+code1+"&ctrl_code="+code2;
		document.method = "get";
		
		document.forms[0].submit();
		
		$.post(
			"<%=POASRM_CONTEXT_NAME%>/servlets/ict.admin.basic.material.maa_wk_lis2_ict",
			{
				company_code : code1,
				ctrl_code    : code2, 
				mode         : "getQuery"
...
function goRight(){
	...
	if(gridObj_1_rowCount > 0){
		...
		var servletURL = "/servlets/ict.admin.basic.material.mct_lis1_ict";
...
function GridObj_3_doSelectParams(item_type, code){
	...
	inputParam = inputParam + "&class1=M042_ICT";
...
function goDown(){
	...
	var servletURL = "/servlets/ict.admin.basic.material.mcl_lis1_ict";
...
function GridObj_4_doSelectParams(item_type, item_control, item_class1){
	...
	inputParam = inputParam + "&mclass2=M122_ICT";
...
function goLeft(){
	...
	var servletURL = "/servlets/ict.admin.basic.material.mcl_lis2_ict";
...
function goWorkItem(){
	...
	var servletURL = "/servlets/ict.admin.basic.material.maa_lis1_ict";
