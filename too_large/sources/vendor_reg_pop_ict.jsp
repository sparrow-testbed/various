...
<%
	...
	multilang_id.addElement("I_SU_102");
	multilang_id.addElement("BUTTON");
	multilang_id.addElement("MESSAGE");
	
	HashMap text = MessageUtil.getMessage(info,multilang_id);
	
	String screen_id = "I_SU_102";
...
<%
	...
	Object[] obj = { vendor_code};
	SepoaOut value = ServiceConnector.doService(info, "I_p0070", "CONNECTION", "getVendorInfo", obj);
...
<%
	...
	//SepoaOut value1 = ServiceConnector.doService(info, "I_p0070", "CONNECTION", "getJobStatus", obj1);
	...
	//SepoaOut value2 = ServiceConnector.doService(info, "I_s6006", "CONNECTION", "getEvalScore", obj2);
	...
	function doRegister(flag){
		...
		*/
		...
		if(flag == 'P'){ // 결재
			...
			f.target = "hiddenframe";
			f.action = "vendor_reg_ins_ict.jsp?approval_reason="+f.approval_reason.value;
			f.submit();
...
<%-- <s:grid screen_id="I_SU_102" grid_obj="GridObj" grid_box="gridbox"/> --%>
<s:footer/>
</BODY>
</HTML>
