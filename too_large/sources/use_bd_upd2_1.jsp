...
<%
	...
	multilang_id.addElement("SUP_003");
	multilang_id.addElement("BUTTON");
	multilang_id.addElement("MESSAGE");
	
	HashMap text = MessageUtil.getMessage(info,multilang_id);
	
	String screen_id = "SUP_003";
...
if( user_id != "" )  {
	...
	String[] args = {user_id, house_code, user_id};
	...
	try {
		...
		if(value.status == 1) {
			wf = new SepoaFormater(value.result[0], field, line);
			str = wf.getValue();
		...
		//id = wf.getValue("USER_ID", 0);
		Logger.debug.println("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"+wf.getValue("USER_ID", 0));
...
function searchProfile(fc) {
	...
	if(fc == "pr") url = "/kr/admin/wisepopup/cod_cm_lis1.jsp?code=SP9053&function=getPr&values=<%=house_code%>&values=M062&values=&values=";
	else if(fc == "posi") {
	...
	//alert(makeEncData(frm));
  	if(makeEncData(frm)){ // 키보드보안 암호화 함수
		...
		if(LRTrim(frm.signed_msg.value) != ""){
			frm.action = "use_wk_upd3.jsp";
			usePageCharset = true;
			//XecureSubmit(frm);
			frm.submit();
		}else{
			frm.action = "use_wk_upd2.jsp";
			frm.submit();
		}
...
<script type="text/javascript">
document.write("<script type=\"text/javascript\" src=\"" + "/AnySign/anySign4PCInterface_TouchEnKey.js" + "?version=" + new Date().getTime() + "\"></scr"+"ipt>");
</script>
...
function SignDataCMS_callback(aResult) {
    ...
    document.getElementById ("form1").signed_msg.value = aResult;
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td class="title_td" width="18%">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;사용자 구분</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td class="title_td" width="18%">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;사용자 ID<br>
      </td>
	<td class="data_td" >
		<table cellpadding="0">
			<tr>
	...
	<td class="title_td" width="15%">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;기존비밀번호</td>
      <td class="data_td" width="35%">
        <input type="password" name="old_password" id="old_password" style="width:95%" maxlength="100" class="input_re" value=""   data-enc="on">
      </td>     
    </tr>
	<tr>
		<td colspan="4" height="1" bgcolor="#dedede"></td>
    ...
    <tr>
      <td class="title_td" width="18%">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;새 비밀번호</td>
      <td class="data_td" width="32%">
        <input type="password" name="password" id="password" style="width:95%" maxlength="100" class="inputsubmit" value="" onKeyUp="return chkMaxByte(150, this, '비밀번호');"  data-enc="on">
      </td>
      <td class="title_td" width="15%">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;새 비밀번호확인</td>
      <td class="data_td" width="35%">
        <input type="password" name="password2" id="password2" style="width:95%" maxlength="100" class="inputsubmit" value=""   data-enc="on">
      </td>
    </tr>
    <Tr>
    ...
    <tr>
      ...
      <td class="data_td" <%= ("WOORI".equals(USER_TYPE))?"":"colspan='3'" %>>
        <input type="text" name="user_name_loc" id="user_name_loc" style="width:<%=("WOORI".equals(USER_TYPE))?"95%":"37%"%>" maxlength="40" class="input_re" value="<%=USER_NAME_LOC%>" onKeyUp="return chkMaxByte(40, this, '사용자명(국문)');">
        <input type="hidden" name="dept" id="dept" style="width:15%" maxlength="100" class="inputsubmit" value="<%=DEPT%>" onKeyUp="return chkMaxByte(100, this, '부서코드');" >
        <input type="hidden" name="employee_no" id="employee_no" style="width:95%" maxlength="20" class="inputsubmit" value="<%=EMPLOYEE_NO%>" onKeyUp="return chkMaxByte(20, this, '사원번호');">
      </td>
      <% if( "WOORI".equals(USER_TYPE) ) { %> 
   ...
   <tr>
    ...
    <tr>
      ...
      <td class="data_td" colspan="3">
        <input type="text" name="zip_code" id="zip_code" style="width:15%;ime-mode: disabled;" maxlength="10" class="inputsubmit" value="<%=ZIP_CODE%>" onKeyUp="return chkMaxByte(10, this, '우편번호');" onKeyPress="return onlyNumber(event.keyCode);" data-dataType="n">
      </td>      
 	<tr>
		<td colspan="4" height="1" bgcolor="#dedede"></td>
	</tr>    
