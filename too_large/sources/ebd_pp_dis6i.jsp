...
<%
	...
	multilang_id.addElement("PR_033");
	multilang_id.addElement("BUTTON");
	multilang_id.addElement("MESSAGE");
	
	HashMap text = MessageUtil.getMessage(info,multilang_id);
	
	String screen_id = "PR_033";
...
--%>
<%
	String WISEHUB_PROCESS_ID="PR_033";
	...
	<table width="99%" border="0" cellspacing="0" cellpadding="0" >
		<tr>
			<td class='title_page' height="20" align="left" valign="bottom">
				<span class='location_end'>사전지원요청 상세현황</span>
			</td>
		</tr>
	</table>
							...
							<td width="100%">
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									...
									<tr>
										...
										<td width="35%" class="data_td">
											<input type="text" name="expect_amt" size="20" class="input_data2" value="<%=PR_TOT_AMT%>" style="border:0; background-color: #f6f6f6" >
										</td>
									</tr>
									<tr>
										<td colspan="4" height="1" bgcolor="#dedede"></td>
...
<s:grid screen_id="PR_033" grid_obj="GridObj" grid_box="gridbox"/>
<s:footer/>
