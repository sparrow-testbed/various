...
<%
	...
	multilang_id.addElement("I_SU_002");
	multilang_id.addElement("BUTTON");
	multilang_id.addElement("MESSAGE");
	
	HashMap text = MessageUtil.getMessage(info,multilang_id);
	
	String screen_id = "I_SU_002";
...
<!-- PROCESS ID 선언 -->
<% String WISEHUB_PROCESS_ID="I_SU_002";%>
...
<!--
var G_SERVLETURL         = "<%=POASRM_CONTEXT_NAME%>/servlets/ict.supply.admin.info.ven_bd_ins9_ict";
...
function NextPage()
{
	parent.up.MM_showHideLayers('m1','','show','m2','','show','m3','','show','m4','','hide','m5','','hide','m6','','show','m7','','show','m11','','hide','m22','','hide','m33','','hide','m44','','show','m55','','hide','m66','','hide','m77','','hide');
	parent.up.goPage('qr');
}
...
function BackPage()
{
	parent.up.MM_showHideLayers('m1','','show','m2','','hide','m3','','show','m4','','show','m5','','hide','m6','','show','m11','','hide','m22','','show','m33','','hide','m44','','hide','m55','','hide','m66','','hide');
	parent.up.goPage('cp');
}
//-->
</Script>
...
<%-- <s:grid screen_id="I_SU_002" grid_obj="GridObj" grid_box="gridbox"/> --%>
