...
<%
	...
	multilang_id.addElement("VR_002");
	multilang_id.addElement("BUTTON");
	multilang_id.addElement("MESSAGE");
	
	HashMap text = MessageUtil.getMessage(info,multilang_id);
	
	String screen_id = "VR_002";
...
<%-- 		document.form.action = "/sourcing/bd_ann_<%=ANN_VERSION%>.jsp?SCR_FLAG=C&BID_STATUS=AR&BID_TYPE=D&popup_flag=false"; --%>
// 		document.form.target = "body"; 
// 		document.form.submit();
		$("#getBdAnn").attr("src", "/sourcing/bd_ann_<%=ANN_VERSION%>.jsp?SCR_FLAG=V&BID_STATUS=AR&BID_TYPE=D&ANN_VERSION=<%=ANN_VERSION%>");
	}
</script>
</head>
<body onload="init();">
