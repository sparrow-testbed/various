var __iccard = function(__SANDBOX) {
...
iccard_tk1 = null; var gDialogObj;
var gInputHandler;

XWC.getLocaleResource("iccard", XWC.lang());
function onload(aDialogObj) {
    gDialogObj = aDialogObj;
	XWC.UI.setDragAndDrop(__2);
    
    if (gDialogObj.type == "kepco")
        __2.firstChild.appendChild(document.createTextNode(XWC.S.title_kepco));
    else
        __2.firstChild.appendChild(document.createTextNode(XWC.S.title));

	if (AnySign.mWBStyleApply)
		gInputHandler = new __SANDBOX.inputKeyHandler ("iccard", __7, 1, -190, 0, "qwerty_crt", 30, 117);
	else
		gInputHandler = new __SANDBOX.inputKeyHandler ("iccard", __7, 1, -190, 0, "qwerty_crt", 30, 130);
	...
	gInputHandler.onEnterKeyPress (__9);
	...
	if (AnySign.mWBStyleApply)
	{
		...
		label.setAttribute('for', 'xwup_iccard_tek_check1', 0);
		label.setAttribute('id', 'xwup_iccard_tek_label1', 0);
		label.style.margin = '0px';

		var checkbox = XWC.UI.createElement('INPUT');
		checkbox.style.margin = '0 4.0px 0 0';
		checkbox.setAttribute('tabindex', '5', 0);
		if (__SANDBOX.IEVersion <= 8) {
			checkbox.mergeAttributes(XWC.UI.createElement("<INPUT name='iccard_tek_check1'>"), false);
		} else {
			checkbox.setAttribute('name', 'iccard_tek_check1', 0);
		}

		checkbox.setAttribute('id', 'xwup_iccard_tek_check1', 0);
		...
		__7.parentNode.appendChild (label);
	}
...
function onOKButtonClick() {
	...
	if (gInputHandler.getLength() == 0) {
		alert(XWC.S.depasswd);
		return;
	}

	if (gInputHandler.getLength() > 8) {
		alert(XWC.S.longpasswd);
		return;
	}
...
function onInputMouseCheckBoxClick(aEvent) {
	...
	aTransKey = iccard_tk1;

	if (aChecked) {
		aTransKey.useTransKey = true;
		__7.readOnly = true;
		showTransKeyBtn("iccard_tk1");
		aTransKey.clear();
	}
	else {
...
__2.appendChild(__3);
__1.appendChild(__2);
var __4 = XWC.UI.createElement('FORM');
if (__SANDBOX.IEVersion <= 8) {
__4.mergeAttributes(XWC.UI.createElement("<FORM name='xwup_iccard_tek_form'>"),false);
} else {
__4.setAttribute('name', 'xwup_iccard_tek_form', 0);
}
__4.setAttribute('id', 'xwup_iccard_tek_form', 0);
__4.className = 'xwup-inpwd-sec2';
__4.onsubmit = function(event) {return false;};
var __5 = XWC.UI.createElement('DIV');
__5.setAttribute('id', 'iccard_tk1', 0);
var __6 = XWC.UI.createElement('LABEL');
__6.htmlFor = 'xwup_iccard_tek_input';
__6.className = 'xwup-input-name';
__6.appendChild(document.createTextNode(XWC.S.depasswd));
__5.appendChild(__6);
var __7 = XWC.UI.createElement('INPUT');
__7.setAttribute('tabindex', '5', 0);
if (__SANDBOX.IEVersion <= 8) {
__7.mergeAttributes(XWC.UI.createElement("<INPUT name='iccard_tek_input1'>"),false);
} else {
__7.setAttribute('name', 'iccard_tek_input1', 0);
}
__7.setAttribute('id', 'xwup_iccard_tek_input', 0);
__7.setAttribute('type', 'password', 0);
__7.className = 'xwup-input-pwd';
__7.setAttribute('kbd', 'qwerty_crt', 0);
__5.appendChild(__7);
__4.appendChild(__5);
var __8 = XWC.UI.createElement('DIV');
__8.className = 'xwup-buttons-layout';
var __9 = XWC.UI.createElement('BUTTON');
__9.setAttribute('tabindex', '5', 0);
__9.setAttribute('type', 'button', 0);
__9.setAttribute('id', 'xwup_ok', 0);
__9.onclick = function(event) {onOKButtonClick(event)};
__9.appendChild(document.createTextNode(XWC.S.button_ok));
__8.appendChild(__9);
var __10 = XWC.UI.createElement('BUTTON');
__10.setAttribute('tabindex', '5', 0);
__10.setAttribute('type', 'button', 0);
__10.onclick = function(event) {onCancelButtonClick()};
__10.appendChild(document.createTextNode(XWC.S.button_cancel));
