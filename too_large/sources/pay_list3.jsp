...
<%
	...
	multilang_id.addElement("TX_015");
	multilang_id.addElement("BUTTON");
	multilang_id.addElement("MESSAGE");
	
	HashMap text = MessageUtil.getMessage(info,multilang_id);
	
	String  screen_id      = "TX_015";
...
//<!--
var G_SERVLETURL   = "<%=POASRM_CONTEXT_NAME%>/servlets/sepoa.svl.tax.pay_list3";
...
function doManPayEnd(){
	...
	myDataProcessor = new dataProcessor("<%=POASRM_CONTEXT_NAME%>/servlets/sepoa.svl.tax.pay_list2"+params);
							...
							<td width="100%">
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td class="data_td">
											<input type="text" name="vendor_code" id="vendor_code" size="12" class="inputsubmit" maxlength="10" readonly="readonly" onkeydown='entKeyDown()' style="ime-mode:inactive">
									...
									<tr>
										...
										<td width="35%" class="data_td">
            								<input type="text" id="tax_no" name="tax_no" size="10" value='' onkeydown='entKeyDown()' style="ime-mode:inactive">
										</td>
										...
										<td class="data_td" width="35%" colspan="3">
											<input type="text" name="purchase_id" id="purchase_id" value="<%=info.getSession("ID")%>" size="15" class="inputsubmit"onkeydown='entKeyDown()' style="ime-mode:inactive">
...
<s:grid screen_id="TX_015" grid_obj="GridObj" grid_box="gridbox"/>
<s:footer/>
