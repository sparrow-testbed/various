...
<%
	...
	multilang_id.addElement("I_BD_017");
	multilang_id.addElement("BUTTON");
	multilang_id.addElement("MESSAGE");
	
	HashMap text = MessageUtil.getMessage(info,multilang_id);
	
	String screen_id = "I_BD_017";
	...
	function PopupManager(part)
	{
		...
		*/
		...
		if(part == "PURCHASER_ID"){
			window.open("/common/CO_008_ict.jsp?callback=getPurUser", "SP9113", "toolbar=no, location=no, directories=no, status=yes,menubar=no,scrollbars=yes,resizable=no,width=450,height=550,left=0,top=0");
		}
	}
...
var G_SERVLETURL   = "<%=POASRM_CONTEXT_NAME%>/servlets/ict.sepoa.svl.sourcing.bd_result_list_ict";
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									...
									<td class="data_td" style="display: none;">
										...
										<a href="javascript:doRemove('purchaser_id')">
											<img src="<%=POASRM_CONTEXT_NAME %>/images/button/ico_x2.gif" align="absmiddle" border="0">
										</a>
...
<%-- <s:grid screen_id="I_BD_017" grid_obj="GridObj" grid_box="gridbox"/> --%>
