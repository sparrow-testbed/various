...
<%
	...
	multilang_id.addElement("TX_018");
	multilang_id.addElement("BUTTON");
	multilang_id.addElement("MESSAGE");
	
	HashMap text = MessageUtil.getMessage(info,multilang_id);
	
	String screen_id = "TX_018";
...
<%
    ...
    //////////////////ClipReport4 선언부 시작///////////////////////////////////////////////////////////
	String _rptName          = "020644/rpt_pay_cost_list"; //리포트명
   		...
   		<td height="30" align="right">
			<TABLE cellpadding="0">
            	<TR>
                    ...
                    <TD><script language="javascript">btn("javascript:doCost()"		,"승 인")    	</script></TD>
				</TR>
			</TABLE>
		</td>
	</tr>
...
<s:grid screen_id="TX_018" grid_obj="GridObj" grid_box="gridbox"/>
<s:footer/>
