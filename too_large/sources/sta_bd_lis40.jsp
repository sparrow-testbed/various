...
//<!--
var G_SERVLETURL   = "<%=POASRM_CONTEXT_NAME%>/servlets/dt.pr.pr6_bd_lis3";
...
//     GridObj.SetColCellSortEnable("SIGN_STATUS_TEXT",false); 
//     GridObj.SetDateFormat("ADD_DATE"          ,"yyyy/MM/dd"); 
//     GridObj.SetDateFormat("RETURN_HOPE_DAY"   ,"yyyy/MM/dd");    
//     GridObj.SetNumberFormat("PR_TOT_AMT"      ,G_format_amt); 
...
<form name="form1" action="">
	...
	<table width="100%" border="0" cellpadding="1" cellspacing="1" bgcolor="#ccd5de">
		<tr>
        	<td width="15%" class="se_cell_title">발행일자</td>
            <td class="se_cell_data">
            	<s:calendar id="start_add_date" default_value="<%=SepoaDate.addSepoaDateMonth(SepoaDate.getShortDateString(),-1)%>" format="%Y/%m/%d"/>
			</td>
		</tr>
	</table>
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
    		...
    		<td height="30" align="right">
            	<TABLE cellpadding="0">
                	<TR>
                        ...
                        <TD><script language="javascript">btn("javascript:doModify()","선택완료")   			</script></TD> 
                        <TD><script language="javascript">btn("javascript:doDelete()","닫 기")   			</script></TD> 
                    </TR>
                </TABLE>
            </td>
        </tr>
