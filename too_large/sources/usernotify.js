var __usernotify = function(__SANDBOX) {
...
XWC.getLocaleResource("usernotify",XWC.lang(),"UTF8");

function onload(aDialogObj){
	XWC.UI.setDragAndDrop(__2);
    __5.innerHTML = aDialogObj.args[0];
	__5.onkeydown = onkeydownEvent;

    XWC.Event.add(__7,"click",function(e){window.open(aDialogObj.args[1]);});
    XWC.Event.add(__8,"click",function(e){
		aDialogObj.onconfirm();
		aDialogObj.args[2].focus();
	});
...
__2.setAttribute('id', 'xwup_usernotify_title', 0);
__2.className = 'xwup-title';
__2.setAttribute('tabindex', '1', 0);
...
__5.setAttribute('tabindex', '1', 0);
__5.setAttribute('id', 'xwup_usernotify', 0);
__5.className = 'xwup-usernoti-box';
...
__7.setAttribute('tabindex', '1', 0);
__7.setAttribute('type', 'button', 0);
__7.setAttribute('id', 'xwup_moreinfo', 0);
__7.appendChild(document.createTextNode(XWC.S.link));
__6.appendChild(__7);
var __8 = XWC.UI.createElement('BUTTON');
__8.setAttribute('tabindex', '1', 0);
__8.setAttribute('type', 'button', 0);
__8.setAttribute('id', 'xwup_ok', 0);
__8.appendChild(document.createTextNode(XWC.S.button_ok));
__6.appendChild(__8);
__1.appendChild(__6);
