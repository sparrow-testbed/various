 ...
 */
	...
	/* SWFObject 생성 메소드
	 * param1 : _1 - flash 파일 지정 및 data url 
	 * param2 : id - swfobject.js 에서 생성되는 graph 객체의 id
	 * param3 : w  - WIDTH
	 * param4 : h  - HEIGHT
	 * param5 : _5 - version
	 * param6 : c  - 배경색
	 * ex) var so = new SWFObject("../fc2.swf?dataUrl=area1.xml","graph","480","340","8","#FFFFFF");
	 */
	...
	deconcept.SWFObject.prototype={
		...
		write:function(_20){
			...
			if(this.skipDetect||this.getAttribute("doExpressInstall")||this.installedVer.versionIsValid(this.getAttribute("version"))){
				...
				//alert("this.getSWFHTML(); = " + this.getSWFHTML());
