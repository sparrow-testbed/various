...
<%
	...
	multilang_id.addElement("I_BD_005");
	multilang_id.addElement("BUTTON");
	multilang_id.addElement("MESSAGE");
	
	HashMap text = MessageUtil.getMessage(info,multilang_id);
	
	String screen_id = "I_BD_005";
...
var G_SERVLETURL   = "<%=POASRM_CONTEXT_NAME%>/servlets/ict.sepoa.svl.sourcing.bd_confirm_list_ict2";
...
{ 
	...
	if( header_name == "ANN_NO")
    {
    	...
    	url =  "bd_confirm_popup_ict2.jsp";
    	url += "?BID_NO=" + BID_NO + "&BID_COUNT=" + BID_COUNT + "&VOTE_COUNT=" + VOTE_COUNT;
			...
			<td height="30" align="right">
				<TABLE cellpadding="0">
					<TR>
						...
						<TD><script language="javascript">btn("javascript:doClose()", "확 인")</script></TD>
					</TR>
				</TABLE>
			</td>
		</tr>
...
<%-- <s:grid screen_id="I_BD_005" grid_obj="GridObj" grid_box="gridbox"/> --%>
