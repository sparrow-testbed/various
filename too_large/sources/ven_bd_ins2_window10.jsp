...
function NextSave()
{
	...
	f.method = "POST";
 	f.target = G_TARGET;
	f.action = "ven_wk_ins2_window10.jsp?SOLE_PROPRIETOR_FLAG="+f.SOLE_PROPRIETOR_FLAG.value+"&VENDOR_TYPE="+f.VENDOR_TYPE.value;
...
%>
	...
	<tr>
		...
		<TABLE cellpadding="0">
			<tr>
				<td> 
					<input type="text" id="USER_ID" name="USER_ID" size="20" maxlength="10" value="<%=irs_no %>" style="ime-mode: disabled;" class="input_re" onKeyUp="return chkMaxByte(10, this, '사용자ID');">
				</td>
...
<%-- 			<input type="text" id="BANK_ACCT" name="BANK_ACCT" value="" size="20" class="input_re" <%=readOnly_flag%> onKeyUp="return chkMaxByte(30, this, '계좌번호');" onKeyPress="return onlyNumber(event.keyCode);"  npkencrypt="on" data-dataType="n" maxlength="30" style="ime-mode:disabled;"> --%>
