					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
			  			<tr>
        					...
        					<td height="24" class="data_td" colspan="3">
        						<input type="text" id="contract_name" name="contract_name" value="<%=CONT_FORM_NAME%>" class="input_empty" style="width: 740px;" readOnly <%=txt_use_yn%>>
        					</td>
        					...
        					<td width="20%" height="24" class="data_td" >
                				<select id="contract_type" name="contract_type" class="inputsubmit" disabled <%=sel_use_yn%>>
									<option value="">----------------</option>
									<%
						...
						<tr>
		      			...
		      			<tr>
        					...
        					<td width="20%" height="24" class="data_td">
        						<input type="text" id="user_name" name="user_name" value="<%=CONT_USER_NAME%>" size="8" class="input_empty" readonly>
        						<input type="hidden" id="user_id" name="user_id" value="<%=CONT_USER_ID%>" size="8" readonly>
        					</td>
						...
						<tr>
		      			...
		      			<tr>
        					...
        					<td width="87%" height="24" class="data_td" colspan="5">
        						<textarea name="cont_update_desc" class="inputsubmit" cols="120%" rows="5px" <%=del_use_yn%>><%=CONT_UPDATE_DESC%></textarea>
        					</td>
			  			</tr>			  
					</table>
				</td>
		 			...
		 			<% if(view.equals("Y")) { %>
			   		<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#DBDBDB">
				  		<tr>
	        				<td width="100%" height="24" align="center" class="div_input" >
	        					계약서식
	        				</td>
				  		</tr>
				  		<tr>
	        				<td width="100%" height="24" bgcolor="FFFFFF" colspan="2" style="word-break:break-all;">
					 		<div  style="width:100%; height:550; overflow-x;hidden; overflow-y:scroll; word-break:break-all;"><%=CONT_CONTENT%></div>
					 		</td>
	        	  		</tr>
        	  		</table>
					<% } else {%>
