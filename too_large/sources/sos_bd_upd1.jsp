...
<%
	...
	multilang_id.addElement("SO_004");
	multilang_id.addElement("MESSAGE");
	
	HashMap text = MessageUtil.getMessage(info,multilang_id);
	
	String screen_id = "SO_004";
	...
	$.post(
		...
		function(arg){
			...
			if(result.length == 1){
				...
				document.getElementById("attach_no").value       = result[2];
				document.getElementById("sign_attach_no_count").value = result[3];
...
function attachFileHeader(){
	...
	attach_file(document.getElementById('attach_no').value, 'FILE');
}
...
function fnCreate(status){
	...
	var url                = "<%=POASRM_CONTEXT_NAME%>/servlets/os.sos_bd_upd1";
	var i                  = 0;
	var rowCount           = GridObj.GetRowCount();
	var chkCount           = 0;
...
function doOnRowSelected(rowId, cellInd){
	...
	if(cellInd == GridObj.getColIndexById("ATTACH_COUNT")) {
		...
		attach_file(attachNoColValue, 'FILE');
	}
}
...
<s:header popup="true">
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td align="left" class="title_page">실사요청생성</td>
		</tr>
	</table>
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr >
										...
										<td width="35%"  class="data_td">
											<input type="text" name="subject" id="subject" style="width:95%" class="inputsubmit">
										</td>
										<td width="15%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;실사요청일자</td>
										<td width="35%"  class="data_td">
											<s:calendar id="osqDate" default_value="" format="%Y/%m/%d"/>
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td class="data_td" colspan="3">
											<input type="text" name="remark" id="remark" style="width:95%" class="inputsubmit" value="" onKeyUp="return chkMaxByte(500, this, '특이사항');">
										</td>
									</tr>
									<tr>
										<td colspan="4" height="1" bgcolor="#dedede"></td>
...
<!-- 						<TD> -->
<%-- <script language="javascript"> --%>
<!-- // btn("javascript:fnDeleteRows()", "행삭제"); -->
<%-- </script> --%>
<!-- 						</TD> -->
						<TD>
<script language="javascript">
...
<s:grid screen_id="SO_004" grid_obj="GridObj" grid_box="gridbox"/>
<s:footer/>
</body>
</html>