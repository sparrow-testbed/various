...
<form name="form1" method="post" action="ven_bd_con_ict.jsp">
			...
			<td valign="top">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td height="35" class="title_page">
							약관동의 (협력업체가 가입을 하실 경우 아래의 협력업체 이용약관에 대한 안내를 반드시 읽고 동의해 주십시오)
						</td>
					</tr>
				</table>
				...
				<table width="840" border="0" cellpadding="0" cellspacing="0" bgcolor="#f7f7f7">
					<tr>
						<td width="20" height="29">
							<img src="/images//img/0.gif" width="10" height="1" border="0" align="absmiddle" />
						</td>
						<td width="110" class="gray">사업자등록번호</td>
						<td width="610" height="29" bgcolor="#FFFFFF" class="gray2">
				...
				<br />
					...
					<table width="840" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td height="100">
								<textarea name="textarea" style="width:840px;height:300px;" readOnly>
제1조 (목적)
...
③ 우리은행시스템은 본 시스템의 원활한 운영을 위해 전자 거래 기본법, 정보 통신망 이용 촉진 등에 관한 법률 등을 위배하지 않는 범위에서 본 약관을 수시로 개정할 수 있으며, 약관이 개정된 경우에는 적용 일자와 개정 사유를 본 시스템의 홈페이지에 명시하여 공문한다.
...
① 우리은행시스템은 등록 신청 업체의 승인 여부와 “공급업체”에 대한 입찰 공문 기타의 통지에 대해 이를 ”공급업체”가 등록한 영업 담당자의 전자우편 주소로 통지할 수 있다.
...
입찰공문 -> ”공급업체”의 입찰 -> 낙찰 (업체 선정) -> 재견적 요청 -> 최종 협의 및 마감" 순으로 진행하며, 우리은행시스템 전자계약서에 대해 ”공급업체”가 전자 서명을 행함으로써 거래가 성립된다.
...
④ 우리은행시스템이 통제할 수 없는 시스템의 장애로 시스템 사용이 불가능하다고 판단될 경우 우리은행시스템은 입찰의 취소 및 재공문 입찰 등 필요한 조치를 취할 수 있다. 시스템의 장애는 시스템의 다운, 시스템에 연결된 모든 네트워크의 장애 등으로 본 시스템에 접속이 불가능하거나 관련 문서를 송신할 수 없는 경우 등을 말한다.
...
제 1조 이 약관은 2012년 8월 31일부터 시행한다.
					...
					<table width="840" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td height="100">
								<textarea name="textarea2" style="width:840px;height:150px;" readOnly>
