(function() { 
    ...
    input_guide2: "인증서 선택 후 확인버튼을 눌러주세요.",
	...
	open_layer: "레이어 열림 ",
	xvvcursor_guide: "인증서 입력(전자서명) 레이어가 열렸습니다. 센스리더 사용자는 원활한 사용을 위해 가상커서를 해제해주시기 바랍니다. 가상커서는 현재 위치에서 엔터키를 입력하면 해제됩니다.",
	...
	passwd: "인증서 암호",
	keyworderror1: "인증서 암호가 올바르지 않습니다.\n인증서 암호는 대문자 소문자를 구분합니다.\n암호 %s회",
	keyworderror2: "(현재 %s회 오류) 오류시 재시도 해주시기 바랍니다.",
