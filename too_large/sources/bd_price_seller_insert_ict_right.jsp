...
<%
	HashMap text = MessageUtil.getMessageMap( info, "MESSAGE", "BUTTON", "I_SBD_004_R" );
	
	String screen_id = "I_SBD_004_R";
...
function doQuery() {
    ...
    var params = "mode=getHistoryQuery";
