...
<%
	...
	multilang_id.addElement("I_BD_006");
	multilang_id.addElement("BUTTON");
	multilang_id.addElement("MESSAGE");
	
	HashMap text = MessageUtil.getMessage(info,multilang_id);
	
	String screen_id = "I_BD_006";
...
var G_SERVLETURL   = "<%=POASRM_CONTEXT_NAME%>/servlets/ict.sepoa.svl.sourcing.bd_confirm_list_ict";
...
<%-- <s:grid screen_id="I_BD_006" grid_obj="GridObj" grid_box="gridbox"/> --%>
