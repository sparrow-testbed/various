...
<%
	...
	multilang_id.addElement("CT_051");
	...
	String screen_id = "CT_051";//help 파일에 사용
...
<script language="javascript">
	...
	function setContractSave() {
		...
		if(viewYN == "N"){
			alert("미리보기 후 임의서식을 등록하세요.");
			return;
		}
		
		if (confirm("임의서식을 등록 하시겠습니까?")) {
...
<input type="hidden" name="btn"          value="N"> 
<input type="hidden" name="seller_flag"  value="app"> 
<input type="hidden" name="cont_no"      value="CT201000613"> 
<input type="hidden" name="cont_gl_seq"  value="001"> 
<input type="hidden" name="cont_form_no" value=""> 
<input type="hidden" name="ct_flag"      value=""> 

<input type="hidden" name="input_flag" value="I"> 
<input type="hidden" name="cont_private_flag" value="PV"> 
<%
// 	 thisWindowPopupFlag = "true";
// 	 thisWindowPopupScreenName = "임의서식작성";
