...
<form name="form1" >
	<input type="hidden" name="s_factor_refitem" id="s_factor_refitem" value="<%=s_factor_refitem%>">
	<input type="hidden" name="recommendNum" id="recommendNum" value="<%=recommendNum%>">
...
%>
					<input type="text" class="inputsubmit" style="width:80%" id= "ScreeningItemName"  name="ScreeningItemName"  maxlength="50" <%=readOnly%>>
...
%>
		<tr>
			<td align="center" class="c_data_1_p_c" id="seq"><%=seq%></td>
			<td class="c_data_1_p"><input type="text" name="itemName" id="itemName_<%=i+1%>" class="inputsubmit" style="width:95%" value="<%=wf.getValue(i, 2)%>" maxlength="30" <%if(mode.equals("view")){%>readonly<%}%>></td>
			<td align="center" class="c_data_1_p_c"><input type="text" name="itemScore" id="itemScore_<%=i+1%>" class="inputsubmit" style="width:40%" value="<%=wf.getValue(i, 4)%>" maxlength="30" <%if(mode.equals("view")){%>readonly<%}%>></td>
		</tr>
...
%>
		<tr>
			...
			<td class="c_data_1_p"><input type="text" name="itemName" id="itemName_1" class="inputsubmit" style="width:95%" value="" maxlength="30"></td>
			<td align="center" class="c_data_1_p_c"><input type="text" name="itemScore" id="itemScore_1" maxlength="3" style="width:40%;IME-MODE:disabled;" onKeyDown="onOnlyNumber(this);" ></td>
		</tr>
		<tr>
			<td align="center" class="c_data_1_p_c">2</td>
			<td class="c_data_1_p"><input type="text" name="itemName" id="itemName_2" class="inputsubmit" style="width:95%" value="" maxlength="30"></td>
			<td align="center" class="c_data_1_p_c"><input type="text" name="itemScore" id="itemScore_2" maxlength="3" style="width:40%;IME-MODE:disabled;" onKeyDown="onOnlyNumber(this);" ></td>
		</tr>
		<tr>
			<td align="center" class="c_data_1_p_c">3</td>
			<td class="c_data_1_p"><input type="text" name="itemName" id="itemName_3"  class="inputsubmit" style="width:95%" value="" maxlength="30"></td>
			<td align="center" class="c_data_1_p_c"><input type="text" name="itemScore" id="itemScore_3" maxlength="3" style="width:40%;IME-MODE:disabled;" onKeyDown="onOnlyNumber(this);" ></td>
		</tr>
		<tr>
			<td align="center" class="c_data_1_p_c">4</td>
			<td class="c_data_1_p"><input type="text" name="itemName" id="itemName_4"  class="inputsubmit" style="width:95%" value="" maxlength="30"></td>
			<td align="center" class="c_data_1_p_c"><input type="text" name="itemScore" id="itemScore_4" maxlength="3" style="width:40%;IME-MODE:disabled;" onKeyDown="onOnlyNumber(this);" ></td>
		</tr>
		<tr>
			<td align="center" class="c_data_1_p_c">5</td>
			<td class="c_data_1_p"><input type="text" name="itemName" id="itemName_5" class="inputsubmit" style="width:95%" value="" maxlength="30"></td>
			<td align="center" class="c_data_1_p_c"><input type="text" name="itemScore" id="itemScore_5" maxlength="3" style="width:40%;IME-MODE:disabled;" onKeyDown="onOnlyNumber(this);" ></td>
		</tr>
<%
		}
%>
