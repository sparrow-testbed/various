...
<%
	...
	multilang_id.addElement("BR_005");
	multilang_id.addElement("BUTTON");
	multilang_id.addElement("MESSAGE");
	
	HashMap text = MessageUtil.getMessage(info,multilang_id);
	
	String screen_id = "BR_005";
...
--%>
<%
	String WISEHUB_PROCESS_ID="BR_005";
	...
	<table width="99%" border="0" cellspacing="0" cellpadding="0" >
		<tr>
			<td class='title_page' height="20" align="left" valign="bottom">
				<span class='location_end'>사전지원요청 수정</span>
			</td>
		</tr>
	</table>
...
<!-- 											<a href="javascript:Calendar_Open('returnhopeDay');"><img src="../../images/button/butt_calender.gif" align="absmiddle" border="0"></a> -->
									...
									<tr>
										<td width="15%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;시장조사요청번호</td>
										<td width="35%" class="data_td">
									...
									<tr>
										...
										<td width="35%" class="data_td">
											<s:calendar id="add_date" default_value="<%=SepoaString.getDateSlashFormat(ADD_DATE)%>" format="%Y/%m/%d" cssClass=" "/>
										</td>
...
btn("javascript:attach_file(document.getElementById('sign_attach_no').value, 'TEMP');", "파일등록");
		...
		<s:grid screen_id="BR_005" grid_obj="GridObj" grid_box="gridbox"/> 
	</form>
</s:header>
<s:footer/>
