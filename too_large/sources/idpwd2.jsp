...
$(document).ready(function(){
	...
	<%if("login_fail".equals(prev_url)){%>
		...
		window.location.href = "/common/idpwd2.jsp";
...
//		var params = "&user_id=" + $('#id').val() + "&password=" + $('#password').val();
	    ...
	    frm.mode.value   = "setLogin2";
	    frm.FromSite.value = "GAD2"
...
<form name="form1" id="form1">
	...
	<input type="hidden" name="FromSite"         id="FromSite"            value="GAD2"  />
	<input type="hidden" name="os_gb"            id="os_gb"               value="win10"  />
	
	<table width="520" border="0" cellspacing="10" cellpadding="0" bgcolor="#0083ca" style="width:520px; height:337px">
		<tr>
			<td bgcolor="#FFFFFF">
				<table width="500" style="height:182px" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td width="258" align="center" style="height:54px">
							<br />
							<img src="../images/intro/login_title.gif" width="350" height="49" />
						</td>
					</tr>
					<tr>
						...
						<td align="center" valign="top" style="height:107px">
							<table width="450" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									...
									<td height="29" align="right">
										<input type="password" name="password" id="password" npkencrypt="on" style="width:290px; height:25px"  onkeydown="enter_event('pass');" data-enc="on" />
									</td>
								</tr>
								<tr>
