...
<%
	...
	//20131209 sendakun
	HashMap text = MessageUtil.getMessageMap( info, "MESSAGE", "BUTTON", "I_CO_017_1" );
...
var G_SERVLETURL = "<%=POASRM_CONTEXT_NAME%>/servlets/ict.sepoa.svl.co.I_CO_017_Servlet";
