...
<%
	...
	SepoaOut value = ServiceConnector.doService(info, "MT_014", "TRANSACTION","getQuery_dataStore_POP_New", obj);
...
<%--
												<td width="15%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;<%=text.get("MT_014.VIEW_COUNT")%></td>
