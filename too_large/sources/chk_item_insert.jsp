...
<form name="form1" >
	<input type="hidden" name="c_factor_refitem" id="c_factor_refitem" value="<%=c_factor_refitem %>" >
...
<%
	if(mode.equals("update") || mode.equals("view")) {
%>
		<input type="text" class="input_data2" style="width:95%" value="<%=checkListItemName%>" name="checkListItemName" id="checkListItemName" maxlength="50" <%=readOnly%>>
<%
	} else {
%>
		<input type="text" class="text" style="width:95%" value="" name="checkListItemName" id="checkListItemName"  maxlength="50">
<%
	}
%>
	</td>
...
<%
		if(mode.equals("update")) {
%>
			<td class="c_data_1_p"><input type="text" name="itemName" id="itemName_<%=i+1 %>" class="text" style="width:95%" value="<%=wf.getValue(i, 2)%>" maxlength="30" <%=readOnly%>></td>
<%
		} else {
%>
...
%>	
				<input type="hidden" name="itemScore" id="itemScore"class="text" value="<%=wf.getValue(i, 4)%>" style="width:40" <%=readOnly%>>
		</tr>
<%
	}
%>
...
%>
		<tr>
			...
			<td class="c_data_1_p"><input type="text" name="itemName" id="itemName_1" class="text" style="width:95%" value="" maxlength="30"></td>
		...
		<tr>
			...
			<td class="c_data_1_p">
				<input type="text" name="itemName" id="itemName_6" class="text" style="width:95%" value="" maxlength="30">
			</td>
				<input type="hidden" name="itemScore" class="text" value="" style="width:40">
		</tr>
		<tr>
			...
			<td class="c_data_1_p">
				<input type="text" name="itemName" id="itemName_7" class="text" style="width:95%" value="" maxlength="30">
			</td>
				<input type="hidden" name="itemScore" class="text" value="" style="width:40">
		</tr>
<%
