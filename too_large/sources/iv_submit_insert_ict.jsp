...
<%
    ...
    String BIZ_SEQ                = request.getParameter("BIZ_SEQ");      
    ...
    String PUM_NO                 = request.getParameter("PUM_NO");
    String ANN_NO                 = request.getParameter("ANN_NO");      
    String CT_NM                  = request.getParameter("CT_NM");      
    String VENDOR_CODE            = request.getParameter("VENDOR_CODE");      
    String VENDOR_NAME        = request.getParameter("VENDOR_NAME");      
    String MATERIAL_CLASS1        = request.getParameter("MATERIAL_CLASS1");      
    String MATERIAL_CLASS2        = request.getParameter("MATERIAL_CLASS2");     
    String MATERIAL_CLASS1_LOC    = request.getParameter("MATERIAL_CLASS1_LOC");      
    String MATERIAL_CLASS2_LOC    = request.getParameter("MATERIAL_CLASS2_LOC");   
    String CT_USER_ID             = request.getParameter("CT_USER_ID");      
    String CT_USER_NAME           = request.getParameter("CT_USER_NAME");      
    
    
    if(CU              == null) CU              = "";
    if(BIZ_NO          == null) BIZ_NO          = "";
    if(BIZ_SEQ         == null) BIZ_SEQ         = "";
    if(BID_NO          == null) BID_NO          = "";
    if(BID_COUNT       == null) BID_COUNT       = "";
    if(VOTE_COUNT      == null) VOTE_COUNT      = "";
    if(PUM_NO          == null) PUM_NO          = "";
    if(ANN_NO          == null) ANN_NO          = "";
    if(CT_NM           == null) CT_NM           = "";
    if(VENDOR_CODE     == null) VENDOR_CODE     = "";
    if(VENDOR_NAME == null) VENDOR_NAME = "";
    if(MATERIAL_CLASS1 == null) MATERIAL_CLASS1 = "";
    if(MATERIAL_CLASS2 == null) MATERIAL_CLASS2 = "";
    if(MATERIAL_CLASS1_LOC == null) MATERIAL_CLASS1_LOC = "";
    if(MATERIAL_CLASS2_LOC == null) MATERIAL_CLASS2_LOC = "";
    if(CT_USER_ID == null) CT_USER_ID = "";
    if(CT_USER_NAME == null) CT_USER_NAME = "";
    ...
    if(!"C".equals(CU)){
    	...
    	mapData.put( "BIZ_SEQ", BIZ_SEQ );
    	
    	Object[]     obj = { mapData };
    	SepoaOut     so  = ServiceConnector.doService( info, "I_CT_001", "CONNECTION", "getIvInfo", obj );
    	SepoaFormater wf = new SepoaFormater( so.result[0] );

    	ATTACH_NO        = wf.getValue("IV_ATTACH_NO"    ,0);
    	ATTACH_CNT       = wf.getValue("IV_ATTACH_CNT"   ,0);		
    }
%>
<html>
<head>
...
// 	var rowcount = grid_array.length;
		...
		{
   			alert("업로드해야할 입찰서류가 첨부되지 않았습니다.");
   			return;
		}
        var f = document.forms[0];

        var Message = "업로드 하시겠습니까?";
    	...
    	$.post(
    		G_SERVLETURL,
    		{
    			...
    			biz_seq              	: document.getElementById("biz_seq").value,
    			...
    			pum_no               	: document.getElementById("pum_no").value,
    			ann_no               	: document.getElementById("ann_no").value,
    			ct_nm                	: document.getElementById("ct_nm").value,
    		...
    		function(arg){
    			...
    			if(result[1] == "true"){
    				alert(result[0]);
	    			location.href="iv_submit_list_ict.jsp";
    			}
...
// 	var rowcount = grid_array.length;
    	...
    	$.post(
    		...
    		function(arg){
    			...
    			if(result[1] == "true"){
    				alert(result[0]);
	    			location.href="bd_ct_submit_list_seller_ict.jsp";
    			}
...
<input type="hidden" name="biz_seq" 	    id="biz_seq" 	      value="<%=BIZ_SEQ         %>">                     
...
<input type="hidden" name="pum_no" 	        id="pum_no" 	      value="<%=PUM_NO          %>">                     
<input type="hidden" name="ann_no" 	        id="ann_no" 	      value="<%=ANN_NO          %>">                     
<input type="hidden" name="ct_nm" 	        id="ct_nm" 	          value="<%=CT_NM           %>">                     
...
<input type="hidden" name="material_class1_loc" id="material_class1_LOC"  value="<%=MATERIAL_CLASS1_LOC %>">                     
<input type="hidden" name="material_class2_loc" id="material_class2_LOC"  value="<%=MATERIAL_CLASS2_LOC %>"> 

<input type="hidden" name="ct_user_id"	    id="ct_user_id"       value="<%=CT_USER_ID %>">
<input type="hidden" name="ct_user_name"	id="ct_user_name"     value="<%=CT_USER_NAME %>">		                    
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td width="35%" class="data_td"><%=PUM_NO%></td>
      <td width="15%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;계약명</td>
      <td width="35%" class="data_td"><%=CT_NM%></td>
    </tr>
    <tr>
		<td colspan="4" height="1" bgcolor="#dedede"></td>
	</tr>     
    <tr>
     <td width="15%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;품목군</td>
      <td width="35%" class="data_td"><%=MATERIAL_CLASS1_LOC%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=MATERIAL_CLASS2_LOC%></td>
      <td width="15%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;계약자</td>
      <td width="35%" class="data_td"><%=CT_USER_NAME%> (<%=CT_USER_ID %>)</td>
    </tr>
	<tr>
		<td colspan="4" height="1" bgcolor="#dedede"></td>
	</tr>     
    <tr>
      <td class="title_td" width="15%">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;검수확인서 첨부<img src='/images/mail_point.gif'' border='0'></td>
      ...
      <td width="35%" class="data_td"><%=ANN_NO          %></td>
    </tr>
</table>
</td>
</tr>
  ...
  <table width="98%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td width="98%" height="30">
        <div align="right">
        <table><tr>
          <td><script language="javascript">btn("javascript:doSubmit()", "검수확인서 업로드")</script></td>
          </tr></table>  
        </div>
      </td>
    </tr>
