...
//      LIMIT_CRIT					 = WiseString.replace(LIMIT_CRIT, "\n","<br>");
...
var G_SERVLETURL   = "<%=POASRM_CONTEXT_NAME%>/servlets/sepoa.svl.sourcing.bd_confirm_popup";
...
function doBidStatus(pflag) {
    ...
    if(Long.parseLong(BID_END_DATE + BID_END_TIME) < Long.parseLong(current_date1 + current_time1)){ 
	%>
...
thisWindowPopupScreenName = "입찰자 적격 확인 처리";
%>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td class="title_td" width="20%">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;낙찰자선정</td>
      <td width="80%" class="data_td">&nbsp;
      <%=PROM_CRIT_NAME%>
      </td>
    </tr>
...
<tr>
	<td height="30" align="right">
		...
		<TR>
			...
			<TD><script language="javascript">btn("javascript:doBidStatus('RC');", "저 장")</script></TD>
...
<%-- <s:grid screen_id="BD_007" grid_obj="GridObj" grid_box="gridbox"/> --%>
