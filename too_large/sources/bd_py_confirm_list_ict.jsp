...
<%
	...
	multilang_id.addElement("I_BD_030");
	multilang_id.addElement("BUTTON");
	multilang_id.addElement("MESSAGE");
	
	HashMap text = MessageUtil.getMessage(info,multilang_id);
	
	String screen_id = "I_BD_030";
...
var G_SERVLETURL   = "<%=POASRM_CONTEXT_NAME%>/servlets/ict.sepoa.svl.sourcing.bd_py_confirm_ict";
...
function doQuery() {
    ...
    var params = "mode=getBdPyConfirmList";
...
function doCt2Confirm() { 
    ...
    for( var i = 0; i < grid_array.length; i++ ) {
            ...
            if(ATTACH_NO_H == ""){
          		alert("대금지급서류가 제출되지 않아 확인 불가합니다.");
          		return;
        	}
    ...
    var cols_ids = "<%=grid_col_id%>";
    var params = "mode=setBdPyConfirm";
