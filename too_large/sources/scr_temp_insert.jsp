...
<form name="form1" > 
	...
	<input type="hidden" name="s_template_refitem"id="s_template_refitem">
...
<tr>
	...
	<td class="c_data_1" width="85%">
		<input type="text" class="inputsubmit" style="width:95%;" value="<%=templateName%>" name="templateName" id="templateName" maxlength="50" <%=readOnly%>>
	</td>
</tr>
</table>
...
%>
		<TR>
			<TD class="c_data_1_p_c"  align="center">
				<input type="checkbox" name="factor_chk" id="factor_chk" <%if(!mode.equals("insert")) {%> disabled <%}%>>
...
<%				
				if(mode.equals("update")) { 
%>
					<input type="text" name="weight" id="weight"  maxlength="3" style="width:30%;IME-MODE:disabled;" onKeyDown="onOnlyNumber(this);"  value="<%=wf.getValue(i, 5)%>"> %
<%				
				} else { 
%>
					<input type="text" name="weight" id="weight" maxlength="3" style="width:30%;IME-MODE:disabled;" onKeyDown="onOnlyNumber(this);"  > %	
<%				
				} 
%>
				</TD>
