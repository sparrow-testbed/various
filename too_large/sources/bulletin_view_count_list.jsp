...
function doQuery()
{
		...
		GridObj.post("<%=POASRM_CONTEXT_NAME%>/servlets/sepoa.svl.admin.bulletin_view_count_list","seq="+seq+"&user_name="+user_name+"&company_name="+company_name+"&user_gubun="+user_gubun+"&user_ip="+user_ip+"&mode=query&grid_col_id="+grid_col_id+"&language="+language);
