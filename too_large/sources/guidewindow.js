var __guidewindow = function(__SANDBOX) {
...
XWC.getLocaleResource("guidewindow", XWC.lang());
...
function onload(aDialogObj) {
	...
	if (AnySign.mAnySignEnable)
		AnySign.mExtensionSetting.mDialog = gDialogObj;

	aElement.appendChild(document.createTextNode(XWC.S.info1));
	aElement.appendChild(XWC.UI.createElement("BR"));
	aElement.appendChild(document.createTextNode(XWC.S.info2));
		return 0;
}

var __1 = XWC.UI.createElement('DIV');
__1.style.width = '250px';
var __2 = XWC.UI.createElement('DIV');
__2.setAttribute('id', 'xwup_title_guidewindow', 0);
...
__4.style.textAlign = 'center';
var __5 = XWC.UI.createElement('IMG');
__5.setAttribute('src', AnySign.mBasePath+'/img/loader.gif', 0);
__4.appendChild(__5);
var __6 = XWC.UI.createElement('DIV');
__6.className = 'xwup-guidewindow';
__4.appendChild(__6);
__1.appendChild(__4);
__1.onload = onload;
