...
//    	CONT_GUBUN     			= JSPUtil.nullToEmpty(wf.getValue("CONT_GUBUN",				0));
    	...
    	CONT_DATE				= JSPUtil.convertDate(JSPUtil.nullToEmpty(wf.getValue("CONT_DATE",				0)), "/");
...
//    		document.form.cont_gubun.value = "<%=CONT_GUBUN%>";
		...
		*/
		...
		document.form.cont_price.value = add_comma("<%=CONT_PRICE %>", 0);
		
		document.form.pay_div_flag.value = "<%=PAY_DIV_FLAG %>";
...
%>
    ...
    function doUpdate() {
		...
		var x_purchase_qty          = "<%=TTL_ITEM_QTY%>"; // 구매수량
...
<body leftmargin="15" topmargin="6" onload="setGridDraw();initAjax();doSelect111();doAmtGubunChange();load_chele_cont_flag();">
<s:header>
<form name="form">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
						  	...
						  	<tr>
			        			...
			        			<td height="24" class="data_td">
			        				<input type="text" id="sign_person_id" name="sign_person_id" value="<%=SIGN_PERSON_ID%>" onkeyup="delInputEmpty('sign_person_id', 'sign_person_name')" size="10">
			        			<%if( !"N".equals(button) ){ %>
							...
							<tr>
						  	...
						  	<tr>
			        			...
			        			<td height="24" class="data_td">
				                	...
				                	<s:calendar id="cont_date" default_value="<%=CONT_DATE%>" format="%Y/%m/%d" />
			        			</td>        		
							</tr>
			        	  	<tr>
								<td colspan="6" height="1" bgcolor="#dedede"></td>
							...
							<tr>
						  	...
						  	<tr>
			        			...
			        			<td height="24" class="data_td">
			        				...
			        				%>
			        				<%=sNo %>
			        				<input type="hidden" size="20" id="bd_no" name="bd_no" value="<%=BD_NO%>" readonly>
			        				<input type="hidden" size="10" id="bd_count" name="bd_count" value="<%=BD_COUNT%>">
			        			</td>
						  	</tr>
						  	<tr>
								<td colspan="6" height="1" bgcolor="#dedede"></td>
		...
		<td style="padding:5 5 5 0" align="right">
			<TABLE cellpadding="2" cellspacing="0">
				<TR>
					...
					<% } else { %>
					<td><script language="javascript">btn("javascript:doUpdate()","수정")</script></td>
					<td><script language="javascript">btn("javascript:doConfrim()","확정")</script></td>
					<% } %>
				</TR>
			</TABLE>
		</td>
