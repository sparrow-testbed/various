...
<%
	...
	String LB_MATERIAL_TYPE = ListBox(request, "SL0518", info.getSession("HOUSE_CODE") + "#M040", "02");
%>
<html>
<head>
        	 ...
        	 for(var i = 0; i < grid_array.length; i++){
        		 var rowIndex   = GridObj.getRowIndex(grid_array[i]);
	           	...
	           	parent.opener.<%=callback%>(
					...
					GD_GetCellValueIndex(GridObj, rowIndex, INDEX_MODEL_NO),
...
<body onload="javascript:setGridDraw();setHeader();MATERIAL_TYPE_Changed();" bgcolor="#FFFFFF" topmargin="0" marginwidth="0" leftmargin="0" >
<s:header popup="true">
	<div>
		<table width="99%" border="0" cellspacing="0" cellpadding="0" >
			<tr>
				<td class='title_page' height="20" align="left" valign="bottom">
					<span class='location_end'>품목선택</span>
				</td>
			</tr>
		</table>
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td width="35%" class="data_td">
												<select name="MATERIAL_TYPE" class="input_re" onChange="javacsript:MATERIAL_TYPE_Changed();", id="MATERIAL_TYPE" disabled="true">
