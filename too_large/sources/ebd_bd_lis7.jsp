...
<%
	...
	multilang_id.addElement("PR_007");
	multilang_id.addElement("BUTTON");
	multilang_id.addElement("MESSAGE");
	
	HashMap text = MessageUtil.getMessage(info,multilang_id);
	
	String screen_id = "PR_007";
	String grid_obj  = "GridObj";
	boolean isSelectScreen = false;

	String WISEHUB_PROCESS_ID="PR_007";
...
//<!--
var G_SERVLETURL   = "<%=POASRM_CONTEXT_NAME %>/servlets/dt.ebd.ebd_bd_lis7";
...
<%
	if(isAdmin){ 
%>
											<input type="text" name="demand_dept" id="demand_dept" size="15" class="inputsubmit" value='' >
											<a href="javascript:PopupManager('DEMAND_DEPT');">
												<img src="<%=G_IMG_ICON%>" align="absmiddle" border="0" alt="">
											</a>
											<input type="text" name="demand_dept_name" id="demand_dept_name" size="20" class="input_data2" maxlength="15" value='' style="border:0">
<%
	}
	else{
%>
...
%>  
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr height="30">
				<TD  align="left">
					&nbsp;* 신청상태가 <font color="blue">신청</font> 이면<font color="red"> 출고전</font> , <font color="blue">출고(인도)</font> 이면 <font color="red">신청완료</font>							
		    	</TD>		
				<TD  align="right">
...
<%-- <s:grid screen_id="PR_007" grid_obj="GridObj" grid_box="gridbox"/> --%>
