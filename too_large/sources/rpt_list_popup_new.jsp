	...
	<table width="99%" border="0" cellspacing="0" cellpadding="0" >
		<tr>
			<td class='title_page' height="20" align="left" valign="bottom">
				<span class='location_end'>고객의 소리</span>
			</td>
		</tr>
	</table>
							...
							<table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#dedede">
								<tr>
									<td width="100%">
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td width="20%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;제목</td>
											...
											<tr>
												<td width="20%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;고객의소리 구분</td>
...
<%--
 ...
 --%>
												<td width="20%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;<%=text.get("MT_014.VIEW_COUNT")%></td>
												<td width="30%" class="data_td">
													<%=VIEW_COUNT%>
												</td>
											</tr>
											...
											<tr>
												<td style="background:#FFFFFF;padding:20px 5px 5px 5px;" height="450" colspan="4" class="content" valign="top">
													<%=CONTENT%>
												</td>
											</tr>
										</table>
