...
var click_row = "";
	 ...
	 */		
// 	function doSelect(vendor_code, name_loc, gubun, mat_code,SG_CODE1,SG_CODE2,SG_CODE3,SG_CODE4,mat_code_select,SOURCING_GROUP,industry_type)
// 	{

// 	     alert('left doSelect org'); 
// 		var param = "&vendor_code=" + encodeUrl(vendor_code) + "&name_loc=" + name_loc;
// 		param    += "&gubun="+gubun+"&mat_code="+mat_code+ "&industry_type="+ industry_type;			//Du 추가 For 업종 검색
// 		param    += "&SG_CODE1="+SG_CODE1;
// 		param    += "&SG_CODE2="+SG_CODE2;
// 		param    += "&SG_CODE3="+SG_CODE3;
// 		param    += "&SG_CODE4="+SG_CODE4;
// 		param    += "&mat_code_select="+mat_code_select;
// 		param    += "&SOURCING_GROUP="+SOURCING_GROUP;		
// 		alert(param); 
...
// 	}
     ...
     * @Function 설명  : 구매요청목록(품목) > 조회
     */     
    function doSelect(seller_code, name_loc, type, sg_code1, sg_code2, sg_code3, sg_code4, sg_code5, gp_code1, gp_code2, company_code)
    {
        var param = "";
        ...
        param    += "&gp_code1="    + gp_code1   ; 
        param    += "&gp_code2="    + gp_code2   ;         
...
<form name="form">
	<table width="98%" border="0" cellspacing="0" cellpadding="0">
		<tr>
	  		<td width="78%" >&nbsp;&nbsp;&nbsp;<b><%-- 전체업체 --%><%=text.get("PU_112_2.TEXT_0001")%></b>
	  		</td>
		</tr>
		<tr>
