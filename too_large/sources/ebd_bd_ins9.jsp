...
<%
	...
	multilang_id.addElement("PR_039");
	multilang_id.addElement("BUTTON");
	multilang_id.addElement("MESSAGE");
	
	HashMap text = MessageUtil.getMessage(info,multilang_id);
	
	String  screen_id             = "PR_039";
	String  grid_obj              = "GridObj";
	String  WISEHUB_PROCESS_ID    = "PR_039";
...
function fnBodyOnLoad(){
	fnCategory();
	setGridDraw();
	//fnMiddleMenuProductList("03","03091");
	//fnMiddleMenuProductList(1,1);
	//alert(1);
	//fnMiddleMenuProductList(1,1);
	//var bigMenuCode                   = bigMenuCodeArray[1];
	//var middleMenuCode                = middleMenuCodeArray[1][1];
	...
	var categoryTableDisplayTable     = document.getElementById("categoryTable");
	categoryTableDisplayTable.style.display     = "none";
	setTimeout("fnMiddleMenuProductList(0,1)",1000);
}
...
function fnList(){
	...
	document.getElementById("DESCRIPTION_LOC").value = "";
	...
	if( (materialType == "") &&
		...
		(materialClass1 == "") &&
		(materialClass2 == "") ){
		alert("품목 카테고리 선택후  조회하여 주시기 바랍니다.");
		return;
	}
...
function fnList2(){
	...
	var verySmallCategoryDisplayTableDisplayTable     = document.getElementById("verySmallCategoryDisplayTable");
	verySmallCategoryDisplayTableDisplayTable.style.display     = "none";
	
	document.getElementById("MATERIAL_TYPE").value = "03";
	document.getElementById("MATERIAL_CTRL_TYPE").value = "03091";
	document.getElementById("MATERIAL_CLASS1").value = "";
	document.getElementById("MATERIAL_CLASS2").value = "";
	...
	if( (itemNo == "") &&
		(descriptionLoc == "") ){
		alert("품목코드 또는 품목명을 입력하고 조회하여 주시기 바랍니다.");
...
function fnRequest(){
	...
	if(checkCount > 1){
		alert("안내장은 선택은 1건씩만 신청가능합니다.\r\n\r\n안내장은 신청 즉시 출고요청 됩니다.(전결권자 승인 불필요)");
		return;
	}
	
	var confirm_msg = "신청 하시겠습니까?\r\n\r\n안내장은 신청 즉시 출고요청 됩니다.(전결권자 승인 불필요)";
	if(checkCount == 1){
		if(confirm(confirm_msg)){
//			document.getElementById("material_ctrl_type").value = material_ctrl_type_before;
			var grid_array = getGridChangedRows(GridObj, "SELECTED");
			var params = "?mode=setPrCreate_NonApp2";
						...
						<tr>
							<td width="100%">
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td width="7%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;품목코드</td>
										<td width="14%" class="data_td">
											<input type="text" id="ITEM_NO" name="ITEM_NO" style="ime-mode:inactive" value="" onkeydown="JavaScript: KeyFunction('Enter');">
										</td>
										<td width="7%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;품목명</td>
										<td width="14%" class="data_td">
											<input type="text" id="DESCRIPTION_LOC" name="DESCRIPTION_LOC" value="" onkeydown="JavaScript: KeyFunction('Enter');">
										</td>
										<TD  width="7%"  class="data_td" align="right">
											<script language="javascript">
											btn("javascript:fnList2();","조회");
											</script>
										</TD>
										<TD  width="7%"  class="data_td" align="left">
											<script language="javascript">
											btn("javascript:fnRequest();","신청");
											</script>
										</TD>
										<td   width="44%"  class="data_td" align="left">
											&nbsp;* <font color="blue" size="10">안내장은 선택은 1건씩만 신청가능합니다.</font><br>
											&nbsp;* <font color="red" size="10">안내장은 신청 즉시 출고요청 됩니다.(전결권자 승인 불필요)</font><br>
											&nbsp;* <a href="javascript:topMenuClick('/kr/dt/ebd/ebd_bd_lis7.jsp','MUO141000013', '1','')" class="summary_no"><font color="red">안내장신청결과</font>는 <font color="blue">"구매관리 / 구매요청 / 안내장신청현황"</font> 에서 확인 하세요. <font color="red">(클릭)</font></a>
										</td>
									</tr>
								</table>
							</td>
...
<%-- <s:grid screen_id="PR_039" grid_obj="GridObj" grid_box="gridbox" /> --%>
