...
<% String WISEHUB_PROCESS_ID="AP_004";%>
<%@ include file="/include/code_common.jsp"%>
...
function Query(type){
 ...
 if(type == "close")
 {
	...
	var url	= "<%=POASRM_CONTEXT_NAME%>/servlets/sepoa.svl.approval.ap_complete_list";
	param += dataOutput();
...
<%-- <s:grid screen_id="AP_004" grid_obj="GridObj" grid_box="gridbox"/> --%>
