...
<%
	//HTML에 쓰일 변수들
	String TITLE = String.valueOf(text.get("FQ_002.MSG_0105"));//"FAQ 수정";
%>
...
function Update()
{
	...
	{
		//alert("제목은 필수 입력입니다.");
		alert("<%=text.get("FQ_002.MSG_0103")%>");
		return;
	}
	...
	{
		//alert("내용은 필수 입력입니다.");
		alert("<%=text.get("FQ_002.5000")%>");
		return;
	}

    F.method = "POST";
    F.target = "child_Work1";
    F.action = "faq_list_wk_upd_new.jsp?SEQ=<%=SEQ%>";

    F.submit();
    
    <%--
	var jqa = new jQueryAjax();
	jqa.action = "faq_list_wk_upd_new.jsp";
...
function Cancel()
{
    if(!confirm("<%=text.get("FQ_002.MSG_0104")%>"))//취소 하시겠습니까?
		return;
...
<%
	...
	SepoaOut value = ServiceConnector.doService(info, "MT_014", "CONNECTION","getQuery_FAQ_POP_New", obj);
		...
		<TABLE cellpadding="0" cellspacing="0" border="0" width="100%">
         ...
         <table width="100%" border="0" cellspacing="0" cellpadding="1">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
		        	<td width="15%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;<%=text.get("FQ_001.MSG_0102")%></td>
		            <td class="data_td">
			    ...
			    <tr>
		        	<td width="15%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;<%=text.get("FQ_001.MSG_0106")%></td>
		            <td class="data_td">
			    ...
			    <tr>
		        	<td width="15%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;<%=text.get("FQ_001.gongji_gubun")%></td>
		            <td class="data_td">
		            ...
		            <td class="data_td">
						 <TABLE >
		      			<TR>
							...
							<td><script language="javascript">btn("javascript:attach_file(document.forms[0].ATTACH_NO.value,'NOT')","<%=text.get("FQ_002.0004")%>")</script></td>
