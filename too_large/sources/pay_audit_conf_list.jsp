...
<%
	...
	multilang_id.addElement("TX_017");
	multilang_id.addElement("BUTTON");
	multilang_id.addElement("MESSAGE");
	
	HashMap text = MessageUtil.getMessage(info,multilang_id);
	
	String screen_id = "TX_017";
...
<%
	...
	//////////////////ClipReport4 선언부 시작///////////////////////////////////////////////////////////
	String _rptName          = "020644/rpt_pay_audit_conf_list"; //리포트명
...
function clipPrint(rptAprvData,approvalCnt) {
	...
	for(var i = 0; i < GridObj.GetRowCount(); i++){	
		...
		sRptData += rf;
		sRptData += GridObj.GetCellValue("AUDIT_USER_ID",i);
		sRptData += rf;
...
<s:grid screen_id="TX_017" grid_obj="GridObj" grid_box="gridbox"/>
<s:footer/>
