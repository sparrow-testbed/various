...
<%
    ...
    if(!"C".equals(CU)){
    	...
    	Object[]     obj = { mapData };
    	SepoaOut     so  = ServiceConnector.doService( info, "I_CT_001", "CONNECTION", "getCtInfo", obj );
    	SepoaFormater wf = new SepoaFormater( so.result[0] );

    	ATTACH_NO        = wf.getValue("CT_ATTACH_NO"    ,0);
    	ATTACH_CNT       = wf.getValue("CT_ATTACH_CNT"   ,0);		
    }
%>
<html>
<head>
...
// 	var rowcount = grid_array.length;
    	...
    	$.post(
    		...
    		function(arg){
    			...
    			if(result[1] == "true"){
    				alert(result[0]);
	    			location.href="ct_submit_list_ict.jsp";
    			}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td class="title_td" width="15%">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;계약서 첨부<img src='/images/mail_point.gif'' border='0'></td>
  ...
  <table width="98%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td width="98%" height="30">
        <div align="right">
        <table><tr>
          <td><script language="javascript">btn("javascript:doSubmit()", "계약서 업로드")</script></td>
          </tr></table>  
        </div>
      </td>
    </tr>
