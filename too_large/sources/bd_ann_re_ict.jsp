...
<!--
    ...
    function checkData() {
		...
		// 시간 체크        
        if(LRTrim(document.form1.BID_BEGIN_TIME_HOUR_MINUTE.value) == "")  {
            alert("입찰일시 시작시간을 입력하셔야 합니다.");
            document.forms[0].BID_BEGIN_TIME_HOUR_MINUTE.focus();
            return false;
        }

        if(LRTrim(document.form1.BID_END_TIME_HOUR_MINUTE.value) == "")  {
            alert("입찰일시 종료시간을 입력하셔야 합니다.");
            document.forms[0].BID_END_DATE.focus();
            return false;
        }
    ...
    function doConfirm() {
        ...
        var OPEN_TIME_HOUR_MINUTE      	= BID_END_TIME; // 개찰일시 (tohour)
        var OPEN_DATE               	= BID_END_DATE; // 개찰일시 (from)
        var OPEN_TIME               	= BID_END_TIME;
    ...
    function fnMinute(){
		var strBegin = document.form1.BID_BEGIN_TIME_HOUR_MINUTE.value;
		var strEnd   = document.form1.BID_END_TIME_HOUR_MINUTE.value;
					...
					<tr>
						<td width="100%">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">	
									...
									<td colspan="3" id="g4" class="data_td">
										<span id="g5"> 
											...
											<input type="text" name="BID_BEGIN_TIME_HOUR_MINUTE" id="BID_BEGIN_TIME_HOUR_MINUTE"
													...
													onKeyPress="checkNumberFormat('[0-9]');" onBlur="javascript:fnMinute();">
											&nbsp;&nbsp;~&nbsp;&nbsp; 
								...
								<tr id="g14" style="display:none">
									<td class="title_td" id="g15">
										<span id="g16">
											&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">
											&nbsp;&nbsp;개찰일시
										</span>
