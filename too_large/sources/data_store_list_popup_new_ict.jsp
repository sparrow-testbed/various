...
//	if(this_window_popup_flag.trim().length() <= 0) this_window_popup_flag = "false";
	...
	thisWindowPopupScreenName = (String) text.get("I_MT_014.MSG_0100");
%>
								...
								<tr>
									<td width="100%">
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											...
											<tr>
<%--
												<td width="13%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;<%=text.get("I_MT_014.COMPANY_NAME")%></td>
												<td width="20%" class="data_td">
													<%=COMPANY_NAME%>
												</td>
												<td width="13%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;<%=text.get("I_MT_014.DEPT_TYPE")%></td>
												<td width="20%" class="data_td">
													<%=DEPT_TYPE%>
												</td>
 --%>
												<td width="13%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;<%=text.get("I_MT_014.VIEW_COUNT")%></td>
												<td class="data_td">
													<%=VIEW_COUNT%>
												</td>
											</tr>
