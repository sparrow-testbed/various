...
<%
	...
	multilang_id.addElement("ST_007");
	multilang_id.addElement("BUTTON");
	multilang_id.addElement("MESSAGE");
	
	HashMap text = MessageUtil.getMessage(info,multilang_id);
	
	String screen_id = "ST_007";
	String grid_obj  = "GridObj";
	boolean isSelectScreen = false;
	String G_IMG_ICON     = "/images/ico_zoom.gif"; // 이미지 
%>
<% String WISEHUB_PROCESS_ID="ST_007";%>
...
setHeader();
	...
	/* function setFormat() {
		GridObj.SetNumberFormat("PO_CNT"			,G_format_qty);
		GridObj.SetNumberFormat("CT_CNT"			,G_format_qty);
	...
	function EndGridQuery() {
		...
		if(mode == "getStaLTUserList"){
			GridObj.AddSummaryBar('SUMMARY1', '합계', 'summaryall', 'sum', 'PO_CNT,CT_CNT');
	...
	function doSelect() {
		...
		/* var servlet_url ="/servlets/statistics.sta_bd_lis11";

		GridObj.SetParam("mode", 				"getStaLTUserList");
		...
		var G_SERVLETURL ="<%=POASRM_CONTEXT_NAME%>/servlets/statistics.sta_bd_lis11"; 
		var cols_ids = "<%=grid_col_id%>";
        var params = "mode=getStaLTUserList";
...
<tr>
	...
	<td width="15%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;발주/계약구분
	</td>
	<td width="35%" class="data_td">
        <select name="flag" id="flag" class="inputsubmit">
        <option value="">전체</option>
        <option value="PO">발주</option>
        <option value="CT">계약</option>
        </select>
	</td>
</tr>
				<tr>
...
<tr>
	...
	<td width="35%" class="data_td" colspan="3">
		<input type="text" name="ctrl_person_id" id="ctrl_person_id" style="ime-mode:inactive" size="15" class="inputsubmit" value="" onkeydown='entKeyDown()'>
		...
		<input type="text" name="ctrl_person_name" id="ctrl_person_name" size="20" class="input_data2" readOnly  value="" onkeydown='entKeyDown()'>
...
<s:grid screen_id="ST_007" grid_obj="GridObj" grid_box="gridbox"/>
<s:footer/>
</body>
</html>
