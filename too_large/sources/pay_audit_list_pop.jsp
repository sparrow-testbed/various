...
<%
	...
	multilang_id.addElement("TX_020");
	multilang_id.addElement("BUTTON");
	multilang_id.addElement("MESSAGE");
	
	HashMap text = MessageUtil.getMessage(info,multilang_id);
	
	String screen_id = "TX_020";
...
<%
	...
	String doc_no			= JSPUtil.nullToEmpty(request.getParameter("pay_send_no"));
...
<s:grid screen_id="TX_020" grid_obj="GridObj" grid_box="gridbox"  height="150"/>
<s:footer/>
