...
<%
	...
	multilang_id.addElement("I_SBD_013");
	multilang_id.addElement("BUTTON");
	multilang_id.addElement("MESSAGE");
	
	HashMap text = MessageUtil.getMessage(info,multilang_id);
	
	String screen_id = "I_SBD_013";
...
function doQuery() {
    ...
    var params = "mode=getBdPySubmitList";
...
//     }
	...
	f.target                   = "_self"; 
	f.method                   = "post";   
	f.action = "bd_py_submit_seller_insert_ict.jsp";
	f.submit();
}
    ...
    <tr>
      <td height="30">
        ...
        <table><tr>
          ...
          <td><script language="javascript">btn("javascript:doQtSubmit()", "대금지급서류제출")</script></td>
		  <td><script language="javascript">btn("javascript:doQtCancel()", "대금지급서류제출취소")</script></td>
		  </tr></table>  
        </div>
      </td>
    </tr>
