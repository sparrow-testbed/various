<!--
 Title:        	checkDuplicateIrsNo.jsp  <p>
 Description:  	회원가입(사업자 등록번호 중복체크 popup)
 Copyright:    	Copyright (c) <p>
 Company:      	ICOMPIA <p>
 @author        SHYI
 @version      	1.0.0
 @Comment       사업자 등록번호 중복체크 popup
-->

<!-- PROCESS ID 선언 -->
<% String WISEHUB_PROCESS_ID="s6006";%>
<!-- 사용 언어 설정 -->
...
<!--
		function Next()
		{
			...
			if(job_status == ""){ // ICOMVNGL에 없으므로 신규업체
				...
				if(confirm("반려되었습니다. 관리자에게 문의하십시요.\n재가입 신청을 진행하시겠습니까?"))
