...
function find_id()
{
	...
	MM_openBrWindow("/kr/master/user/find_id.jsp?lang=<%=browser_language%>", "system_pic", "450", "250");
}
      ...
      <td width="258" rowspan="2" valign="top"><table width="258" height="500" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="193" valign="top"><table width="258" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td align="left" valign="top" style="height:95px"><a href="javascript:open_idpwd();"><img src="/images/intro/btn_login_bidding.gif" width="122" height="79" border="0"></a></td>              
        ...
        <tr>
          <td valign="top"><table width="258" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td height="84" align="left" valign="top"><img src="/images/intro/banner3.gif" width="126" height="77"></td>
