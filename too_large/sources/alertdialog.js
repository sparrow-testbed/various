var __alertDialog = function(__SANDBOX) {
...
XWC.getLocaleResource("alertDialog", XWC.lang());

function onload(aDialogObj) {
    gDialogObj = aDialogObj;

	__6.appendChild(document.createTextNode(XWC.S.message1));
	__6.appendChild(document.createElement("BR"));
	__6.appendChild(document.createElement("BR"));
	__6.appendChild(document.createTextNode(XWC.S.message2));
	__6.appendChild(document.createElement("BR"));
	__6.appendChild(document.createTextNode(XWC.S.message3));
	__6.appendChild(document.createElement("BR"));
	__6.appendChild(document.createElement("BR"));
	__6.appendChild(document.createTextNode(XWC.S.message4));
	__6.appendChild(document.createElement("BR"));
	__6.appendChild(document.createTextNode(XWC.S.message5));
	__6.appendChild(document.createElement("BR"));
	__6.appendChild(document.createElement("BR"));
	__6.appendChild(document.createTextNode(XWC.S.message6));

	var element;
	var infoElement = document.getElementById("xwup_underinfo");

	if (XecureWeb.mPlatform == XecureWeb.mPlatformList[2]) {
		element = XWC.UI.createElement("a");
		element.setAttribute("href", XWC.S.URL1);
		element.appendChild(document.createTextNode(XWC.S.info2));
		infoElement.appendChild(element);
	} else if (XecureWeb.mPlatform == XecureWeb.mPlatformList[3]) {
		element = XWC.UI.createElement("a");
		element.setAttribute("href", XWC.S.URL2);
		element.appendChild(document.createTextNode(XWC.S.info3));
		infoElement.appendChild(element);
	} else if (XecureWeb.mPlatform == XecureWeb.mPlatformList[0]) {
		var element1, element2, element3, element4;

		element1 = XWC.UI.createElement("a");
		element1.setAttribute("href", XWC.S.URL3);
		element1.appendChild(document.createTextNode(XWC.S.info4));
		element1.appendChild(document.createElement("BR"));

		infoElement.appendChild(element1);

		element2 = XWC.UI.createElement("a");
		element2.setAttribute("href", XWC.S.URL4);
		element2.appendChild(document.createTextNode(XWC.S.info5));
		element2.appendChild(document.createElement("BR"));

		infoElement.appendChild(element2);

		element3 = XWC.UI.createElement("a");
		element3.setAttribute("href", XWC.S.URL5);
		element3.appendChild(document.createTextNode(XWC.S.info6));
		element3.appendChild(document.createElement("BR"));

		infoElement.appendChild(element3);

		element4= XWC.UI.createElement("a");
		element4.setAttribute("href", XWC.S.URL6);
		element4.appendChild(document.createTextNode(XWC.S.info7));
		element4.appendChild(document.createElement("BR"));

		infoElement.appendChild(element4);

	} else {
		element = XWC.UI.createElement("a");
		element.setAttribute("href", XWC.S.URL7);
		element.appendChild(document.createTextNode(XWC.S.info8));
		infoElement.appendChild(element);
	}
...
__5.setAttribute('id', 'xwup_info', 0);
__4.appendChild(__5);
var __6 = XWC.UI.createElement('TEXTAREA');
__6.setAttribute('cols', '15', 0);
__6.setAttribute('rows', '7', 0);
__6.setAttribute('tabindex', '4', 0);
__6.setAttribute('id', 'xwup_alertDialog_textview', 0);
__6.className = 'xwup-textview3';
__6.setAttribute('readonly', '', 0);
__4.appendChild(__6);
var __7 = XWC.UI.createElement('DIV');
__7.className = 'xwup-verify-info';
__7.setAttribute('id', 'xwup_underinfo', 0);
var __8 = XWC.UI.createElement('DIV');
__8.className = 'info';
__8.appendChild(document.createTextNode(XWC.S.info1));
__7.appendChild(__8);
__4.appendChild(__7);
var __9 = XWC.UI.createElement('DIV');
__9.style.textAlign = 'right';
__9.appendChild(document.createTextNode(XWC.S.info9));
__4.appendChild(__9);
var __10 = XWC.UI.createElement('DIV');
__10.style.textAlign = 'right';
__10.appendChild(document.createTextNode(XWC.S.info10));
__4.appendChild(__10);
var __11 = XWC.UI.createElement('DIV');
__11.className = 'xwup-buttons-layout';
var __12 = XWC.UI.createElement('BUTTON');
__12.setAttribute('tabindex', '4', 0);
__12.setAttribute('type', 'button', 0);
__12.setAttribute('id', 'xwup_cancel', 0);
__12.onclick = function(event) {onCancelButtonClick()};
__12.appendChild(document.createTextNode(XWC.S.button_cancel));
