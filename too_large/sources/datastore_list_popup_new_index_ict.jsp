...
<%
	...
	SepoaOut value = ServiceConnector.doService(info, "I_MT_014", "TRANSACTION","getQuery_dataStore_POP_New", obj);
//  	SepoaOut value = ServiceConnector.doService(info, "I_MT_014", "CONNECTION","getQuery_NOTICE_POP_New", obj);
    ...
    int checkVal = 0;
	String title = String.valueOf(text.get("I_MT_014.MSG_0100"));// "공지사항";
	String readOnly = "";
...
function view_count_list_popup(){
	...
	var url = "../admin/dataStore_view_count_list.jsp?seq="+seq;

	CodeSearchCommon(url,'dataStore_view_count_list','0','0','700','600');
}
</script>
</head>
							...
							<table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#dedede">
								<tr>
									<td width="100%">
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td width="15%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;제목</td>
												<td class="data_td">
													<%=SUBJECT%>
												</td>
<%--
												<td width="15%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;<%=text.get("I_MT_014.VIEW_COUNT")%></td>
