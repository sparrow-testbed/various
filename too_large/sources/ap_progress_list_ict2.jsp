...
<%
	...
	multilang_id.addElement("I_AP_003");
	multilang_id.addElement("BUTTON");
	multilang_id.addElement("MESSAGE");
	
	HashMap text = MessageUtil.getMessage(info,multilang_id);
	
	String screen_id = "I_AP_003";
...
<% String WISEHUB_PROCESS_ID="I_AP_003";%>
<%@ include file="/include/code_common.jsp"%>
...
function Query(type){
 ...
 if(type == "close")
 {
	...
	var url	= "<%=POASRM_CONTEXT_NAME%>/servlets/ict.sepoa.svl.approval.ap_progress_list_ict";
	param += dataOutput();
...
<%-- <s:grid screen_id="I_AP_003" grid_obj="GridObj" grid_box="gridbox"/> --%>
