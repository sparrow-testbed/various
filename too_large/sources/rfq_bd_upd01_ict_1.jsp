...
function setHeader() {
	...
	document.form1.szTime.value = '<%=SZTIME%>';
...
function getApprovalSend(approval_str){
	var servletUrl = "<%=POASRM_CONTEXT_NAME%>/servlets/ict.dt.rfq.rfq_bd_upd1";
...
<s:header popup="true">
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td align="left" class="title_page">견적요청 (수정)</td>
		</tr>
	</table>
	...
	<td width="100%">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td class="data_td">
					<select name="sel_item_no" id="sel_item_no" style="ime-mode:disabled" disabled readonly class="inputsubmit">
...
%>
				...
				<td class="data_td">
					<input type="text" name="txt_item_cn" id="txt_item_cn" style="width:70px" value="<%=ITEM_CN%>"  onKeyUp="return chkMaxByte(19, this, '수량');">
				</td>
			</tr>											
			<tr>
				<td colspan="4" height="1" bgcolor="#dedede"></td>
			...
			<tr>				
				...
				<td width="35%" class="data_td">
					...
					시
					<input type="text" name="szMin" id="szMin"  value='<%=SZMIN%>' size="2" maxLength="2" style="ime-mode:disabled" onKeyPress="checkMin('[0-9]')">
					분
				</td>
				...
				<td width="85%" class="data_td" colspan=3>
					<input type="text" name="txt_rfq_id" id="txt_rfq_id" size="16" maxlength="10"  value='<%=RFQ_ID%>'  readOnly>
			...
			<tr>
				...
				<td class="data_td" colspan="3" height="150px">
					<table width="98%" >
						<tr>
							<td>
								<textarea name="txt_rmk_txt" id="txt_rmk_txt" class="inputsubmit" style="width: 98%; height: 140px" rows="5" onKeyUp="return chkMaxByte(4000, this, '비고');"></textarea>
							</td>
						</tr>
					</table>
				</td>
