...
<%
	...
	multilang_id.addElement("I_BD_026");
	multilang_id.addElement("BUTTON");
	multilang_id.addElement("MESSAGE");
	
	HashMap text = MessageUtil.getMessage(info,multilang_id);
	
	String screen_id = "I_BD_026";
...
//     }
	...
	f.target                   = "_self"; 
	f.method                   = "post";   
	f.action = "bd_ct_submit_seller_insert_ict.jsp";
	f.submit();
}
    ...
    <tr>
      <td height="30">
        ...
        <table><tr>
          ...
          <td><script language="javascript">btn("javascript:doQtSubmit()", "계약서류 업로드")</script></td>
		  <td><script language="javascript">btn("javascript:doQtCancel()", "계약서류 업로드 취소")</script></td>
		  </tr></table>  
        </div>
      </td>
    </tr>
