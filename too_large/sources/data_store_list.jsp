...
<% } %>
	...
	function doSelect()
	{
		...
		GridObj.post("<%=POASRM_CONTEXT_NAME%>/servlets/sepoa.svl.admin.bulletin_list_new","gubun="+gubun+"&quest="+quest+"&company_code="+company_code+"&dept_type="+dept_type+"&view_user_type="+view_user_type+"&language="+language+"&mode=getDataStore&grid_col_id="+grid_col_id);
	...
	function doUpdate()
	{
		...
		location.href = "data_store_list_upd.jsp?select_seq="+select_seq;
	...
	function doDelete()
	{
	   ...
	   if (confirm("<%=text.get("DS_002.0001")%>")){
		    ...
		    myDataProcessor = new dataProcessor("<%=POASRM_CONTEXT_NAME%>/servlets/sepoa.svl.admin.bulletin_list_new?cols_ids="+cols_ids+"&mode=setDataStoreDelete");
...
/* 	document.form1.method = "POST";
	...
	jqa.action = "data_store_view_count_update.jsp";
	jqa.submit();
}

function popup(seq)
{
	var url = "../admin/data_store_list_popup_new.jsp?seq="+seq;
