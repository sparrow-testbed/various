...
<%
	...
	multilang_id.addElement("I_SBD_012");
	multilang_id.addElement("BUTTON");
	multilang_id.addElement("MESSAGE");
	
	HashMap text = MessageUtil.getMessage(info,multilang_id);
	
	String screen_id = "I_SBD_012";
...
%> 
<!--
 title_tdle:   계약서제출리스트<p>
 Description:  계약서제출리스트<p>
...
function doQuery() {
    ...
    var params = "mode=getBdCt2SubmitList";
...
//     }
	...
	f.target                   = "_self"; 
	f.method                   = "post";   
	f.action = "bd_ct_submit_seller_insert_ict2.jsp";
	f.submit();
}
    ...
    <tr>
      <td height="30">
        ...
        <table><tr>
          ...
          <td><script language="javascript">btn("javascript:doQtSubmit()", "계약서류제출")</script></td>
		  <td><script language="javascript">btn("javascript:doQtCancel()", "계약서류제출취소")</script></td>
		  </tr></table>  
        </div>
      </td>
    </tr>
