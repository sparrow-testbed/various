...
<%
	...
	HashMap text               = null;
	String  screen_id          = "AD_800";
	String  grid_obj           = "GridObj";
	String  G_IMG_ICON         = "/images/ico_zoom.gif";
	boolean isSelectScreen     = false;

	multilang_id.addElement("AD_800");
	multilang_id.addElement("BUTTON");
	multilang_id.addElement("MESSAGE");
	
	String job_date = JSPUtil.nullToRef(request.getParameter("job_date"),SepoaString.getDateSlashFormat(SepoaDate.getShortDateString()));
...
function doSelect(){
	var params = "mode=selectUserlogList";
...
<tr>
	<td width="100%">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>				
				<td width="15%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;실행일시<font style="color: red;">*</font></td>
				<td width="35%" class="data_td"  align="left">
					<s:calendar id="job_date" default_value="<%=job_date%>" format="%Y/%m/%d"/>&nbsp;&nbsp;
				...
				<td width="15%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;실행배치</td>
				<td width="35%" class="data_td"  align="left">
					<select name="process_id" id="process_id" class="inputsubmit">
                         <option value="" selected="selected">전체</option>
                         <option value="AutoPaySms"         >AutoPaySms         </option>
                         <option value="SPSample"           >SPSample           </option>
                         <option value="AutoBidBatchProcess">AutoBidBatchProcess</option>
                         <option value="SPUser"             >SPUser             </option>
                         <option value="SPSzip2"            >SPSzip2            </option>
                         <option value="AutoUmsSend"        >AutoUmsSend        </option>
                         <option value="SPReturntax"        >SPReturntax        </option>
                         <option value="SPEpabadinfo"       >SPEpabadinfo       </option>
                         <option value="AutoUmsRecv"        >AutoUmsRecv        </option>
                         <option value="SPDept"             >SPDept             </option>
                         <option value="AutoBid_ict"        >AutoBid_ict        </option>
                         <option value="SPIlgae"            >SPIlgae            </option>                                                    										     									
        			</select>
				</td>				
			</tr>			
		</table>
...
<s:grid screen_id="AD_800" grid_obj="GridObj" grid_box="gridbox"/>
<s:footer/>
</body>
</html>