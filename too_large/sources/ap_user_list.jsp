...
<%
	...
	multilang_id.addElement("AP_002");
	multilang_id.addElement("BUTTON");
	multilang_id.addElement("MESSAGE");
	
	HashMap text = MessageUtil.getMessage(info,multilang_id);
	
	String screen_id = "AP_002";
...
function Query() {
	...
	var url	= "<%=POASRM_CONTEXT_NAME%>/servlets/sepoa.svl.approval.ap_user_list";
	param += dataOutput();
...
<s:grid screen_id="AP_002" grid_obj="GridObj" grid_box="gridbox"/>
<s:footer/>
</body>
</html>
