...
<%
	...
	multilang_id.addElement("SUP_002");
	multilang_id.addElement("BUTTON");
	multilang_id.addElement("MESSAGE");
	
	HashMap text = MessageUtil.getMessage(info,multilang_id);
	
	String screen_id = "SUP_002";
	String grid_obj  = "GridObj";
	boolean isSelectScreen = false;

%>
<!-- PROCESS ID 선언 -->
<% String WISEHUB_PROCESS_ID="SUP_002";%>
...
<%
	...
	SepoaOut value = ServiceConnector.doService(info, "s6030", "CONNECTION","getWokrType", obj);
...
function Init(){
	...
	function setHeader() {
		...
		// 2011.3.25 정민석  supplier 직책 부분 hidden 처리
		/* GridObj.AddHeader("HOUSE_CODE",		"","t_text",10,0,false);
		GridObj.AddHeader("SIGN_STATUS",		"","t_text",10,0,false); */


		//GridObj.SetColCellBgColor("USER_ID",			"194|207|239");
	...
	function doSelect() {
		...
		*/
		...
		var G_SERVLETURL = "<%=POASRM_CONTEXT_NAME%>/servlets/supply.admin.user.use_lis1";
	...
	function Display() {
		...
		for(var i=0;i<GridObj.GetRowCount();i++){
			...
			if(temp == true) {
				...
				winobj = window.open("/s_kr/admin/user/use_bd_dis2.jsp?user_id="+GD_GetCellValueIndex(GridObj,i,1),"BKWin","top="+top+",left="+left+",width=840,height=500,resizable=yes,status=yes,scrollbars = yes");
...
/* 				var servletUrl = "/servlets/supply.admin.user.use_del1"; */
				/* GridObj.SetParam("WISETABLE_DOQUERY_DODATA","1");
				GridObj.SendData(servletUrl, "ALL", "ALL"); */
				var G_SERVLETURL = "/servlets/supply.admin.user.use_del1";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <td class="data_td">Supplier
       <input type="hidden" name="user_type" id="user_type" value="S" class="input_data0" readonly  >
      </td>
      <td class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;업무권한</td>
      <td class="data_td">
        <select name="work_type" id="work_type" class="inputsubmit">
    ...
    <tr>
      ...
      <td class="data_td" width="35%">
        <input type="text" name="user_name" id="user_name" size="20" class="inputsubmit" onkeydown='entKeyDown()' ></td>
    </tr>
	</table>
</td>
</tr>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td><input type="hidden"  name="dept_usedpopup" value="off" >
        <input type="hidden"    name="id_usedpopup"   value="off"   > </td>
    </tr>
  </table>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    	<tr>
...
<%-- <s:grid screen_id="SUP_002" grid_obj="GridObj" grid_box="gridbox"/> --%>
