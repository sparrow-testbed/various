...
<% String WISEHUB_PROCESS_ID="BD_010";%>
...
var G_SERVLETURL   = "<%=POASRM_CONTEXT_NAME%>/servlets/sepoa.svl.sourcing.bd_req_prepare_list";
...
function Cancel()
{
	...
	params+=dataOutput();	
	myDataProcessor = new dataProcessor( "<%=POASRM_CONTEXT_NAME%>/servlets/sepoa.svl.sourcing.bd_req_prepare_list",params);
...
<td width="100%">
	<table width="100%" border="0" cellspacing="0" cellpadding="0">	
		...
		<tr>
      		...
      		<td class="data_td">
        		<b><input type="text" name="CHANGE_USER_NAME"  id="CHANGE_USER_NAME" onkeydown='entKeyDown()'   value="<%=(!"MUP210200001".equals(info.getSession("MENU_PROFILE_CODE")))?USER_NAME:""%>" size="20" maxlength="10" ></b>
      		</td>
    	</tr>
		<tr>
			<td colspan="4" height="1" bgcolor="#dedede"></td>
...
<%-- <s:grid screen_id="BD_010" grid_obj="GridObj" grid_box="gridbox"/> --%>
