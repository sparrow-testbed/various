...
<%
	...
	Object[] obj = {cont_no, cont_gl_seq, "D"};
	...
	try{
		...
		else
		{
			Object[] obj3 = {cont_no, cont_gl_seq, stamp_tax_no, stamp_tax_amt, aMultiSignedData, aMDN2}; //추가수정_20171127
	 		value1 = ServiceConnector.doService(info, "CTS_001", "TRANSACTION", "getContractAbolSignBuyer", obj3);
	
			if(value1.flag == true){

// 계약완료건을 우리은행폐기서명하는경우만 단가계약삭제					
//				if(!"".equals(exec_no)){
...
//					msg = "우리은행인증서로 서명하셨습니다."; 				
//				}
				msg = "우리은행인증서로 폐기서명하셨습니다."; 	
			}else{
				msg = "우리은행인증서로 폐기서명 실패하였습니다.";
				err = "우리은행인증서로 폐기서명 실패하였습니다.";
			}
