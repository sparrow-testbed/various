...
function doSave(flag) {
	...
	if(flag == "Y"){		
		...
		if(document.getElementById("sel_mfco_code").value == ""){
			alert("제조사를 선택하세요.");
			document.getElementById("sel_mfco_code").focus();
			return;
		}
	}
...
function JavaCall(msg1, msg2, msg3, msg4, msg5) {
	...
	if(msg1 == "t_imagetext") {
		...
		//opener.doSelect();
		//window.close();
		location.href= "/ict/s_kr/bidding/rfq/rfq_bd_lis01_ict.jsp";
	}
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
		    <tr>
				...
				<td width="35%" class="data_td">
					<input type="text" name="mdl_id" id="mdl_id" style="width:95%;" onKeyUp="return chkMaxByte(100, this, '모델번호');">					
				</td>
				<td width="15%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;
					 모델명<font style="color: red;">*</font>
				</td>
				<td width="35%" class="data_td">
					<input type="text" name="mdl_nm" id="mdl_nm" style="width:95%;" onKeyUp="return chkMaxByte(100, this, '모델명');">
				</td>
			</tr>
			<tr>
...
<%
	String  lb_item_no2 = ListBox(request, "SL0156",info.getSession("HOUSE_CODE") + "#" + "M681_ICT" + "#" + ITEM_NO, "");
