...
//         }
		...
		if(IsTrimStr(document.forms[0].VENDOR_CODE.value) == ""){
			alert("추가할 업체를 선택해 주세요.");
			document.forms[0].VENDOR_CODE.focus();
            //button_flag = false;
            return;
		}
    	...
    	$.post(
    		...
    		function(arg){
    			...
    			if(result[1] == "true"){
    				...
    				opener.doQuery();
    				window.close();
	    			//location.href="bd_join_list_seller.jsp";
    			}
    		}
    	);        
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td class="title_td" width="15%">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;입찰보증금(KRW)</td>
      <td width="35%" class="data_td">
    ...
    <tr>
      <td class="title_td" width="15%">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;입찰보증서 첨부</td>
    ...
    <tr> 
      <td width="98%" height="30">
        ...
        <table><tr>
          ...
          <td><script language="javascript">btn("javascript:window.close()", "취소")</script></td> 
		  </tr></table>  
        </div>
      </td>
    </tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="15%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;추가업체<img src='../images/mail_point.gif' border='0'></td>
      <td  width="35%" class="data_td" colspan="3">
      	<input type="text" name="VENDOR_CODE" id="VENDOR_CODE" size="12" class="input_re" value="" onKeyUp="return chkMaxByte(50, this, '업체코드');" readonly="readonly">
		<a href="javascript:getVendorCode('setVendorCode')">
			<img src="<%=G_IMG_ICON%>" align="absmiddle" name="p_vendor_code" border="0" alt="">
		</a>
      	<input type="text" name="VENDOR_NAME" id="VENDOR_NAME" size="12" class="input_re" value="" onKeyUp="return chkMaxByte(50, this, '업체명');" readonly="readonly"> 
      </td>
    </tr>
	<tr>
		<td colspan="4" height="1" bgcolor="#dedede"></td>
...
<table width="100%" class="board-search" border="0" cellpadding="0" cellspacing="0">
    <tr align="center">
      <td><center>
		본인은 위의 번호로 공고한 귀사의  입찰에 참가하고자 입찰유의서 및 입찰공고사항과 계약조건 등 입찰 및 계약에 필요한 모든 사항을 숙지하고
		<br>이를 승낙하며 참가신청서를 제출합니다.
      </td>
    </tr>
</table>
