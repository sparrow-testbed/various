...
<%
	...
	multilang_id.addElement("MA_011_5");
	multilang_id.addElement("BUTTON");
	multilang_id.addElement("MESSAGE");
	
	HashMap text = MessageUtil.getMessage(info,multilang_id);
	
	String screen_id = "MA_011_5";
...
<!-- PROCESS ID 선언 -->
<% String WISEHUB_PROCESS_ID="MA_011_5";%>
<!-- 사용 언어 설정 -->
...
function setHeader() {
	...
	/* WiseGrid5 세팅 시작 */
	GridObj5.AddHeader( 	"ctrl_type",	"","t_text",100,0,false);
	
	
	area_code_col = GridObj5.GetColHDIndex("area_code");
	image_text_col = GridObj5.GetColHDIndex("image1");
	area_name_col = GridObj5.GetColHDIndex("area_name");
	company_code_col = GridObj5.GetColHDIndex("company_code");
	ctrl_code_col = GridObj5.GetColHDIndex("ctrl_code");
	image_text1_col = GridObj5.GetColHDIndex("image2");
	ctrl_name_loc = GridObj5.GetColHDIndex("ctrl_name_loc");
	ctrl_type_col = GridObj5.GetColHDIndex("ctrl_type");	
	/* WiseGrid5 세팅 종료 */
...
<s:grid screen_id="MA_011_5" grid_obj="GridObj" grid_box="gridbox"/>
<s:footer/>
</body>
</html>
