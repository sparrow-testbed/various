...
<%
	...
	multilang_id.addElement("CO_010");
...
function fnSelect(){
    ...
    params += dataOutput();
    GridObj.post("<%=POASRM_CONTEXT_NAME%>/servlets/sepoa.svl.co.CO_010_Servlet", params );
...
<s:grid screen_id="CO_010" grid_obj="GridObj" grid_box="gridbox"/>
<s:footer/>
</body>
</html>