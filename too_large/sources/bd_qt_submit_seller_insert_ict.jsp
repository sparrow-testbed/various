...
<%
	...
	Object[]    obj = { mapData };
	SepoaOut    so  = ServiceConnector.doService( info, "I_SBD_010", "CONNECTION", "getBDHeader", obj );
	SepoaFormater wf = new SepoaFormater( so.result[0] );
        ...
        so  = ServiceConnector.doService( info, "I_SBD_010", "CONNECTION", "getBDHD_VnInfo", obj );
...
// 	var rowcount = grid_array.length;
    	...
    	$.post(
    		...
    		function(arg){
    			...
    			if(result[1] == "true"){
    				alert(result[0]);
	    			location.href="bd_qt_submit_list_seller_ict.jsp";
    			}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td class="title_td" width="15%">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;견적서류 첨부<img src='/images/mail_point.gif'' border='0'></td>
  ...
  <table width="98%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td width="98%" height="30">
        ...
        <table><tr>
         <% if("S".equals(MODE)){ %>
          <td><script language="javascript">btn("javascript:doSubmit()", "견적서류제출")</script></td>
         <% }else if("C".equals(MODE)){ %>          
          <td><script language="javascript">btn("javascript:doCancel()", "견적서류제출취소")</script></td>
          <% } %>         
		  </tr></table>  
        </div>
      </td>
