...
<form name="form1" >
	<input type="hidden" name="e_factor_refitem">
	...
	<tr>
		...
		<td width="80%" class="c_data_1">
			<select name="factor_type" class="inputsubmit" <%=disabled%>>
          		<%=LB_FACTOR_TYPE%>
        	</select>
		</td>
	</tr>
...
<%
	if (mode.equals("update") || mode.equals("view")) {
%>
			<input type="text" class="input_data0" style="width:70%" value="<%=evaItemName%>" name="evaItemName"  maxlength="50" <%=readOnly%>>
<%
	} else {
%>
			<input type="text" class="text" style="width:350" value="" name="evaItemName"  maxlength="50">
<%
	}
%>
		</td>
	...
	<tr>
		...
		<td width="80%" class="c_data_1">
			<textarea name="factor_desc" class="inputsubmit" rows="3" style="width:98%; height: 100px" onKeyUp="return chkMaxByte(1000, this, '��ぉ�ㅻ�');"><%=factorDesc%></textarea>
		</td>
	</tr>
	</table>
...
%>
	<tr>
		...
		<td class="c_data_1_p"><%=wf.getValue(i, 2)%>
			<input type="hidden" name="itemScore" class="text" value="<%=wf.getValue(i, 4)%>" style="width:40" <%=readOnly%>>
		</td>
		<td align="center" class="c_data_1_p_c"><%=wf.getValue(i, 4)%>점</td>
	</tr>
<%
		}
...
%>
	<tr>
		...
		<td align="center" class="c_data_1_p_c"><input type="text" name="itemScore" class="text" value="" style="width:40"></td>
	</tr>
	<tr>
