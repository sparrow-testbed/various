...
function init()
{
    ...
    server_time = "<%=DB_time%>";
    printDateInput('server_date');
    //clock('s');
	
	// 날짜는 오늘로...
	document.form1.BID_BEGIN_DATE.value = current_date;
	document.form1.BID_END_DATE.value = current_date;
	document.form1.OPEN_DATE.value = current_date;
}
...
<td width="100%">
    ...
    <tr>
      <td class="title_td" width="15%">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp; 현재시간</td>
      <td width="85%" class="data_td">&nbsp;
<!--       <div id="id1"></div> -->
      <input type="text" id="server_date" name="server_date" style="width:180px; text-align: center;" readonly="readonly"/>
      <input type="hidden" name="h_server_date" size="50" readonly/></td>
    </tr>
	<tr>
		<td colspan="4" height="1" bgcolor="#dedede"></td>
	</tr>  	    
	<tr id="g1">
	  ...
	  <td colspan="3" id="g4" class="data_td">
					 <s:calendar id="BID_BEGIN_DATE" default_value=""  format="%Y/%m/%d"/>일
		<input type="text" name="BID_BEGIN_TIME_HOUR_MINUTE"  value="" size="4"   maxlength="4"  id=g9 style="ime-mode:disabled;" onKeyPress="checkNumberFormat('[0-9]', this)">
		&nbsp;&nbsp;~&nbsp;&nbsp;
		<s:calendar id="BID_END_DATE" default_value=""  format="%Y/%m/%d"/>일
		<input type="text" name="BID_END_TIME_HOUR_MINUTE"  value="" size="4" maxlength="4"  id=g13 style="ime-mode:disabled;" onKeyPress="checkNumberFormat('[0-9]', this)">
		</span></td>
	</tr>
	<tr>
		<td colspan="4" height="1" bgcolor="#dedede"></td>
	...
	<tr id="g14">
	  ...
	  <td  colspan="3" id="g17" class="data_td"><span id="g18">
		...
		<input type="text" name="OPEN_TIME_HOUR_MINUTE"  value="" size="4"    maxlength="4"   id=g22 style="ime-mode:disabled;" onKeyPress="checkNumberFormat('[0-9]', this)">
	  </span>
	  </td>
	</tr>
  </table> 
