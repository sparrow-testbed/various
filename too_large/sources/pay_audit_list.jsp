...
<%
	...
	multilang_id.addElement("TX_016");
	multilang_id.addElement("BUTTON");
	multilang_id.addElement("MESSAGE");
	
	HashMap text = MessageUtil.getMessage(info,multilang_id);
	
	String screen_id = "TX_016";
...
<%
    ...
    //////////////////ClipReport4 선언부 시작///////////////////////////////////////////////////////////
	String _rptName          = "020644/rpt_pay_audit_list"; //리포트명
...
function doOnRowSelected(rowId,cellInd){
	...
	if( GridObj.getColIndexById("TAX_NO") == cellInd ){
	...
	else if(cellInd == GridObj.getColIndexById("PAY_SEND_NO")) {
    	var doc_no          = GridObj.cells(rowId, GridObj.getColIndexById("PAY_SEND_NO")).getValue();
    	var doc_seq         = 0;
    	var doc_type        = "PSB"
    	var attach_no       = "";
    	var doc_status      = "N";
    	...
    	var default_url = "/approval/approval_psb.jsp?doc_no="+doc_no+"&doc_seq="+doc_seq+"&doc_type="+doc_type+"&sign_enable=T"+"&attach_no="+attach_no+"&doc_status="+doc_status+"&proceeding_flag="+proceeding_flag+"&doc_seq="+doc_seq+"&sign_path_seq="+sign_path_seq+"&add_user_name="+add_user_name+"&add_date="+add_date+"&subject="+subject;
	...
	else if(cellInd == GridObj.getColIndexById("SIGN_PATH_IMG")) {
    	var company_code = 'WOORI';
		var doc_type     = 'PSB';
		var doc_no       = GridObj.cells(rowId, GridObj.getColIndexById("PAY_SEND_NO")).getValue();
		var doc_seq      = 0;
...
<input type="hidden" id="audit_status" name="audit_status" value="N">
					...
					<td width="100%">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td width="15%" class="title_td" style="display: none;">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;결의부서</td>
								<td class="data_td" style="display: none;">
									<input type="text" name="demand_dept" style="ime-mode:inactive"  id="demand_dept" size="15" maxlength="6" value='' onkeydown="JavaScript: entKeyDown();">
    	...
    	<td height="30" align="right">
        	<TABLE cellpadding="0">
               	<TR>
                    ...
                    <TD><script language="javascript">btn("javascript:doAudit()"	,"승 인")    	</script></TD>
				</TR>
			</TABLE>
		</td>
	</tr>
...
<s:grid screen_id="TX_016" grid_obj="GridObj" grid_box="gridbox"/>
<s:footer/>
