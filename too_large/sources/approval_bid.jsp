...
<iframe id="bidFrm" name="bidFrm" src="/sourcing/bd_ann_d_<%=ANN_VERSION %>.jsp?BID_NO=<%=doc_no %>&BID_COUNT=<%=doc_seq %>&SCR_FLAG=D&BID_STATUS=AR&BID_TYPE=<%=BID_TYPE %>&ANN_VERSION=<%=ANN_VERSION %>&VIEW_TYPE=P&view_content=<%=view_content %>" style="width: 98%;height: 550px; border: 0px;" frameborder="0" scrolling="yes"></iframe>
