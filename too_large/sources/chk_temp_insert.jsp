...
<form name="form1" > 
	<input type="hidden" name="c_template_refitem" id="c_template_refitem">
...
<%
		if(mode.equals("update")) {
%>
			<input type="text" class="text" style="width:95%" value="<%=wf.getValue(0, 5)%>" name="chkTempName" id="chkTempName" maxlength="50" <%=readOnly%>>
<%
		} else {
%>
			<input type="text" class="input_data2" style="width:95%" value="<%=wf.getValue(0, 5)%>" name="chkTempName" id="chkTempName"  maxlength="50" <%=readOnly%>>
<%
		}
%>
		</td>
...
<%
		if(mode.equals("update")) {
%>
			<input type="text" class="text" style="width:95%" name="require_score" id="require_score" maxlength="50" value="<%=wf.getValue(0, 6)%>"<%=readOnly%>>
<%
		} else {
%>
			<input type="text" class="input_data2" style="width:95%" name="require_score" id="require_score" maxlength="50" value="<%=wf.getValue(0, 6)%>"<%=readOnly%>>
<%
		}
%>
		</td>
...
%>
		<td width="35%" class="c_data_1">
			<input type="text" class="text" style="width:95%" value="" name="chkTempName" id="chkTempName" maxlength="50">
		</td>
		<td width="15%" class="c_title_1">기준점수</td>
		<td width="35%" class="c_data_1">
			<input type="text" class="text" style="width:95%" name="require_score" id="require_score" maxlength="50">
		</td>
<%
	}
%>
