...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <tr>
				<td width="15%"  class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;계약서식이름
        		</td>
        		<td width="85%"  colspan="5" class="data_td">
        			<input type="text" name="cont_form_name" id="cont_form_name" value="" style="width: 98%;">
        		</td>
			  </tr>
			</table>
</td>
