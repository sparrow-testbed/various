...
<form name="form1" id="form1" method="post">
	...
	<input type="hidden" name="mode"             id="mode"                value="setPwdNew2"  />
						...
						<td width="100%">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<td class="data_td">
										<input type="password" name="password" id="password" size="25" maxlength="20" npkencrypt="on">
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td class="data_td">
										<input type="password" name="new_password" id="new_password" size="25" maxlength="20" npkencrypt="on">
									</td>
								</tr>
								<tr>
									<td colspan="4" height="1" bgcolor="#dedede"></td>
								...
								<tr> 
									...
									<td class="data_td">
										<input type="password" name="new_password_confirm" id="new_password_confirm" size="25" maxlength="20" npkencrypt="on">
									</td>
								</tr>
							</table>
						</td>
