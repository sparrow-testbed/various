...
<%
	...
	String FROM_DATE = SepoaString.getDateUnDashFormat(JSPUtil.nullChk(JSPUtil.CheckInjection(request.getParameter("from_date"))));
	String TO_DATE = SepoaString.getDateUnDashFormat(JSPUtil.nullChk(JSPUtil.CheckInjection(request.getParameter("to_date"))));
	...
	Object[] obj = {args};
	SepoaOut value = ServiceConnector.doService(info, "MT_014", "CONNECTION","setInsertFaq_New", obj);
...
<%-- 	parent.location.href = "faq_write_new.jsp?con_type="+con_type+"&load_flag="+"<%=load_flag%>"; --%>
})();
