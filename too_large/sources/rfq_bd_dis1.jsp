...
<%
	...
	//////////////////ClipReport4 선언부 시작///////////////////////////////////////////////////////////
	String _rptName          = "020644/rpt_rfq_bd_dis1"; //리포트명
...
<tr>
	<td align="left" class='title_page'>견적요청 상세조회
	</td>
</tr>
</table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<td width="35%" class="data_td">
			<input type="text" name="rfq_no" id="rfq_no" size="20" value="<%=rfq_no%>" class="input_data2" readonly="readonly">
		</td>
		<td width="15%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;차수
		</td>
		<td class="data_td">
			<input type="text" name="rfq_count" id="rfq_count" size="15" value="<%=rfq_count%>" class="input_data2" readonly="readonly">
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td width="35%" class="data_td" colspan="3">
          <textarea name="REMARK" style="width:98%;height:100%" rows="5" readonly><%=REMARK %></textarea></td><td>
		</td>
	</tr>
	<tr>
		<td colspan="4" height="1" bgcolor="#dedede"></td>
	...
	<td class="data_td" colspan="3" height="150">    
				...
				<iframe id="attachFrm" name="attachFrm" src="/sepoafw/filelob/file_attach_downloadView.jsp?attach_key=<%=ATTACH_NO%>&view_type=VI" style="width: 98%;height: 102px; border: 0px;" frameborder="0" ></iframe>
					<%-- <script language="javascript">btn("javascript:FileAttach('IMAGE',document.forms[0].sign_attach_no.value,'RFQ')", "파일보기")</script> --%>
