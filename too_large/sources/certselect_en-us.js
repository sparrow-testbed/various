(function() {  
	...
	input_guide: "The input for password after select certificate.",
    input_guide2: "Select the certificate and click the OK button.",
	...
	passwd: "Password : ",
	keyworderror1: "Certificate password is not correct.\nCertificate Passwords are case sensitive.\nPassword %s times",
	keyworderror2: "(%s times the current error) Please retry if an error occurs.",
	...
	renewplease1: "To renew the certificate prior to the expiration date, please.",
	renewplease2: "",
	...
	/* wooribank request */
	banner_explain: "Internet Banking",
	close: "close",
