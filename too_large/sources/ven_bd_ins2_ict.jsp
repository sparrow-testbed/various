...
function NextSave()
{
	...
	f.method = "POST";
 	f.target = G_TARGET;
	f.action = "ven_wk_ins2_ict.jsp?SOLE_PROPRIETOR_FLAG="+f.SOLE_PROPRIETOR_FLAG.value+"&VENDOR_TYPE="+f.VENDOR_TYPE.value;
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<% if(!ctrl_code.equals("P99")){ %>
								...
								<tr>
									...
									<td class="data_td">
										<input type="text" id="VENDOR_NAME_LOC" name="VENDOR_NAME_LOC" value="" size="35" class="input_re" onKeyUp="return chkMaxByte(50, this, '회사명');" maxlength="50">
