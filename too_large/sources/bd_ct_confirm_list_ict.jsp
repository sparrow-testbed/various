...
<%
	...
	multilang_id.addElement("I_SBD_011");
	multilang_id.addElement("BUTTON");
	multilang_id.addElement("MESSAGE");
	
	HashMap text = MessageUtil.getMessage(info,multilang_id);
	
	String screen_id = "I_SBD_011";
...
%> 
<!--
 title_tdle:   계약서제출확인   <p>
 Description:  계약서제출확인<p>
...
var G_SERVLETURL   = "<%=POASRM_CONTEXT_NAME%>/servlets/ict.sepoa.svl.sourcing.bd_ct_confirm_ict";
...
function doOnCellChange(stage,rowId,cellInd)
{
    ...
    if(stage==0) {
    	...
    	if( header_name == "CONFIRM_FLAG" || header_name == "NFIT_RSN" ) {
        	return true;
    	}
		  return true;
    } else if(stage==1) {
