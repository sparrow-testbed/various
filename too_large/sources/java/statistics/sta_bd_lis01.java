...
public class sta_bd_lis01 extends HttpServlet{
     ...
     * @modify 2014-11-24
     */
	private GridData prProceedingList(GridData gdReq, SepoaInfo info) {
	    ...
	    try{
	    	...
	    	value    = ServiceConnector.doService(info, "p7008", "CONNECTION", "prProceedingList", obj);
	    	isStatus = value.flag;
...
*/
	 ...
	 @SuppressWarnings({ "rawtypes", "unchecked" })
	    ...
	    private Object[] requestListHeader(GridData gdReq, SepoaInfo info) throws Exception{
	    	...
	    	String              add_date_end          = header.get("add_date_end");
	    	String              pr_proceeding_flag    = header.get("pr_proceeding_flag");
...
//	    	String              pr_user               = header.get("pr_user");
	    	String              req_dept              = header.get("req_dept");
	    	String              req_user              = header.get("req_user");
	    	String              bid_div               = header.get("BID_DIV");
	    	String              purchaser_id          = header.get("purchaser_id");
	    	
	    	
	    	resultInfo.put("house_code",           houseCode          );
	    	resultInfo.put("add_date_start",       add_date_start     );   
	    	resultInfo.put("add_date_end",         add_date_end       );
	    	resultInfo.put("pr_proceeding_flag",   pr_proceeding_flag );
...
//	    	resultInfo.put("pr_user",              pr_user            );
	    	resultInfo.put("req_dept",             req_dept           );
	    	resultInfo.put("req_user",             req_user           );
	    	resultInfo.put("bid_div",              bid_div            );
	    	resultInfo.put("purchaser_id",         purchaser_id       );
