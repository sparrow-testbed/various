...
public class sta_bd_lis44 extends HttpServlet{
...
//    	System.out.println("vendor_name : >" + header.get("vendor_name") + "<");
	...
	private GridData getCatalog(GridData gdReq, SepoaInfo info) throws Exception{
	    ...
	    try{
	    	...
	    	value    = ServiceConnector.doService(info, "p7008", "CONNECTION","getStaCompInfo", obj);
	    	isStatus = value.flag;
