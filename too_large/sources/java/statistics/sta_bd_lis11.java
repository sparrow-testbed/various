...
public class sta_bd_lis11  extends HttpServlet{
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
    	...
    	try {
    		...
    		if("getStaLTUserList".equals(mode)){
    			gdRes = this.getStaLTUserList(gdReq, info);
    		}
     ...
     * @modify 2014-11-24
     */
	private GridData getStaLTUserList(GridData gdReq, SepoaInfo info) {
	    ...
	    try{
	    	...
	    	value    = ServiceConnector.doService(info, "p7008", "CONNECTION", "getStaLTUserList", obj);
	    	isStatus = value.flag;
