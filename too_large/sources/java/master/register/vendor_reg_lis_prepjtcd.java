...
public class vendor_reg_lis_prepjtcd extends HttpServlet{
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
    	...
    	try {
    		...
    		if("select1".equals(mode)){ // 조회 샘플
    			gdRes = this.select1(gdReq, info);
    		}
    	}
    	catch (Exception e) {
	...
	private GridData select1(GridData gdReq, SepoaInfo info) throws Exception{
	    GridData            gdRes      = new GridData();
	    ...
	    try{
	    	...
	    	header.put("pre_pjt_code", header.get("PRE_PJT_CODE"));
	    	header.put("pr_no",        header.get("PR_NO"));
	    	header.put("subject",      header.get("SUBJECT"));
	    	
	    	Object[] obj = {header};
	
	    	value = ServiceConnector.doService(info, "p0070", "CONNECTION","getPrePjtCodeLst", obj);
