...
public class qta_bd_ins3 extends HttpServlet {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
    	...
    	try {
    		...
    		if("getQtaCompareItem".equals(mode)){ // 조회
    			gdRes = this.getQtaCompareItem(gdReq, info);
    		}
...
//    			e.printStackTrace();
	...
	private GridData getQtaCompareItem(GridData gdReq, SepoaInfo info) throws Exception{
	    GridData            gdRes      = new GridData();
	    ...
	    try{
	    	...
	    	Object[] obj = {header};
	    	value = ServiceConnector.doService(info,"p1072", "CONNECTION","getQtaCompareItem", obj);
