...
public class ebd_bd_lis6 extends HttpServlet{
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
		...
		try {
			...
			if("getReqBidRlt".equals(mode)){ // 품목 마스터 조회
				gdRes = this.getReqBidRlt(gdReq, info);
			}
		}
		catch (Exception e) {
    ...
    private GridData getReqBidRlt(GridData gdReq, SepoaInfo info) throws Exception{
        GridData            gdRes        = new GridData();
        ...
        try{
            ...
            value = ServiceConnector.doService(info, "p1015", "CONNECTION","getReqBidRlt", obj);
