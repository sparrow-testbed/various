...
public class os_001 extends SepoaService {
	private Message msg;

    public os_001(String opt, SepoaInfo info) throws SepoaServiceException {
        super(opt, info);
	...
	public SepoaOut requestList(Map<String, String> header){
		...
		try{
			...
			sxp = new SepoaXmlParser(this, "requestList");
			
			sxp.addVar("HOUSE_CODE", houseCode);
			sxp.addVar("prNoSeq",    header.get("prNoSeq"));
