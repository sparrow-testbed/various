...
public class evdetail_mst extends HttpServlet{
...
//    			e.printStackTrace();
    ...
    private Object[] queryObj(GridData gdReq, SepoaInfo info) throws Exception{
	...
	private GridData query(GridData gdReq, SepoaInfo info) throws Exception{
	    ...
	    try{
	    	...
	    	obj      = this.queryObj(gdReq, info);
	    	value    = ServiceConnector.doService(info, "WO_202", "TRANSACTION","ev_query", obj);
	    	isStatus = value.flag;
	...
	private Object[] insertObj(GridData gdReq, SepoaInfo info) throws Exception{
		...
		String                    pEvGubun     = header.get("p_ev_gubun");
		...
		headerData.put("TYPE", pEvGubun);
		
		resultInfo.put("header",   headerData);
    ...
    private GridData insert(GridData gdReq, SepoaInfo info) throws Exception{
    	...
    	try {
    		...
    		value    = ServiceConnector.doService(info, "WO_202", "TRANSACTION", "ev_insert", obj);
    		isStatus = value.flag;
    ...
    private GridData delete(GridData gdReq, SepoaInfo info) throws Exception{
    	...
    	try {
    		...
    		value    = ServiceConnector.doService(info, "WO_202", "TRANSACTION", "ev_delete", obj);
    		isStatus = value.flag;
