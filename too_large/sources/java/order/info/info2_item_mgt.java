...
public class info2_item_mgt extends HttpServlet{
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
    	...
    	try {
    		...
    		if("doSaveInfo2ItemMgt".equals(mode)) {
    			gdRes = this.doSaveInfo2ItemMgt(gdReq, info);
    		}
    		else if("getInfo2ItemMgt".equals(mode)) {
    			gdRes = this.getInfo2ItemMgt(gdReq, info);
    		}
    		else if("doDeleteInfo2ItemMgt".equals(mode)) {
//    			System.out.println("11111111111111111111111111111111111");
    			gdRes = this.doDeleteInfo2ItemMgt(gdReq, info);
    		}
    		/*
    		...
    		else if("doSaveInfo2ItemMgt".equals(mode)) {
	...
	private GridData doSaveInfo2ItemMgt(GridData gdReq, SepoaInfo info) throws Exception{
    	GridData            gdRes       = new GridData();
		...
		try {
			...
			value = ServiceConnector.doService(info, "p2004", "TRANSACTION", "doSaveInfo2ItemMgt", obj);
	...
	@SuppressWarnings({ "rawtypes", "unchecked" })
	private GridData getInfo2ItemMgt(GridData gdReq, SepoaInfo info) throws Exception{
	    GridData            gdRes      = new GridData();
	    ...
	    try{
			...
			header.put("PURCHASE_LOCATION", "01");
			
	    	Object[] obj = {header};

	    	value = ServiceConnector.doService(info, "p2004", "CONNECTION","getInfo2ItemMgt", obj); 
	 ...
	 */
	@SuppressWarnings({ "rawtypes", "unchecked" })
	private GridData doDeleteInfo2ItemMgt(GridData gdReq, SepoaInfo info) throws Exception{
		GridData            gdRes       = new GridData();
		Vector              multilangId = new Vector();
		HashMap             message     = null;
		SepoaOut            value       = null;
		...
		try {
			...
			data = SepoaDataMapper.getData(info, gdReq);
//			System.out.println("--doDeleteInfo2ItemMgt-------------------------------------------------------------------------------");
			Object[] obj = {data};
			
			value = ServiceConnector.doService(info, "p2004", "TRANSACTION", "doDeleteInfo2ItemMgt", obj);
