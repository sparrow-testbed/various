...
public class rfq_bd_ins1 extends HttpServlet{
    ...
    private GridData setRfqCreate(GridData gdReq, SepoaInfo info) throws Exception{
    	...
    	try {
    		...
    		rqhddata      = this.setRfqCreateRqhddata(info, header, rfqNo, "1", iRfqStatus, signStatus);
    		rqopdata      = this.setRfqCreateRqopdata(info, header, rfqNo, "1", rqopdata);
    		svcParam      = this.getGridInfoParamList(info, data, rfqNo, "1");
    		...
    		svcParam.put("rfq_count",   "1");
    		svcParam.put("rqhddata",    rqhddata);
    		svcParam.put("rqopdata",    rqopdata);
    		
    		Object[] obj = {svcParam};
    		
    		value = ServiceConnector.doService(info, "I_p1004", "TRANSACTION", "setRfqCreate", obj);
...
//		rqhdtemp.put("MFCO_CODE",     header.get("I_MFCO_CODE"));
    ...
    private String setRfqCreateRfqNo(SepoaInfo info) throws Exception{
    	...
    	wo2    = DocumentUtil.getDocNumber(info, "IRQ");
    	result = wo2.result[0];
