...
public class rfq_bd_lis3 extends HttpServlet{
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
		...
		try{
			...
			if ("getRfqList3".equals(mode)){				// 견적요청현황 조회
				gdRes = getRfqList3(gdReq,info);
			} 
     ...
     * @throws Exception
     */
	private GridData getRfqList3(GridData gdReq, SepoaInfo info) throws Exception {
        ...
        try{
            ...
            value        = ServiceConnector.doService(info, "I_p1004", "CONNECTION", "getRfqList3", obj);
   			if(value.flag) {
