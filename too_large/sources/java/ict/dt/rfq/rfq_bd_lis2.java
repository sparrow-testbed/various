...
public class rfq_bd_lis2 extends HttpServlet{
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
		...
		try{
			...
			if ("getRfqList2".equals(mode)){				// 견적요청현황 조회
				gdRes = getRfqList2(gdReq,info);
			} 
     ...
     * @throws Exception
     */
	private GridData getRfqList2(GridData gdReq, SepoaInfo info) throws Exception {
        ...
        try{
            ...
            value        = ServiceConnector.doService(info, "I_p1004", "CONNECTION", "getRfqList2", obj);
   			if(value.flag) {
