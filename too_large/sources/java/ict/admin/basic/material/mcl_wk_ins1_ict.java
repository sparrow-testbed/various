...
public class mcl_wk_ins1_ict extends HttpServlet{
	...
	private GridData getQuery(GridData gdReq, SepoaInfo info) throws Exception{
	    ...
	    String              class1    = gdReq.getParam("class1");
	    ...
	    try{
	    	...
	    	svcParam.put("TYPE",       class1);
	    	svcParam.put("CODE",       itemClass);
	
	    	Object[] obj = {svcParam};
	
	    	value = ServiceConnector.doService(info, "I_p6024", "CONNECTION", "mcl_checkItem", obj);
