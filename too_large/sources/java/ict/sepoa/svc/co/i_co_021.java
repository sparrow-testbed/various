...
public class I_CO_021 extends SepoaService {
	private Message msg;

    public I_CO_021(String opt, SepoaInfo info) throws SepoaServiceException {
        super(opt, info);
	...
	public SepoaOut selectCrPeList(Map<String, String> header){
		...
		try{
			...
			rtn = this.select(ctx, "selectCrPeList", header);
