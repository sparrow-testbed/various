...
public class I_CO_014 extends SepoaService {
	private Message msg;

    public I_CO_014(String opt, SepoaInfo info) throws SepoaServiceException {
        super(opt, info);
	...
	public SepoaOut selectVendorList(Map<String, String> header){
		...
		try{
			...
			rtn = this.select(ctx, "selectVendorList", header);
