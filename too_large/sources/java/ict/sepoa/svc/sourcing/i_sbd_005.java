...
public class I_SBD_005 extends SepoaService {
    ...
    public I_SBD_005( String opt, SepoaInfo info ) throws SepoaServiceException {
        super( opt, info );
        setVersion( "1.0.0" );
        //20131212 sendakun
        try {
        	...
        	Logger.err.println("I_SBD_005: = " + e.getMessage());
        }
    }
