...
public class I_BD_026 extends SepoaService {
    ...
    public I_BD_026( String opt, SepoaInfo info ) throws SepoaServiceException {
        super( opt, info );
        setVersion( "1.0.0" );
        //20131212 sendakun
        try {
//            msg = new Message( info, "MESSAGE" );
        	...
        	Logger.err.println("I_BD_026: = " + e.getMessage());
        }
    }
