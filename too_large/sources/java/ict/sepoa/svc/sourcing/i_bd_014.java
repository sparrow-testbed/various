...
public class I_BD_014 extends SepoaService {
    ...
    public I_BD_014( String opt, SepoaInfo info ) throws SepoaServiceException {
        super( opt, info );
        setVersion( "1.0.0" );
        //20131212 sendakun
        try {
//            msg = new Message( info, "MESSAGE" );
        	...
        	Logger.err.println("I_BD_014: = " + e.getMessage());
        }
    }
...
//        			}
	...
	public SepoaOut getBdHeaderCompare(Map< String, String > headerData)
	{
        ...
        try {
            ...
            Logger.err.println("====flagkkk==========>" +flag);
...
//        	e.printStackTrace();
	...
	public SepoaOut getBidResult(Map< String, String > headerData)
	{
		...
		try {
			...
			sxp = new SepoaXmlParser(this, "getBidResultRpt");
			ssm = new SepoaSQLManager(info.getSession("ID"), this, ctx, sxp); 
			setValue(ssm.doSelect(headerData));
	...
	public SepoaOut setBdProcessSB( Map< String, Object > allData ) throws Exception {
        ...
        try {
            ...
            headerData.put("PREFERRED_BIDDER", 		"PB".equals(FLAG) ? "Y" : "N");  //PB: 우선협상선정 : 사용안함
	...
	public SepoaOut setReBd( Map< String, Object > allData ) throws Exception {
        ...
        try {
			...
			// 입찰공고 진행정보 로그
			sxp = new SepoaXmlParser(this, "et_setReBDPGCreate_log");                     
			ssm = new SepoaSQLManager(info.getSession("ID"), this, ctx, sxp);   
			int rtn11 = ssm.doUpdate(headerData); 
            ...
            param.put("SMS_KIND"	, "ICT_SMS_06");
			param.put("HOUSE_CODE"	, house_code);
			param.put("BID_NO"		, headerData.get("BID_NO"));
			param.put("BID_COUNT"	, headerData.get("BID_COUNT"));
			param.put("BID_BEGIN_DATE"	, headerData.get("BID_BEGIN_DATE"));
			param.put("BID_BEGIN_TIME"	, headerData.get("BID_BEGIN_TIME"));
			param.put("BID_END_DATE"	, headerData.get("BID_END_DATE"));
			param.put("BID_END_TIME"	, headerData.get("BID_END_TIME"));
    ...
    public SepoaOut getBdMaxVoteCount(Map< String, String > headerData)
	{
        ConnectionContext ctx = getConnectionContext();
        String house_code   = info.getSession("HOUSE_CODE"); 
		...
		SepoaSQLManager ssm = null;
        try {
			sxp = new SepoaXmlParser(this, "getBdMaxVoteCount");
			ssm = new SepoaSQLManager(info.getSession("ID"), this, ctx, sxp);  
            setValue(ssm.doSelect(headerData));
            setStatus(1);
        }catch (Exception e){
