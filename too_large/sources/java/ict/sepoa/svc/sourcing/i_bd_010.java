...
public class I_BD_010 extends SepoaService {
    ...
    public I_BD_010( String opt, SepoaInfo info ) throws SepoaServiceException {
        super( opt, info );
        setVersion( "1.0.0" );
        //20131212 sendakun
        try {
//            msg = new Message( info, "MESSAGE" );
        	...
        	Logger.err.println("I_BD_010: = " + e.getMessage());
        }
    }
	...
	public SepoaOut getBdReqPrepareHeader(Map< String, String > headerData)
	{
        ...
        try {
            ...
            /* TOBE 2017-07-01 ICT 글로벌 상수 */
            headerData.put("DEFAULT_ICT_JUMCD", default_ict_jumcd);
            ...
            sxp = new SepoaXmlParser(this, "getBdReqPrepareHeader_ESTM");
			ssm = new SepoaSQLManager(info.getSession("ID"), this, ctx, sxp);   
            setValue(ssm.doSelect(headerData));
	...
	public SepoaOut setReqPrepare( Map< String, Object > allData ) throws Exception {
        ...
        try {
    		...
    		sxp = new SepoaXmlParser(this, "et_setBDHD_Bzbg_Upd");
			ssm = new SepoaSQLManager(info.getSession("ID"), this, ctx, sxp);  
			ssm.doUpdate(headerData);    	
