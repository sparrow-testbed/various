...
public class I_BD_029 extends SepoaService {
    ...
    public I_BD_029( String opt, SepoaInfo info ) throws SepoaServiceException {
        super( opt, info );
        setVersion( "1.0.0" );
        //20131212 sendakun
        try {
//            msg = new Message( info, "MESSAGE" );
	...
	public SepoaOut getBdCt2ConfirmList(Map< String, String > headerData)
	{
		...
		try {
			...
			sxp = new SepoaXmlParser(this, "getBdCt2ConfirmList");
	...
	/* ICT 사용 : 적격업체 저장 */
	public SepoaOut setBdCt2Confirm( Map< String, Object > allData ) throws Exception {
...
//          headerData.put( "BID_COUNT",	MapUtils.getString( headerData,  "BID_COUNT") );
	...
	private int et_setBDCT2( Map< String, Object > allData ) throws Exception 
    {
        ConnectionContext ctx = getConnectionContext();
        Map< String, String >           headerData  = null;
        Map< String, String >           gridRowData = null;
    	...
    	try {
    		...
    		SepoaXmlParser sxp = new SepoaXmlParser(this, "et_setBDCT2");
