...
public class ap_progress_list_ict extends HttpServlet {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
        ...
        try {
       		...
       		{	
       			gdRes = getProgressList(gdReq, info);		//조회
       		}
        } catch (Exception e) {
    ...
    public GridData getProgressList(GridData gdReq, SepoaInfo info) throws Exception {
		...
		try {
			...
			SepoaOut value = ServiceConnector.doService(info, "I_AP_003", "CONNECTION", "getProgressList", obj);
