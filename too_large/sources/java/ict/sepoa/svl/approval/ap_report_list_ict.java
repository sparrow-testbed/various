...
public class ap_report_list_ict extends HttpServlet {
    ...
    public GridData getReportList(GridData gdReq, SepoaInfo info) throws Exception {
		...
		try {
			...
			SepoaOut value = ServiceConnector.doService(info, "I_AP_008", "CONNECTION", "getReportList", obj);
    ...
    public GridData setReportCancel(GridData gdReq, SepoaInfo info) throws Exception {
		...
		try {
			...
			Object[] obj = {data};
			SepoaOut value = ServiceConnector.doService(info, "I_AP_008", "TRANSACTION","setReportCancel", obj);
