...
public class I_CO_008_Servlet extends HttpServlet{
...
//    			e.printStackTrace();
	...
	private GridData selectUserList(GridData gdReq, SepoaInfo info) throws Exception{
	    ...
	    try{
	    	...
	    	value    = ServiceConnector.doService(info, "I_CO_008", "CONNECTION", "selectUserList", obj);
	    	isStatus = value.flag;
	...
	private GridData selectDeviceUserJsonList(GridData gdReq, SepoaInfo info) throws Exception{
	    ...
	    try{
	    	...
	    	value    = ServiceConnector.doService(info, "I_CO_008", "CONNECTION","selectDeviceUserJsonList", obj);
	    	isStatus = value.flag;
