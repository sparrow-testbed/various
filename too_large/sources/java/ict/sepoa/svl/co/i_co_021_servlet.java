...
public class I_CO_021_Servlet extends HttpServlet{
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
    	...
    	try {
    		...
    		if("selectCrPeList".equals(mode)){
    			gdRes = this.selectCrPeList(gdReq, info);
    		}
    	}
    	catch (Exception e) {
...
//    			e.printStackTrace();
    ...
    private Object[] selectCrPeListObj(GridData gdReq, SepoaInfo info) throws Exception{
    	Object[]            result      = new Object[1];
    	Map<String, String> header      = this.getHeader(gdReq, info);
    	Map<String, String> resultInfo  = new HashMap<String, String>();
    	String              houseCode   = info.getSession("HOUSE_CODE");
    	String              companyCode = info.getSession("COMPANY_CODE");
    	String              DOC_NO      = header.get("DOC_NO");
    	String              DOC_SEQ     = header.get("DOC_SEQ");
    	
    	//resultInfo.put("HOUSE_CODE",    houseCode);
    	//resultInfo.put("COMPANY_CODE",  companyCode);
    	resultInfo.put("DOC_NO",       DOC_NO);
    	resultInfo.put("DOC_SEQ",      DOC_SEQ);
    ...
    private GridData selectCrPeListGdRes(GridData gdReq, GridData gdRes, SepoaFormater sf) throws Exception{
	...
	private GridData selectCrPeList(GridData gdReq, SepoaInfo info) throws Exception{
	    GridData      gdRes        = new GridData();
	    ...
	    try{
	    	...
	    	obj      = this.selectCrPeListObj(gdReq, info);
	    	value    = ServiceConnector.doService(info, "I_CO_021", "CONNECTION", "selectCrPeList", obj);
	    	isStatus = value.flag;
	    	...
	    	if(isStatus){
		    	...
		    	if(rowCount != 0){
		    		gdRes = this.selectCrPeListGdRes(gdReq, gdRes, sf);
		    	}
