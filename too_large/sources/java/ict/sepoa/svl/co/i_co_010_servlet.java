...
public class I_CO_010_Servlet extends HttpServlet{
...
//    			e.printStackTrace();
    ...
    private Object[] selectUserListObj(GridData gdReq, SepoaInfo info) throws Exception{
    	...
    	String              companyCd   = header.get("companyCd");
    	...
    	resultInfo.put("companyCd",     companyCd);
	...
	private GridData selectUserList(GridData gdReq, SepoaInfo info) throws Exception{
	    ...
	    try{
	    	...
	    	value    = ServiceConnector.doService(info, "I_CO_010", "CONNECTION", "selectUserList", obj);
	    	isStatus = value.flag;
