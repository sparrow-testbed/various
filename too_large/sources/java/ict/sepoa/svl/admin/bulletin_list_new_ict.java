...
public class bulletin_list_new_ict extends SepoaServlet
{

	private static final long serialVersionUID = -8667182084747591247L;

	public bulletin_list_new_ict()
    {
//        msg = new Message("KO", "STDCOMM");
        ...
        throws Exception
    {
        ...
        SepoaOut value = ServiceConnector.doService(info, "I_MT_014", "CONNECTION", "getSendNotice", obj);
...
//            ws.addValue("SEQ", wf.getValue("SEQ", i), "");
    ...
    private void getSupNotice(SepoaStream ws, String mode) throws Exception {
        ...
        try
        {
	        ...
	        SepoaOut value = ServiceConnector.doService(info, "I_MT_014", "CONNECTION", "getSupNotice", obj);
	        SepoaFormater wf = ws.getSepoaFormater(value.result[0]);
	        Logger.debug.println(info.getSession("ID"), ws.getRequest(), new StringBuilder("info===>").append(info.getSession("ID")).toString());
	        Config conf = new Configuration();
	        String POASRM_CONTEXT_NAME = conf.getString("sepoa.context.name");
...
//	            ws.addValue("SEQ", wf.getValue("SEQ", i), "");
    ...
    private void getDataStore(SepoaStream ws, String mode) throws Exception {
        ...
        try
        {
	        ...
	        SepoaOut value = ServiceConnector.doService(info, "I_MT_014", "CONNECTION", "getDataStore", obj);
	        SepoaFormater wf = ws.getSepoaFormater(value.result[0]);
	        Logger.debug.println(info.getSession("ID"), ws.getRequest(), new StringBuilder("info===>").append(info.getSession("ID")).toString());
	        Config conf = new Configuration();
	        String POASRM_CONTEXT_NAME = conf.getString("sepoa.context.name");
...
//    	            ws.addValue("SEQ", wf.getValue("SEQ", i), "");
    ...
    private void getSupFaq(SepoaStream ws, String mode)
    	...
    	try
    	{
    		...
    		SepoaOut value = ServiceConnector.doService(info, "I_MT_014", "CONNECTION", "getSupFaq", obj);
    		SepoaFormater wf = ws.getSepoaFormater(value.result[0]);
    		Logger.debug.println(info.getSession("ID"), ws.getRequest(), new StringBuilder("info===>").append(info.getSession("ID")).toString());
    		Config conf = new Configuration();
    		String POASRM_CONTEXT_NAME = conf.getString("sepoa.context.name");
    ...
    private void getSupNotice_seller(SepoaStream ws, String mode)
            throws Exception
        {
            ...
            try
            {
    	        ...
    	        SepoaOut value = ServiceConnector.doService(info, "I_MT_014", "CONNECTION", "getSupNotice_seller", obj);
    	        SepoaFormater wf = ws.getSepoaFormater(value.result[0]);
    	        Logger.debug.println(info.getSession("ID"), ws.getRequest(), new StringBuilder("info===>").append(info.getSession("ID")).toString());
    	        Config conf = new Configuration();
    	        String POASRM_CONTEXT_NAME = conf.getString("sepoa.context.name");
...
//    	            ws.addValue("SEQ", wf.getValue("SEQ", i), "");
    ...
    private void setDataStoreDelete(SepoaStream ws, String mode)
            throws Exception
        {
            ...
            SepoaOut value = ServiceConnector.doService(info, "I_MT_014", "TRANSACTION", "DeleteSendDataStore_New", obj);
            Vector multilang_id = new Vector();
            multilang_id.addElement("MESSAGE");
        ...
        throws Exception
    {
        ...
        //Logger.debug.println(info.getSession("ID"), this, ">>>>>>>>>>>>>>>>>>>>>>>>> 2");
        SepoaOut value = ServiceConnector.doService(info, "I_MT_014", "TRANSACTION", "DeleteSendNotice_New", obj);
        Vector multilang_id = new Vector();
        multilang_id.addElement("MESSAGE");
        HashMap messages = MessageUtil.getMessage(info, multilang_id);
        String uObj[] = {
    ...
    private void setFaqDelete(SepoaStream ws, String mode)
    	...
    	Logger.debug.println(info.getSession("ID"), this, ">>>>>>>>>>>>>>>>>>>>>>>>> 2");
    	SepoaOut value = ServiceConnector.doService(info, "I_MT_014", "TRANSACTION", "DeleteSendFaq_New", obj);
    	Vector multilang_id = new Vector();
    	multilang_id.addElement("MESSAGE");
    	HashMap messages = MessageUtil.getMessage(info, multilang_id);
    	String uObj[] = {
