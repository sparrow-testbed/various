...
public class bd_prepare_list_ict extends HttpServlet {
    ...
    public void doPost( HttpServletRequest req, HttpServletResponse res ) throws IOException, ServletException {
        ...
        try {
			...
			if ("getBdPrepareList".equals(mode)) {
				gdRes = getBdPrepareList(gdReq , info); 
			} 
    ...
    /* ICT사용 : 내정가격등록-리스트 */
    public GridData getBdPrepareList( GridData gdReq, SepoaInfo info ) throws Exception {
        ...
        try {
            ...
            gdRes.addParam( "mode", "getBdPrepareList" );
             
            Object[] obj = { headerData };
			SepoaOut value = ServiceConnector.doService(info, "I_BD_012", "CONNECTION", "getBdPrepareList", obj); //등록요처
