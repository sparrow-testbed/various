...
public class rfq_req_sellersel_left_ict extends HttpServlet {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
		...
		try {
			...
			/*rfq_req_sellersel_left_ict.jsp*/
	...
	public GridData getRfqVedorList(GridData gdReq) throws Exception {
		...
		try {
			...
			hashMap.put ( "sg_code5   ".trim() , sg_code5    );
			hashMap.put ( "company_code   ".trim() , company_code    );

			// EJB CALL
			Object[] obj = { hashMap };
			SepoaOut value = ServiceConnector.doService(info, "I_PU_112", "CONNECTION", "getRfqVedorList", obj);
	...
	public GridData getBottomSupiList(GridData gdReq) throws Exception {
        ...
        try {
            ...
            if("BID_ICT".equals(sel_flag)) {method = "getBottomSupiList2";}
            ...
            SepoaOut value = ServiceConnector.doService(info, "I_PU_112", "CONNECTION", method, obj);
