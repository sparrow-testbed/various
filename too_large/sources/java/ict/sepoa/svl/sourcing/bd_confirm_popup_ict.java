...
public class bd_confirm_popup_ict extends HttpServlet {
    ...
    public GridData getBdItemDetail( GridData gdReq, SepoaInfo info ) throws Exception {
        ...
        try {
			...
			SepoaOut value = ServiceConnector.doService(info, "I_BD_006", "CONNECTION", "getBdItemDetail", obj);
    ...
    public GridData setBdStatus( GridData gdReq, SepoaInfo info ) throws Exception {
        ...
        try {
            ...
            Object[] obj = { allData };
			SepoaOut value = ServiceConnector.doService(info, "I_BD_006", "TRANSACTION", "setBdStatus", obj);
