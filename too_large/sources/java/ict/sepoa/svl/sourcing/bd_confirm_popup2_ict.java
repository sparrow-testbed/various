...
public class bd_confirm_popup2_ict extends HttpServlet {
    ...
    public void doPost( HttpServletRequest req, HttpServletResponse res ) throws IOException, ServletException {
        ...
        try {
			...
			}else if ("getBdItemDetail2".equals(mode)) {
				gdRes = getBdItemDetail2(gdReq , info); 
			}else if ("setBdStatus".equals(mode)) {
				gdRes = setBdStatus(gdReq , info); 
			}else if ("setBdStatus2".equals(mode)) {
				gdRes = setBdStatus2(gdReq , info); 
			}
    ...
    public GridData getBdItemDetail( GridData gdReq, SepoaInfo info ) throws Exception {
        ...
        try {
			...
			SepoaOut value = ServiceConnector.doService(info, "I_BD_019", "CONNECTION", "getBdItemDetail", obj);
    ...
    /* ICT 사용 : 적격업체 업체리스트 가져오기 (통합처러) */
    public GridData getBdItemDetail2( GridData gdReq, SepoaInfo info ) throws Exception {
        ...
        try {
            ...
            Object[] obj = { headerData };
			SepoaOut value = ServiceConnector.doService(info, "I_BD_019", "CONNECTION", "getBdItemDetail2", obj);
    ...
    public GridData setBdStatus( GridData gdReq, SepoaInfo info ) throws Exception {
        ...
        try {
            ...
            Object[] obj = { allData };
			SepoaOut value = ServiceConnector.doService(info, "I_BD_019", "TRANSACTION", "setBdStatus", obj);
    ...
    public GridData setBdStatus2( GridData gdReq, SepoaInfo info ) throws Exception {
        ...
        try {
            ...
            Object[] obj = { allData };
			SepoaOut value = ServiceConnector.doService(info, "I_BD_019", "TRANSACTION", "setBdStatus2", obj);
