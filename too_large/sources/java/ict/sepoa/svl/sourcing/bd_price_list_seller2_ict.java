...
public class bd_price_list_seller2_ict extends HttpServlet {
    ...
    public void doPost( HttpServletRequest req, HttpServletResponse res ) throws IOException, ServletException {
        ...
        try {
			...
			else if ("setBDAPjoinCancel".equals(mode)) {
				gdRes = setBDAPjoinCancel(gdReq , info); 
			}
            ...
            try {
        		if("setBDAPjoinCancel".equals(mode)){
    ...
    public GridData getBdPriceList( GridData gdReq, SepoaInfo info ) throws Exception {
        ...
        try {
			...
			SepoaOut value = ServiceConnector.doService(info, "I_SBD_008", "CONNECTION", "getBdPriceList", obj);
    ...
    public GridData getBdJoinList( GridData gdReq, SepoaInfo info ) throws Exception {
    	...
    	try {
    		...
    		Object[] obj = { headerData };
    		SepoaOut value = ServiceConnector.doService(info, "I_SBD_008", "CONNECTION", "getBdJoinList", obj);
    ...
    public GridData setBidCancel(GridData gdReq, SepoaInfo info) throws Exception {
	    ...
	    try{
	    	...
	    	Object[] obj = {data};
			SepoaOut value = ServiceConnector.doService(info, "I_SBD_008", "TRANSACTION", "setBidCancel", obj);
			if(value.flag) {
				gdRes.setMessage(message.get("MESSAGE.0001").toString()); 
				gdRes.setStatus("true");
			}else {
    ...
    public GridData setBDAPjoinCancel( GridData gdReq, SepoaInfo info ) throws Exception {
    	...
    	try {
    		...
    		Object[] obj = { headerData };
    		SepoaOut value = ServiceConnector.doService(info, "I_SBD_008", "CONNECTION", "setBDAPjoinCancel", obj);
