...
public class bd_open_ict extends HttpServlet {
    ...
    public void doPost( HttpServletRequest req, HttpServletResponse res ) throws IOException, ServletException {
        ...
        try {
			...
			if ("getBdOpen".equals(mode)) {
				gdRes = getBdOpen(gdReq , info); 
			}else if ("setBdProcess".equals(mode)) {
				gdRes = setBdProcess(gdReq , info); 
			}
    ...
    /* ICT 사용 */
    public GridData getBdOpen( GridData gdReq, SepoaInfo info ) throws Exception {
        ...
        try {
            ...
            gdRes.addParam( "mode", "getBdOpen" );
             
            Object[] obj = { headerData };
			SepoaOut value = ServiceConnector.doService(info, "I_BD_014", "CONNECTION", "getBdOpen", obj);
    ...
    public GridData setBdProcess( GridData gdReq, SepoaInfo info ) throws Exception {
        ...
        try {
            ...
            Object[] obj = { allData };
            SepoaOut value = ServiceConnector.doService( info, "BD_014", "TRANSACTION", "setBdProcess", obj );
