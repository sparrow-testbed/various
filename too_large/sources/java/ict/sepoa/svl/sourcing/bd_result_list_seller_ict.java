/**
 * @파일명   : bd_result_list_seller.java
...
public class bd_result_list_seller_ict extends HttpServlet {
    ...
    public void doPost( HttpServletRequest req, HttpServletResponse res ) throws IOException, ServletException {
        ...
        try {
			...
			if ("getBdResultListSeller".equals(mode)) {
				gdRes = getBdResultListSeller(gdReq , info); 
			}
    ...
    /* ICT 사용 */
    public GridData getBdResultListSeller( GridData gdReq, SepoaInfo info ) throws Exception {
        ...
        try {
            ...
            gdRes.addParam( "mode", "getBdResultListSeller" );
             
            Object[] obj = { headerData };
			SepoaOut value = ServiceConnector.doService(info, "I_SBD_005", "CONNECTION", "getBdResultListSeller", obj);
