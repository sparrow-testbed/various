...
public class bd_open_list_ict extends HttpServlet {
    ...
    public void doPost( HttpServletRequest req, HttpServletResponse res ) throws IOException, ServletException {
        ...
        try {
			...
			if ("getBdOpenList".equals(mode)) {
				gdRes = getBdOpenList(gdReq , info); 
			}else if("getVendor".equals(mode)){
				gdRes = getVendor(gdReq , info); 
			}
    ...
    /* ICT 사용 */
    public GridData getBdOpenList( GridData gdReq, SepoaInfo info ) throws Exception {
        ...
        try {
            ...
            gdRes.addParam( "mode", "getBdOpenList" );
             
            Object[] obj = { headerData };
			SepoaOut value = ServiceConnector.doService(info, "I_BD_014", "CONNECTION", "getBdOpenList", obj);
    ...
    /* ICT 사용 */
    public GridData getVendor( GridData gdReq, SepoaInfo info ) throws Exception {
    	...
    	try {
    		...
    		String[] grid_col_ary = SepoaString.parser( grid_col_id, "," );
    		gdRes = OperateGridData.cloneResponseGridData( gdReq );
    		gdRes.addParam( "mode", "getVendor" );
    		
    		Object[] obj = { headerData };
    		SepoaOut value = ServiceConnector.doService(info, "I_BD_014", "CONNECTION", "getVendor", obj);
