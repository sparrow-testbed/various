...
public class bd_confirm_list2_ict extends HttpServlet {
    ...
    public void doPost( HttpServletRequest req, HttpServletResponse res ) throws IOException, ServletException {
        ...
        try {
			...
			if ("getBdConfrimList".equals(mode)) {
				gdRes = getBdConfrimList(gdReq , info); 
			}
    ...
    public GridData getBdConfrimList( GridData gdReq, SepoaInfo info ) throws Exception {
        ...
        try {
			...
			SepoaOut value = ServiceConnector.doService(info, "I_BD_019", "CONNECTION", "getBdConfrimList", obj);
