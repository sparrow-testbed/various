...
public class bd_ann_list_ict extends HttpServlet {
    ...
    public GridData getBdAnnList( GridData gdReq, SepoaInfo info ) throws Exception {
        ...
        try {
			...
			SepoaOut value = ServiceConnector.doService(info, "I_BD_002", "CONNECTION", "getBdAnnList", obj);
    ...
    public GridData setBdDelete( GridData gdReq, SepoaInfo info ) throws Exception {
        ...
        try {
			...
			SepoaOut value = ServiceConnector.doService(info, "I_BD_002", "CONNECTION", "setBdDelete", obj);
    ...
    private GridData charge_transfer(GridData gdReq, SepoaInfo info) throws Exception{
    	...
    	try {
			...
			SepoaOut value = ServiceConnector.doService(info, "I_BD_002", "CONNECTION", "charge_transfer", obj);
