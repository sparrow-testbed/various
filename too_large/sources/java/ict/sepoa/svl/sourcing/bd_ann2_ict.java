...
public class bd_ann2_ict extends HttpServlet {
    ...
    public void doPost( HttpServletRequest req, HttpServletResponse res ) throws IOException, ServletException {
        ...
        try {
            ...
            }else if ( "setGonggoDelete".equals(mode) ) {//작성중인건 공고삭제
                gdRes = chkApprRep ( gdReq , info ) ;
            }
    ...
    /*
    public GridData setGonggoDelete( GridData gdReq, SepoaInfo info ) throws Exception {
        ...
        try {
			...
			SepoaOut value = ServiceConnector.doService(info, "I_BD_020", "CONNECTION", "setGonggoDelete", obj);
            ...
            gdRes.addParam( "mode", "setGonggoDelete" );
		} catch (Exception e) {
    ...
    */
    ...
    public GridData getPrItemDetail( GridData gdReq, HttpServletRequest req, SepoaInfo info ) throws Exception {
        ...
        try {
			...
			SepoaOut value = ServiceConnector.doService(info, "I_BD_020", "CONNECTION", "getPrItemDetail", obj);
    ...
    public GridData setAnnCreate( GridData gdReq, SepoaInfo info ) throws Exception {
        ...
        try {
            ...
            Object[] obj = { allData };
			SepoaOut value = ServiceConnector.doService(info, "I_BD_020", "TRANSACTION", "setAnnCreate", obj);
 
			if( value.flag ) { 
	            gdRes.addParam( "pflag", value.result[0] );
	            gdRes.addParam( "ann_no", value.result[1] );
	            gdRes.addParam( "ann_count", value.result[2] );
    ...
    public GridData setGonggoModify( GridData gdReq, SepoaInfo info ) throws Exception {
        ...
        try {
            ...
            Object[] obj = { allData };
			SepoaOut value = ServiceConnector.doService(info, "I_BD_020", "TRANSACTION", "setGonggoModify", obj);
    ...
    public GridData setGonggoConfirm( GridData gdReq, SepoaInfo info ) throws Exception {
        ...
        try {
            ...
            Object[] obj = { allData };
			SepoaOut value = ServiceConnector.doService(info, "I_BD_020", "TRANSACTION", "setGonggoConfirm", obj);
    ...
    public GridData setApprovalRequest(GridData gdReq, SepoaInfo info) throws Exception {
        ...
        try
        {
            ...
            Object[] obj = {allData};
            SepoaOut value = ServiceConnector.doService(info, "I_BD_020", "TRANSACTION", "setApprovalRequest", obj);
    ...
    public GridData setUGonggoCreate( GridData gdReq, SepoaInfo info ) throws Exception {
        ...
        try {
            ...
            Object[] obj = { allData };
			SepoaOut value = ServiceConnector.doService(info, "I_BD_020", "TRANSACTION", "setUGonggoCreate", obj);
    ...
    public GridData setUGonggoModify( GridData gdReq, SepoaInfo info ) throws Exception {
        ...
        try {
            ...
            Object[] obj = { allData };
			SepoaOut value = ServiceConnector.doService(info, "I_BD_020", "TRANSACTION", "setUGonggoModify", obj);
    ...
    public GridData setCopy( GridData gdReq, SepoaInfo info ) throws Exception {
    	...
    	try {
    		...
    		Object[] obj = { headerData };
    		SepoaOut value = ServiceConnector.doService(info, "I_BD_020", "TRANSACTION", "setFileCopy", obj);
    ...
    private GridData chkApprRep(GridData gdReq, SepoaInfo info) throws Exception{
	    ...
	    try{
	    	...
	    	value   = ServiceConnector.doService(info, "I_BD_020", "CONNECTION","chkApprRep", obj);
