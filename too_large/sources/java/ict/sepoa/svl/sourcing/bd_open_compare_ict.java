...
public class bd_open_compare_ict extends HttpServlet {
    ...
    public GridData getBdDetailCompare( GridData gdReq, SepoaInfo info ) throws Exception {
        ...
        try {
			...
			SepoaOut value = ServiceConnector.doService(info, "I_BD_014", "CONNECTION", "getBdDetailCompare", obj);
    ...
    public GridData setOrder( GridData gdReq, SepoaInfo info ) throws Exception {
        ...
        try {
            ...
            Object[] obj = { headerData };
			SepoaOut value = ServiceConnector.doService(info, "I_BD_014", "CONNECTION", "setOrder", obj);
    ...
    public GridData setBdProcessSB( GridData gdReq, SepoaInfo info ) throws Exception {
        ...
        try {
            ...
            Object[] obj = { allData };
			SepoaOut value = ServiceConnector.doService(info, "I_BD_014", "CONNECTION", "setBdProcessSB", obj);
    ...
    public GridData setReBd( GridData gdReq, SepoaInfo info ) throws Exception {
        ...
        try {
            ...
            Object[] obj = { allData };
			SepoaOut value = ServiceConnector.doService(info, "I_BD_014", "CONNECTION", "setReBd", obj);
