/**
 * @파일명   : bd_ann_list_seller_ict.java
...
public class bd_ann_list_seller2_ict extends HttpServlet {
    ...
    public void doPost( HttpServletRequest req, HttpServletResponse res ) throws IOException, ServletException {
        ...
        try {
			...
			if ("getBdAnnListSeller".equals(mode)) {
				gdRes = getBdAnnListSeller(gdReq , info); 
			}
    ...
    // ICT 사용
    public GridData getBdAnnListSeller( GridData gdReq, SepoaInfo info ) throws Exception {
        ...
        try {
			...
			SepoaOut value = ServiceConnector.doService(info, "I_SBD_007", "CONNECTION", "getBdAnnListSeller", obj);
