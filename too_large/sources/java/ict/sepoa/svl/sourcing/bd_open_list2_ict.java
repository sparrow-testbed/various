...
public class bd_open_list2_ict extends HttpServlet {
    ...
    public GridData getVendor( GridData gdReq, SepoaInfo info ) throws Exception {
    	...
    	try {
    		...
    		SepoaOut value = ServiceConnector.doService(info, "I_BD_020", "CONNECTION", "getVendor", obj);
