...
public class bd_py_confirm_ict extends HttpServlet {
    ...
    public void doPost( HttpServletRequest req, HttpServletResponse res ) throws IOException, ServletException {
        ...
        try {
			...
			if ("getBdPyConfirmList".equals(mode)) {
				gdRes = getBdPyConfirmList(gdReq , info); 
			}
			else if ("setBdPyConfirm".equals(mode)) {
				gdRes = setBdPyConfirm(gdReq , info); 
			}
    ...
    public GridData getBdPyConfirmList( GridData gdReq, SepoaInfo info ) throws Exception {
    	...
    	try {
    		...
    		SepoaOut value = ServiceConnector.doService(info, "I_BD_030", "CONNECTION", "getBdPyConfirmList", obj);
    ...
    /* ICT 사용 : 적격업체 저장*/
    public GridData setBdPyConfirm( GridData gdReq, SepoaInfo info ) throws Exception {
        ...
        try {
            ...
            gdRes.addParam( "mode", "setBdPyConfirm" );
  
            Object[] obj = { allData };
			SepoaOut value = ServiceConnector.doService(info, "I_BD_030", "TRANSACTION", "setBdPyConfirm", obj);
