...
public class bd_ct_confirm_ict2 extends HttpServlet {
    ...
    public void doPost( HttpServletRequest req, HttpServletResponse res ) throws IOException, ServletException {
        ...
        try {
			...
			if ("getBdCt2ConfirmList".equals(mode)) {
				gdRes = getBdCt2ConfirmList(gdReq , info); 
			}
			else if ("setBdCt2Confirm".equals(mode)) {
				gdRes = setBdCt2Confirm(gdReq , info); 
			}
    ...
    public GridData getBdCt2ConfirmList( GridData gdReq, SepoaInfo info ) throws Exception {
    	...
    	try {
    		...
    		SepoaOut value = ServiceConnector.doService(info, "I_BD_029", "CONNECTION", "getBdCt2ConfirmList", obj);
    ...
    /* ICT 사용 : 적격업체 저장*/
    public GridData setBdCt2Confirm( GridData gdReq, SepoaInfo info ) throws Exception {
        ...
        try {
            ...
            gdRes.addParam( "mode", "setBdCt2Confirm" );
  
            Object[] obj = { allData };
			SepoaOut value = ServiceConnector.doService(info, "I_BD_029", "TRANSACTION", "setBdCt2Confirm", obj);
