...
public class rfq_bd_ins1 extends HttpServlet{
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
    	...
    	try {
    		...
    		if("setRfqSubmit".equals(mode)){
    			gdRes = this.setRfqSubmit(gdReq, info);   
    		}else if("setRfqGiveUp".equals(mode)){
    			gdRes = this.setRfqGiveUp(gdReq, info);   
    		}    	
    	}catch (Exception e) {
    ...
    private GridData setRfqSubmit(GridData gdReq, SepoaInfo info) throws Exception{
    	GridData                  gdRes           = null;
    	...
    	try {
    		...
    		qtaNo         = this.setCreateQtaNo(info);
    		
    		header.put("QTA_NO",           qtaNo);
    		...
    		value = ServiceConnector.doService(info, "I_s2011", "TRANSACTION", "setRfqSubmit", obj);
    ...
    private String setCreateQtaNo(SepoaInfo info) throws Exception{
    	String   result = null;
    	SepoaOut wo2    = null;
    	
    	wo2    = DocumentUtil.getDocNumber(info, "IQT");
    	result = wo2.result[0];
    ...
    @SuppressWarnings({ "rawtypes", "unchecked", "deprecation" })
    private GridData setRfqGiveUp(GridData gdReq, SepoaInfo info) throws Exception{
    	GridData                  gdRes           = null;
    	HashMap                   message         = null;
    	SepoaOut                  value           = null;
    	Map<String, Object>       data            = null;
