...
public class ven_bd_ins10_ict extends HttpServlet {
	...
	private GridData getHicoBdLis3(GridData gdReq, SepoaInfo info) throws Exception{
	    ...
	    try{
	    	...
	    	value = ServiceConnector.doService(info, "I_s6006", "CONNECTION", "getHicoBdLis3", obj);
    ...
    private GridData insertHicoBdLis3(GridData gdReq, SepoaInfo info) throws Exception{
    	...
    	try {
    		...
    		value = ServiceConnector.doService(info, "I_s6006", "TRANSACTION", "insertHicoBdLis3", obj);
	...
	private GridData deleteHicoBdLis3(GridData gdReq, SepoaInfo info) throws Exception{
		...
		try {
			...
			value = ServiceConnector.doService(info, "I_s6006", "TRANSACTION", "deleteHicoBdLis3", obj);
