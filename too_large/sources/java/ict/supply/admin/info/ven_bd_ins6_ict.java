...
public class ven_bd_ins6_ict extends HttpServlet {
	...
	private GridData getMainternace_icomvncp(GridData gdReq, SepoaInfo info) throws Exception{
	    ...
	    try{
	    	...
	    	value = ServiceConnector.doService(info, "I_p0010", "CONNECTION", "getMainternace_icomvncp", obj);
    ...
    private GridData setSave_icomvncp(GridData gdReq, SepoaInfo info) throws Exception{
    	...
    	try {
    		...
    		value = ServiceConnector.doService(info, "I_p0010", "TRANSACTION", "setSave_icomvncp", obj);
...
//    		}
	...
	private GridData setDelete_icomvncp(GridData gdReq, SepoaInfo info) throws Exception{
		...
		try {
			...
			value = ServiceConnector.doService(info, "I_p0010", "TRANSACTION", "setDelete_icomvncp", obj);
