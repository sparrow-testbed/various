...
public class mcl_ins2 extends HttpServlet{
    ...
    private GridData doData(GridData gdReq, SepoaInfo info) throws Exception{
    	...
    	try {
    		...
    		value = ServiceConnector.doService(info, "p6024", "TRANSACTION", "mcl_setInsert2", setInsert2Param);
    		value = ServiceConnector.doService(info, "p6024", "TRANSACTION", "Area_setInsert", areaSetInsertParam);
