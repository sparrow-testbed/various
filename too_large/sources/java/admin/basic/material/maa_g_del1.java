...
public class maa_g_del1 extends HttpServlet{
	...
	private Map<String, Object> doDataSvcParam(GridData gdReq, SepoaInfo info) throws Exception{
    	...
    	String                    type   = null;//header.get("type");
    	String                    code         = null;
    	...
    	for(i = 0; i < gridSize; i++){
    		...
    		gridInfo = grid.get(i);
    		code     = gridInfo.get("VENDOR_CODE");
    		type      = gridInfo.get("GROUP_CODE");
    ...
    private GridData doData(GridData gdReq, SepoaInfo info) throws Exception{
    	...
    	try {
    		...
    		value = ServiceConnector.doService(info, "p6025", "TRANSACTION", "Area_setDelete", obj);
