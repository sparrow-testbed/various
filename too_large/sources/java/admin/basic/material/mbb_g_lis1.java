...
public class mbb_g_lis1 extends HttpServlet{
	...
	private GridData queryGdRes(GridData gdRes, SepoaOut value, HashMap message, String[] gridColAry) throws Exception{
	...
	private GridData query(GridData gdReq, SepoaInfo info) throws Exception{
	    ...
	    try{
	    	...
	    	value = ServiceConnector.doService(info, "p6025", "CONNECTION", "mbb_getVendorList", obj);
	    	gdRes = this.queryGdRes(gdRes, value, message, gridColAry);
	    }
	    catch (Exception e){
