...
public class mbb_g_ins1 extends HttpServlet{
	...
	private List<Map<String, String>> doDataGridData(GridData gdReq, SepoaInfo info) throws Exception{
    	...
    	for(i = 0; i < gridSize; i++){
    		...
    		VENDOR_CODE  = gridInfo.get("VENDOR_CODE");
    		
    		resultInfo.put("HOUSE_CODE",       HOUSE_CODE);
    		resultInfo.put("TYPE",         GROUP_CODE);
    		resultInfo.put("CODE",        VENDOR_CODE);
    ...
    private GridData doData(GridData gdReq, SepoaInfo info) throws Exception{
    	...
    	try {
    		...
    		value = ServiceConnector.doService(info, "p6025", "TRANSACTION", "mbb_setInsert", obj);
