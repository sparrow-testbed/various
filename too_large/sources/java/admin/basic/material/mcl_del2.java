...
public class mcl_del2 extends HttpServlet{
    ...
    private GridData doData(GridData gdReq, SepoaInfo info) throws Exception{
    	...
    	try {
    		...
    		value = ServiceConnector.doService(info, "p6024", "TRANSACTION", "mcl_setDelete2", mclSetDelete2Param);
    		value = ServiceConnector.doService(info, "p6024", "TRANSACTION", "Area_setDelete", areaSetDeleteParam);
