/* TOBE 2017-07-01 자본예산 계좌유효성 및 계좌이체 송신 */
...
//AS-IS : IF_OT870101S
public class IF_BCB01000T03_S extends OUT_MSG {
    ...
    public static String PGMID = "IF_BCB01000T03_S";  
    ...
    private int[] iLen = {3,7,8,4,5,5,1,56,2,6,1,12,8,8,8,7,8,1,1,1,4,20,15,15,15,1,3,3,2,100,5,};
    
    public IF_BCB01000T03_S()
    {
    	iTLen = 335;
    }
