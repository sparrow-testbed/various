/* TOBE 2017-07-01 UMS SMS 문자 발송 EAI */
...
public class UMSCALLSMS extends SepoaService implements I_Wms  {
	  
    public IF_UMSCALLSMS_S  SEND      =  null;
    public IF_UMSCALLSMS_R  RECV      =  null;
    ...
    public UMSCALLSMS () {    	
        this.SEND    = new IF_UMSCALLSMS_S();
        this.RECV    = new IF_UMSCALLSMS_R();
    	...
    	SEND.sysHdr.INTF_ID                	     =  "EPSER0000010"           ;   //(문자	12        )  인터페이스 ID            
    	...
    	SEND.trnHdr.TRN_CD                 =  "CALLSMS";               //(문자	9   )  거래코드                   
    	SEND.trnHdr.SRVC_ID                =  "ISGF_0000010";          //(문자	11  )  서비스ID                   
	...
	public	int sendMessage(String EventCode, String servAddress, int servPort ) {
		if(EventCode.equals("UMSCALLSMS")) {
			...
			try {  
				    ...
				    //test start 
				    //System.out.println("debug:UMSCALLSMS:length:"+slen);
