...
public class CMT90040100 extends SepoaService implements I_Wms  { //TOBE 2017-07-01 추가 SepoaService
	  
    public IF_CMT90040100_S  SEND      =  null;
    public IF_CMT90040100_R  RECV      =  null;
	...
	public String getrcvTxt() {
		return this.rcvTxt;
	}
    
    public CMT90040100 () {    	
        this.SEND    = new IF_CMT90040100_S();
        this.RECV    = new IF_CMT90040100_R();
    	...
    	SEND.sysHdr.INTF_ID                	     =  "EPSER0000009"           ;   //(문자	12        )  인터페이스 ID            
    	...
    	SEND.trnHdr.TRN_CD                 =  "CMT900401";             //(문자	9   )  거래코드                   
    	SEND.trnHdr.SRVC_ID                =  "CMT90040100";           //(문자	11  )  서비스ID                   
	...
	public	int sendMessage(String EventCode, String servAddress, int servPort ) {
		...
		if("CMT90040100".equals(EventCode)) {
			...
			try {  
				    ...
				    if(rcvSize != -1) {
					    ...
					    try {
							...
							param.put("IF_NAME", "CMT90040100"); 
							param.put("SEND_NO", send_no); 
							param.put("CONTS", ""); //보안때문에 공란
							...
							//resultData = new String(in, "KSC5601").trim(); // 한글부분을 처리하고
					    	
					    	//ASIS 2017-07-01 정상처리시 결과내용에 아무것도 안들온다 this.errorCode = RECV.RST_TXT.substring(170, 178);
					    	//TOBE 2017-07-01
					    	this.errorCode = RECV.RST_TXT;
					    	this.rcvTxt = RECV.RST_TXT;
