...
public class ven_bd_ins9 extends HttpServlet {
	...
	private GridData getVendorProject(GridData gdReq, SepoaInfo info) throws Exception{
	    ...
	    try{
	    	...
	    	value = ServiceConnector.doService(info, "p0010", "CONNECTION", "getVendorProject", obj);
	...
	private GridData setVendorProject(GridData gdReq, SepoaInfo info) throws Exception{
		...
		try {
			...
			value = ServiceConnector.doService(info, "p0010", "TRANSACTION", "setVendorProject", obj);
...
//			}
	...
	private GridData delVendorProject(GridData gdReq, SepoaInfo info) throws Exception{
		...
		try {
			...
			value = ServiceConnector.doService(info, "p0010", "TRANSACTION", "delVendorProject", obj);
