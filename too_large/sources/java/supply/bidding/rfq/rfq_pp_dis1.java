...
public class rfq_pp_dis1 extends HttpServlet {
	    ...
	    public void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
	    	...
	    	try {
	    		...
	    		if("getRfqDTDisplay_TYPE".equals(mode)){ 					// 견적요청상세조회
	    			gdRes = this.getRfqDTDisplay_TYPE(gdReq, info);
	    		}
		...
		private GridData getRfqDTDisplay_TYPE(GridData gdReq, SepoaInfo info) throws Exception{
		    GridData            gdRes      = new GridData();
		    SepoaFormater       sf         = null;
		    SepoaOut            value      = null;
		    Vector              v          = new Vector();
		    ...
		    try{
		    	...
		    	value = ServiceConnector.doService(info, "s2011", "CONNECTION","getRfqDTDisplay_TYPE", obj);
