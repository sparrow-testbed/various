...
public class eva_temp_list extends SepoaServlet 
{
	 public void doGet(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
	    ...
	    public void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
	        ...
	        try {
	       		...
	       		{	
	       			...
	       			gdRes = setTempDelete(gdReq, info);
	       		}
	    ...
	    public GridData getTempList(GridData gdReq, SepoaInfo info) throws Exception {
	   		...
	   		try {
	   			...
	   			SepoaOut value = ServiceConnector.doService(info, "SR_017", "CONNECTION", "getTempList", obj);
	    ...
	    public GridData setTempDelete(GridData gdReq, SepoaInfo info) throws Exception {
	   		...
	   		try {
	   			...
	   			Object[] obj = {data};
	   			SepoaOut value = ServiceConnector.doService(info, "SR_017", "TRANSACTION","setTempDelete", obj);
