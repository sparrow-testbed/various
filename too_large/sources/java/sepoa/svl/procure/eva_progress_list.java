...
public class eva_progress_list extends SepoaServlet 
{
...
//					String[] imagetext3 = {"/kr/images/button/query.gif",	"", ""};
//
...
//
//					ws.addValue("valuer", 			wf.getValue("valuer" , i), "");
//	                ws.addValue("comp_flag", 		wf.getValue("comp_flag" , i), "");
//	                ws.addValue("detail" , 			imagetext3, "");
//	                ws.addValue("eval_refitem", 	wf.getValue("eval_refitem" , i), "");
//	                ws.addValue("e_template_refitem", 	wf.getValue("e_template_refitem" , i), "");
//
//					ws.addValue("e_valuer_id", 		wf.getValue("e_valuer_id" , i), "");
...
//    }
    ...
    public GridData getEvaList(GridData gdReq, SepoaInfo info) throws Exception 
    {
        ...
        try {
			...
			SepoaOut value = ServiceConnector.doService(info, "SR_024", "CONNECTION", "getEvaList", obj);
			...
			for (int i = 0; i < wf.getRowCount(); i++) {
				for(int k=0; k < grid_col_ary.length; k++) {
					if(grid_col_ary[k]!=null && grid_col_ary[k].equals("detail")){
						if("Y".equals(wf.getValue("comp_flag", i))){
							gdRes.addValue(grid_col_ary[k],"<img src='/images/icon/icon_search.gif'/>");
						}else{
