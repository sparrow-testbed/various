...
public class eva_detail_list extends HttpServlet 
{
...
//            
//        SepoaOut value = getQuery(evalname, vendor_code, info);  
//
//        if( value.status == 0 ){
//			isOk = false;
...
//					String[] imagetext2 = {"/kr/images/button/query.gif", "", ""};
//					String[] imagetext3 = {"",	wf.getValue("eval_vendor" , i), wf.getValue("eval_vendor" , i)};
//
...
//	                ws.addValue("eval_vendor" , 	imagetext3, "");
//
//	                ws.addValue("operator", 		wf.getValue("operator" , i), "");
//	                ws.addValue("detail" , 			imagetext2, "");
...
//    }
    ...
    public GridData getEvaList(GridData gdReq, SepoaInfo info) throws Exception 
    {
        ...
        String MethodName = "getEvabdlis5";  
        ...
        try {
			...
			SepoaOut value = ServiceConnector.doService(info, "SR_033", "CONNECTION", "getEvaList", obj);
			...
			for (int i = 0; i < wf.getRowCount(); i++) {
				for (int k = 0; k < grid_col_ary.length; k++) {
					if(grid_col_ary[k] != null && grid_col_ary[k].equals("detail")){
						gdRes.addValue(grid_col_ary[k],	"/images/icon/icon_search.gif");
					}else{
