...
public class eva_item_list extends SepoaServlet 
{
	 public void doGet(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
	    ...
	    public void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
	        ...
	        try {
	       		...
	       		{	
	       			gdRes = getEvaList(gdReq, info);		//議고쉶
	       		}
	    ...
	    public GridData getEvaList(GridData gdReq, SepoaInfo info) throws Exception {
	   		...
	   		try {
	   			...
	   			SepoaOut value = ServiceConnector.doService(info, "SR_015", "CONNECTION", "getEvaList", obj);
	   			...
	   			for (int i = 0; i < wf.getRowCount(); i++) {
	   				for(int k=0; k < grid_col_ary.length; k++) {
	   			    	...
	   			    	else if(grid_col_ary[k] != null && grid_col_ary[k].equals("systime_updated")) {
	    ...
	    public GridData setEvaDelete(GridData gdReq, SepoaInfo info) throws Exception {
	   		...
	   		try {
	   			gdRes.addParam("mode", "setEvaDelete");
	   			gdRes.setSelectable(false);
	   			
	   			Map<String, Object> data = SepoaDataMapper.getData(info, gdReq);
	   			
	   			Object[] obj = {data};
	   			SepoaOut value = ServiceConnector.doService(info, "SR_015", "TRANSACTION","setEvaDelete", obj);
