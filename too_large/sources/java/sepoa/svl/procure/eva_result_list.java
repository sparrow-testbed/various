...
public class eva_result_list extends SepoaServlet 
{
...
//					String[] imagetext3 = {"",	wf.getValue("eval_score" , i), wf.getValue("eval_score" , i)};
//
...
//	                ws.addValue("QUANTITY_SCORE",	wf.getValue("QUANTITY_SCORE" , i), "");
...
//    }
    ...
    public GridData getEvaList(GridData gdReq, SepoaInfo info) throws Exception 
    {
        ...
        String MethodName = "getEvabdlis4";  
        ...
        try {
			...
			SepoaOut value = ServiceConnector.doService(info, "SR_025", "CONNECTION", "getEvaList", obj);
