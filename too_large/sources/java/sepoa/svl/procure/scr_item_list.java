...
public class scr_item_list extends SepoaServlet 
{
	 public void doGet(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
	    ...
	    public void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
	        ...
	        try {
	       		...
	       		if ("getScrList".equals(mode))
	       		{	
	       			gdRes = getScrList(gdReq, info);		//議고쉶
	       		}
	       		
	       		else if ("setScrDelete".equals(mode))
	       		{	
	       			gdRes = setScrDelete(gdReq, info);		//��젣
	       		}
	...
	//��ȸ�� ���Ǵ� Method �Դϴ�. Method Name(doQuery)�� ������ �� ����ϴ�.
	    public GridData getScrList(GridData gdReq, SepoaInfo info) throws Exception {
	   	    GridData gdRes   		= new GridData();
	   		...
	   		try {
	   			...
	   			gdRes.addParam("mode", "getScrList");
	   			
	   			Object[] obj = {data};
	   			// DB �곌껐諛⑸쾿 : CONNECTION, TRANSACTION, NONDBJOB
	   			SepoaOut value = ServiceConnector.doService(info, "SR_007", "CONNECTION", "getScrList", obj);
		...
		public GridData setScrDelete(GridData gdReq, SepoaInfo info) throws Exception {
	   	    GridData gdRes      = new GridData();
	   	    Vector multilang_id = new Vector();
	   		multilang_id.addElement("MESSAGE");
	   		HashMap message     = MessageUtil.getMessage(info,multilang_id);
	   		...
	   		try {
	   			gdRes.addParam("mode", "setScrDelete");
	   			gdRes.setSelectable(false);
	   			
	   			Map<String, Object> data = SepoaDataMapper.getData(info, gdReq);
	   			
	   			Object[] obj = {data};
	   			SepoaOut value = ServiceConnector.doService(info, "SR_007", "TRANSACTION","setScrDelete", obj);
