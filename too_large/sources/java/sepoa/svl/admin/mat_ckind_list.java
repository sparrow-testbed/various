...
public class mat_ckind_list extends HttpServlet {
	...
	public GridData doQuery(GridData gdReq) throws Exception {
		...
		try {
			...
			Object[] obj = {allData};
			SepoaOut value = ServiceConnector.doService(info, "AD_104", "CONNECTION", "doQuery", obj);
	...
	public GridData doRegist(GridData gdReq) throws Exception {
		...
		try {
            ...
            allData     = SepoaDataMapper.getData( info, gdReq );
            Object[] obj = { allData };
			SepoaOut value = ServiceConnector.doService(info, "AD_104", "TRANSACTION", "doRegist", obj);
	...
	public GridData doDelete(GridData gdReq) throws Exception {
		...
		try {
            ...
            allData     = SepoaDataMapper.getData( info, gdReq );
            Object[] obj = { allData };
			SepoaOut value = ServiceConnector.doService(info, "AD_104", "TRANSACTION", "doDelete", obj);
	...
	public GridData doUpdate(GridData gdReq) throws Exception {
		...
		try {
            ...
            allData     = SepoaDataMapper.getData( info, gdReq );
            Object[] obj = { allData };
			SepoaOut value = ServiceConnector.doService(info, "AD_104", "TRANSACTION", "doUpdate", obj);
    ...
    public GridData doSave(GridData gdReq) throws Exception {
        ...
        try {
            ...
            SepoaOut value = ServiceConnector.doService(info, "AD_104", "TRANSACTION", "doSave", obj);
