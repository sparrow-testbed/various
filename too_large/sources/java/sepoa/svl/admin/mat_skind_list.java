...
public class mat_skind_list extends HttpServlet {
	...
	public GridData doQuery(GridData gdReq) throws Exception {
		...
		try {
			...
			// EJB CALL
			//Object[] obj = {LKIND,CKIND};
			Object[] obj = {allData};
			SepoaOut value = ServiceConnector.doService(info, "AD_105", "CONNECTION", "doQuery", obj);
	...
	public GridData doRegist(GridData gdReq) throws Exception {
		...
		try {
			...
			**/
            Object[] obj = { allData };
			SepoaOut value = ServiceConnector.doService(info, "AD_105", "TRANSACTION", "doRegist", obj);
	...
	public GridData doDelete(GridData gdReq) throws Exception {
		...
		try {
			...
			**/
            Object[] obj = { allData };
			SepoaOut value = ServiceConnector.doService(info, "AD_105", "TRANSACTION", "doDelete", obj);
	...
	public GridData doUpdate(GridData gdReq) throws Exception {
		...
		try {
			...
			**/
            Object[] obj = { allData };
			SepoaOut value = ServiceConnector.doService(info, "AD_105", "TRANSACTION", "doUpdate", obj);
