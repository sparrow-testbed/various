...
public class user_status extends SepoaServlet
{
    ...
    public GridData setProfile(GridData gdReq, SepoaInfo info) throws Exception
    {
        ...
        try
        {
            ...
            SepoaOut value = ServiceConnector.doService(info, "AD_132", "TRANSACTION", "setProfile", obj);
    ...
    */
    public GridData getMainternace(GridData gdReq , SepoaInfo info) throws Exception
    {
        ...
        { 
            ...
            //EJB CALL
            Object[] obj = {allData};
            value = ServiceConnector.doService(info, "AD_132", "CONNECTION", "getMainternace", obj);
    ...
    */
    public GridData doApproval(GridData gdReq, SepoaInfo info) throws Exception
    {
        ...
        try
        {
            ...
            SepoaOut value = ServiceConnector.doService(info, "AD_132", "TRANSACTION", "setApproval", obj);
    ...
    */
    public GridData setDelete(GridData gdReq , SepoaInfo info) throws Exception
    {
        ...
        try
        {
             ...
             Object[] obj = {gridData };
             SepoaOut value = ServiceConnector.doService(info, "AD_132", "TRANSACTION", "setDelete", obj);
...
/*
	...
	private void setStatusD(SepoaStream ws, String mode) throws Exception
	{
        ...
        SepoaOut value = ServiceConnector.doService(info, "AD_132", "TRANSACTION","setStatusD", obj);
