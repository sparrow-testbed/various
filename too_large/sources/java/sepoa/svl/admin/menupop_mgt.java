...
public class Menupop_mgt extends HttpServlet {

    private static final long serialVersionUID = 7640868381225691644L;
    ...
    public GridData queryCodedList(GridData gdReq, SepoaInfo info) throws Exception { // 쿼리조회
        GridData gdRes = new GridData();
        int rowCount = 0;
        SepoaOut value = null;
        ...
        try {
            ...
            String code = JSPUtil.CheckInjection(gdReq.getParam("code")).trim()
                    .toUpperCase();
            String language = JSPUtil
                    .CheckInjection(gdReq.getParam("language")).trim()
                    .toUpperCase();
            String search = JSPUtil.CheckInjection(gdReq.getParam("search"))
                    .trim().toUpperCase();
            ...
            value = ServiceConnector.doService(info, "AD_015", "CONNECTION",
                    "getCodedQuery", obj);
            ...
            for (int i = 0; i < rowCount; i++) {
                for (int k = 0; k < grid_col_ary.length; k++) {
                    if (grid_col_ary[k] != null
                            && grid_col_ary[k].equals("SELECTED")) {
                        gdRes.addValue("SELECTED", "0");
                    } else if (grid_col_ary[k] != null
                            && grid_col_ary[k].equals("USE_FLAG")) {
    ...
    public GridData insertCodedList(GridData gdReq, SepoaInfo info) throws Exception {
        ...
        try {
            ...
            for (int i = 0; i < row_count; i++) {
                ...
                // 배열루프변수에 그리드 컬럼값 담기
                String[] loop_data1 = { gdReq.getValue("LANGUAGE", i),
                        gdReq.getValue("CODE", i), gdReq.getValue("TEXT1", i),
                        gdReq.getValue("TEXT2", i), gdReq.getValue("TEXT3", i),
                        gdReq.getValue("TEXT4", i), gdReq.getValue("TEXT5", i),
                        gdReq.getValue("TEXT6", i), gdReq.getValue("TEXT7", i),
                        gdReq.getValue("FLAG", i), sort_seq,
            ...
            SepoaOut value = ServiceConnector.doService(info, "AD_015",
                    "TRANSACTION", "getCodedInsert", obj);
    ...
    public GridData modifyCodedList(GridData gdReq, SepoaInfo info) throws Exception {
        ...
        try {
            ...
            for (int i = 0; i < row_count; i++) {
                ...
                String[] loop_data1 = { use_flag,
                        gdReq.getValue("LANGUAGE", i),
                        gdReq.getValue("CODE", i), gdReq.getValue("CODE", i),
                        gdReq.getValue("TEXT1", i), gdReq.getValue("TEXT2", i),
                        gdReq.getValue("TEXT3", i), gdReq.getValue("TEXT4", i),
                        gdReq.getValue("TEXT5", i), gdReq.getValue("TEXT6", i),
                        gdReq.getValue("TEXT7", i), gdReq.getValue("FLAG", i),
            ...
            Object[] obj = { info, type, bean_args };
            SepoaOut value = ServiceConnector.doService(info, "AD_015",
                    "TRANSACTION", "getCodedModify", obj);
    ...
    public GridData deleteCodedList(GridData gdReq, SepoaInfo info) throws Exception {
        ...
        try {
            ...
            Object[] obj = { info, type, bean_args };
            SepoaOut value = ServiceConnector.doService(info, "AD_015",
                    "TRANSACTION", "getCodedDelete", obj);
    ...
    /*
     * Logger(String method, String message) method명과 message를 받아서 print한다.
     */
    ...
    /*
     * getSystemTime() 현재의 시간을 Return한다.
     */
