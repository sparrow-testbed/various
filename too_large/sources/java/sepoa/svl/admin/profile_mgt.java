...
public class profile_mgt extends HttpServlet
{
	private static final long serialVersionUID = -8276646574309994323L;
    ...
    public GridData selectProfileMupd(GridData gdReq, SepoaInfo info) throws Exception
    {
        ...
        { 
            ...
            String strMenuName = gdReq.getParam("st_menu_name").trim();
            ...
            Object[] obj = {strMenuName, strMuduleType};
	    	value = ServiceConnector.doService(info, "AD_022", "CONNECTION", "selectProfileMupd", obj);
...
/**
	...
	/**
	 * @메소드명 : directInsertProfileMupd
	 * @생성일자 : 2009. 03. 26
	 * @작성자   : 전선경
	 * @변경이력 :
	 * @메소드 설명 : 프로파일 관리 > 저장
	 */
    public GridData directInsertProfileMupd(GridData gdReq, SepoaInfo info) throws Exception
    {
...
/*
				...
				straData[i][1] = gd.getHeader("MENU_NAME").getValue(i);
				straData[i][2] = SepoaString.str2in(gd.getHeader("MENU_OBJECT_CODE").getValue(i), "<");
				straData[i][3] = gd.getHeader("MODULE_TYPE").getValue(i);
 */				
	            		
	            		gdReq.getValue("menu_name",i),
	                	SepoaString.str2in(gdReq.getValue("menu_object_code",i), "$"),
	        ...
	        SepoaOut value = ServiceConnector.doService(info, "AD_022", "TRANSACTION", "directInsertProfileMupd", obj);
    ...
    public GridData updateProfileMupd(GridData gdReq, SepoaInfo info) throws Exception
    {
        ...
        try
        {
	        ...
	        for (int i = 0; i < row_count; i++)
	        {
	            String[] loop_data2 =
	            {
	            	...
	            	gdReq.getValue("module_type",i),
	            	SepoaString.str2in(gdReq.getValue("menu_object_code",i), "$"),
	                gdReq.getValue("menu_profile_code", i)
	            };
	        ...
	        Object[] obj = {bean_args};
	        SepoaOut value = ServiceConnector.doService(info, "AD_022", "TRANSACTION", "updateProfileMupd", obj);
    ...
    public GridData deleteProfileMupd(GridData gdReq, SepoaInfo info) throws Exception
    {
        ...
        try
        {
	        ...
	        Object[] obj = {bean_args};
	        SepoaOut value = ServiceConnector.doService(info, "AD_022", "TRANSACTION", "deleteProfileMupd", obj);
