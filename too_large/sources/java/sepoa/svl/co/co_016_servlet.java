...
public class CO_016_Servlet extends HttpServlet{
...
//    			e.printStackTrace();
	...
	private GridData selectItemList(GridData gdReq, SepoaInfo info) throws Exception{
	    ...
	    try{
	    	...
	    	value    = ServiceConnector.doService(info, "CO_016", "CONNECTION", "selectItemList", obj);
	    	isStatus = value.flag;
