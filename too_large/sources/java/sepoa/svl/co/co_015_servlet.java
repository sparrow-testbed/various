...
public class CO_015_Servlet extends HttpServlet{
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
    	...
    	try {
    		...
    		if("selectItemList".equals(mode)){
    			gdRes = this.selectItemList(gdReq, info);
    		}
    	}
    	catch (Exception e) {
...
//    			e.printStackTrace();
    ...
    private Object[] selectItemListObj(GridData gdReq, SepoaInfo info) throws Exception{
    	Object[]            result         = new Object[1];
    	Map<String, String> header         = this.getHeader(gdReq, info);
    	Map<String, String> resultInfo     = new HashMap<String, String>();
    	Configuration       con            = new Configuration();
    	String              houseCode      = info.getSession("HOUSE_CODE");
    	String              vendorCode     = info.getSession("COMPANY_CODE");
    	String              companyCode    = con.get("sepoa.buyer.company.code");
    	String              itemNo         = header.get("itemNo");
    	String              descriptionLoc = header.get("descriptionLoc");
	...
	private GridData selectItemList(GridData gdReq, SepoaInfo info) throws Exception{
	    GridData      gdRes        = new GridData();
	    ...
	    try{
	    	...
	    	obj      = this.selectItemListObj(gdReq, info);
	    	value    = ServiceConnector.doService(info, "CO_015", "CONNECTION", "selectItemList", obj);
	    	isStatus = value.flag;
