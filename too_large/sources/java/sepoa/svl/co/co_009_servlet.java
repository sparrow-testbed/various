...
public class CO_009_Servlet extends HttpServlet{
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
    	...
    	try {
    		...
    		if("selectDeptList".equals(mode)){
    			gdRes = this.selectDeptList(gdReq, info);
    		}
    	}
    	catch (Exception e) {
...
//    			e.printStackTrace();
    ...
    private Object[] selectDeptListObj(GridData gdReq, SepoaInfo info) throws Exception{
    	...
    	String              deptNameLoc = header.get("deptNameLoc");
    	String              vendor_serch = header.get("vendor_serch");
    	if("Y".equals(vendor_serch)) {
    		companyCode = "WOORI";
    	}
    	...
    	resultInfo.put("DEPT_NAME_LOC", deptNameLoc);
	...
	private GridData selectDeptList(GridData gdReq, SepoaInfo info) throws Exception{
	    GridData      gdRes        = new GridData();
	    ...
	    try{
	    	...
	    	obj      = this.selectDeptListObj(gdReq, info);
	    	value    = ServiceConnector.doService(info, "CO_009", "CONNECTION", "selectDeptList", obj);
	    	isStatus = value.flag;
