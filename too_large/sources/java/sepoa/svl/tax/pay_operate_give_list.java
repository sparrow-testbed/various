...
public class pay_operate_give_list extends HttpServlet
{
public void init(ServletConfig config) throws ServletException {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
        ...
        try {
       		...
       		if (mode.equals("getPayOperateGiveList"))
       		{	
       			gdRes = getPayOperateGiveList(gdReq, info);		//조회
       		}
       		else if (mode.equals("setSpy2Delete"))
       		{	
       			gdRes = setSpy2Delete(gdReq, info);		//조회
       		}
	...
	private GridData getPayOperateGiveList(GridData gdReq, SepoaInfo info) throws Exception
	{
		GridData gdRes   		= new GridData();
		...
		try{
			...
			SepoaOut value = ServiceConnector.doService(info, "TX_013", "CONNECTION","getPayOperateGiveList",obj);
...
//			 e.printStackTrace();
   ...
   @SuppressWarnings({ "rawtypes"})
    private GridData setSpy2Delete(GridData gdReq, SepoaInfo info) throws Exception{
    	GridData gdRes        = new GridData();
    	...
    	try {
        	...
        	Object[] obj = {allData};
    		value    = ServiceConnector.doService(info, "TX_013", "TRANSACTION", "setSpy2Delete", obj);
    		isStatus = value.flag;
