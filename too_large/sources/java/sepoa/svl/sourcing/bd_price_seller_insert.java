...
public class bd_price_seller_insert extends HttpServlet {
    ...
    public GridData setBDAPinsert( GridData gdReq, SepoaInfo info ) throws Exception {
        ...
        try {
            ...
            Object[] obj = { allData };
			SepoaOut value = ServiceConnector.doService(info, "SBD_004", "CONNECTION", "setBDAPinsert", obj);
    ...
    public GridData setBDAPjoin( GridData gdReq, SepoaInfo info ) throws Exception {
    	...
    	try {
    		...
    		Object[] obj = { headerData };
    		SepoaOut value = ServiceConnector.doService(info, "SBD_004", "CONNECTION", "setBDAPjoin", obj);
    ...
    public GridData setBDAPjoin2( GridData gdReq, SepoaInfo info ) throws Exception {
    	...
    	try {
    		...
    		Object[] obj = { headerData };
    		SepoaOut value = ServiceConnector.doService(info, "SBD_004", "CONNECTION", "setBDAPjoin2", obj);
