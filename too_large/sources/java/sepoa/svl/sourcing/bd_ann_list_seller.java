...
public class bd_ann_list_seller extends HttpServlet {
    ...
    public GridData getBdAnnListSeller( GridData gdReq, SepoaInfo info ) throws Exception {
        ...
        try {
			...
			SepoaOut value = ServiceConnector.doService(info, "SBD_001", "CONNECTION", "getBdAnnListSeller", obj);
