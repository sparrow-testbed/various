...
public class cs_bd_pn_list_seller extends HttpServlet {
    ...
    public void doPost( HttpServletRequest req, HttpServletResponse res ) throws IOException, ServletException {
        ...
        try {
			...
			if ("getCsBdPnListSeller".equals(mode)) {
				gdRes = getCsBdPnListSeller(gdReq , info); 
			}
    ...
    public GridData getCsBdPnListSeller( GridData gdReq, SepoaInfo info ) throws Exception {
        ...
        try {
			...
			SepoaOut value = ServiceConnector.doService(info, "SPN_001", "CONNECTION", "getCsBdPnListSeller", obj);
