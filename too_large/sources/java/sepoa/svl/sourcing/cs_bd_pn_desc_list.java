...
public class cs_bd_pn_desc_list extends HttpServlet {
    ...
    public void doPost( HttpServletRequest req, HttpServletResponse res ) throws IOException, ServletException {
        ...
        try {
			...
			if ("getCsBdPnDescList".equals(mode)) {
				gdRes = getCsBdPnDescList(gdReq , info); 
			}
    ...
    public GridData getCsBdPnDescList( GridData gdReq, SepoaInfo info ) throws Exception {
        ...
        try {
			...
			SepoaOut value = ServiceConnector.doService(info, "PN_002", "CONNECTION", "getCsBdPnDescList", obj);
