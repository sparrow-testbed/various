...
public class bd_ann extends HttpServlet {
    ...
    public GridData getPrItemDetail( GridData gdReq, HttpServletRequest req, SepoaInfo info ) throws Exception {
        ...
        try {
			...
			SepoaOut value = ServiceConnector.doService(info, "BD_001", "CONNECTION", "getPrItemDetail", obj);
    ...
    public GridData setAnnCreate( GridData gdReq, SepoaInfo info ) throws Exception {
        ...
        try {
            ...
            Object[] obj = { allData };
			SepoaOut value = ServiceConnector.doService(info, "BD_001", "CONNECTION", "setAnnCreate", obj);
    ...
    public GridData setGonggoModify( GridData gdReq, SepoaInfo info ) throws Exception {
        ...
        try {
            ...
            Object[] obj = { allData };
			SepoaOut value = ServiceConnector.doService(info, "BD_001", "CONNECTION", "setGonggoModify", obj);
    ...
    public GridData setGonggoConfirm( GridData gdReq, SepoaInfo info ) throws Exception {
        ...
        try {
            ...
            Object[] obj = { allData };
			SepoaOut value = ServiceConnector.doService(info, "BD_001", "CONNECTION", "setGonggoConfirm", obj);
    ...
    public GridData setApprovalRequest(GridData gdReq, SepoaInfo info) throws Exception {
        ...
        try
        {
            ...
            Object[] obj = {allData};
            SepoaOut value = ServiceConnector.doService(info, "BD_001", "TRANSACTION", "setApprovalRequest", obj);
    ...
    public GridData setUGonggoCreate( GridData gdReq, SepoaInfo info ) throws Exception {
        ...
        try {
            ...
            Object[] obj = { allData };
			SepoaOut value = ServiceConnector.doService(info, "BD_001", "CONNECTION", "setUGonggoCreate", obj);
    ...
    public GridData setCopy( GridData gdReq, SepoaInfo info ) throws Exception {
    	...
    	try {
    		...
    		Object[] obj = { headerData };
    		SepoaOut value = ServiceConnector.doService(info, "BD_001", "TRANSACTION", "setFileCopy", obj);
