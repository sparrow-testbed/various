...
public class cs_bd_pn_desc_list_seller extends HttpServlet {
    ...
    public void doPost( HttpServletRequest req, HttpServletResponse res ) throws IOException, ServletException {
        ...
        try {
			...
			if ("getCsBdPnDescListSeller".equals(mode)) {
				gdRes = getCsBdPnDescListSeller(gdReq , info); 
			}
    ...
    public GridData getCsBdPnDescListSeller( GridData gdReq, SepoaInfo info ) throws Exception {
        ...
        try {
			...
			SepoaOut value = ServiceConnector.doService(info, "SPN_002", "CONNECTION", "getCsBdPnDescListSeller", obj);
