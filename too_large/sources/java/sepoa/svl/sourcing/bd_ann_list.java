...
public class bd_ann_list extends HttpServlet {
    ...
    public GridData getBdAnnList( GridData gdReq, SepoaInfo info ) throws Exception {
        ...
        try {
			...
			SepoaOut value = ServiceConnector.doService(info, "BD_002", "CONNECTION", "getBdAnnList", obj);
    ...
    public GridData getLocList( GridData gdReq, SepoaInfo info ) throws Exception {
    	...
    	try {
    		...
    		Object[] obj = { headerData };
    		SepoaOut value = ServiceConnector.doService(info, "BD_002", "CONNECTION", "getLocList", obj);
