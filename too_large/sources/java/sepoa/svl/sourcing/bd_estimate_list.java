...
public class bd_estimate_list extends HttpServlet {
    ...
    public void doPost( HttpServletRequest req, HttpServletResponse res ) throws IOException, ServletException {
        ...
        try {
			...
			if ("getBdEstimateList".equals(mode)) {
				gdRes = getBdEstimateList(gdReq , info); 
			} 
    ...
    public GridData getBdEstimateList( GridData gdReq, SepoaInfo info ) throws Exception {
        ...
        try {
            ...
            gdRes.addParam( "mode", "getBdEstimateList" );
             
            Object[] obj = { headerData };
			SepoaOut value = ServiceConnector.doService(info, "BD_008", "CONNECTION", "getBdEstimateList", obj);
