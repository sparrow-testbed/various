...
public class bd_price_list_seller extends HttpServlet {
    ...
    public GridData getBdPriceList( GridData gdReq, SepoaInfo info ) throws Exception {
        ...
        try {
			...
			SepoaOut value = ServiceConnector.doService(info, "SBD_003", "CONNECTION", "getBdPriceList", obj);
    ...
    public GridData getBdJoinList( GridData gdReq, SepoaInfo info ) throws Exception {
    	...
    	try {
    		...
    		Object[] obj = { headerData };
    		SepoaOut value = ServiceConnector.doService(info, "SBD_003", "CONNECTION", "getBdJoinList", obj);
    ...
    public GridData setBidCancel(GridData gdReq, SepoaInfo info) throws Exception {
	    ...
	    try{
	    	...
	    	Object[] obj = {data};
			SepoaOut value = ServiceConnector.doService(info, "SBD_003", "TRANSACTION", "setBidCancel", obj);
			if(value.flag) {
				gdRes.setMessage(message.get("MESSAGE.0001").toString()); 
				gdRes.setStatus("true");
			}else {
