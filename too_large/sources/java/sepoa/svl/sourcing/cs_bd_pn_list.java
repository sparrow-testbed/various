...
public class cs_bd_pn_list extends HttpServlet {
    ...
    public void doPost( HttpServletRequest req, HttpServletResponse res ) throws IOException, ServletException {
        ...
        try {
			...
			if ("getCsBdPnList".equals(mode)) {
				gdRes = getCsBdPnList(gdReq , info); 
			}
    ...
    public GridData getCsBdPnList( GridData gdReq, SepoaInfo info ) throws Exception {
        ...
        try {
			...
			SepoaOut value = ServiceConnector.doService(info, "PN_001", "CONNECTION", "getCsBdPnList", obj);
