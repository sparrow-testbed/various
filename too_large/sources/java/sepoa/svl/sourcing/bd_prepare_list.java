...
public class bd_prepare_list extends HttpServlet {
    ...
    public GridData getBdPrepareList( GridData gdReq, SepoaInfo info ) throws Exception {
        ...
        try {
			...
			SepoaOut value = ServiceConnector.doService(info, "BD_012", "CONNECTION", "getBdPrepareList", obj); //등록요처
