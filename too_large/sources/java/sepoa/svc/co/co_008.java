...
public class CO_008 extends SepoaService {
	private Message msg;

    public CO_008(String opt, SepoaInfo info) throws SepoaServiceException {
        super(opt, info);
	...
	public SepoaOut selectApprovalUserList(Map<String, String> header){
		ConnectionContext ctx = null;
		String            rtn = null;
		...
		try{
			...
			ctx = getConnectionContext();
			rtn = this.select(ctx, "selectApprovalUserList", header);
