...
public class CO_009 extends SepoaService {
	private Message msg;

    public CO_009(String opt, SepoaInfo info) throws SepoaServiceException {
        super(opt, info);
	...
	public SepoaOut selectDeptList(Map<String, String> header){
		...
		try{
			...
			rtn = this.select(ctx, "selectDeptList", header);
