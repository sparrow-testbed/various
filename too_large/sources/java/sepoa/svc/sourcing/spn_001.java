...
public class SPN_001 extends SepoaService {
    ...
    public SPN_001( String opt, SepoaInfo info ) throws SepoaServiceException {
        super( opt, info );
        setVersion( "1.0.0" );
        //20131212 sendakun
        try {
//            msg = new Message( info, "MESSAGE" );
	...
	public SepoaOut getCsBdPnListSeller(Map< String, String > headerData)
	{
        ...
        try {
			...
			sxp = new SepoaXmlParser(this, "getCsBdPnListSeller");
