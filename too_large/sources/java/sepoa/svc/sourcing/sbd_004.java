...
public class SBD_004 extends SepoaService {
    ...
    public SBD_004( String opt, SepoaInfo info ) throws SepoaServiceException {
        super( opt, info );
        setVersion( "1.0.0" );
        //20131212 sendakun
        try {
//            msg = new Message( info, "MESSAGE" );
        	...
        	Logger.sys.println( "SBD_004 : " + e.getMessage() );
        }
    }
	...
	public SepoaOut setBDAPinsert(Map< String, Object > allData)
    {
        ...
        try {
            ...
            String status = et_chkBidEndDate(headerData); // 입찰제출마감시간 체크
	...
	public SepoaOut setBDAPjoin2(Map< String, String > headerData)
	{
		...
		try {
            ...
            String status1 = et_chkOpenDate(headerData); // 개찰시간 체크
    ...
    private int et_setBid(Map< String, String > headerData ) throws Exception 
    {
		...
		SepoaSQLManager ssm = null;
        try {
    		sxp = new SepoaXmlParser(this, "et_setBid"); 
			ssm = new SepoaSQLManager(info.getSession("ID"), this, ctx, sxp); 
            rtn = ssm.doInsert(headerData);  
