...
public class SPN_002 extends SepoaService {
    ...
    public SPN_002( String opt, SepoaInfo info ) throws SepoaServiceException {
        super( opt, info );
        setVersion( "1.0.0" );
        //20131212 sendakun
        try {
//            msg = new Message( info, "MESSAGE" );
        	...
        	Logger.sys.println( "BD_017 : " + e.getMessage() );
        }
    }
	...
	public SepoaOut getCsBdPnDescListSeller(Map< String, String > headerData)
	{
        ...
        try {
			...
			sxp = new SepoaXmlParser(this, "getCsBdPnDescListSeller");
			ssm = new SepoaSQLManager(info.getSession("ID"), this, ctx, sxp);  

            headerData.put( "HOUSE_CODE",	    info.getSession("HOUSE_CODE") );  
            headerData.put( "OPEN_DATE_START",	MapUtils.getString( headerData,"pn_yy", "" ) + MapUtils.getString( headerData,"pn_ud", "" ).substring(0,2) + "00");  
            headerData.put( "OPEN_DATE_END",	MapUtils.getString( headerData,"pn_yy", "" ) + MapUtils.getString( headerData,"pn_ud", "" ).substring(2,4) + "99");          
