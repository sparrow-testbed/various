...
public class PN_002 extends SepoaService {
    ...
    public PN_002( String opt, SepoaInfo info ) throws SepoaServiceException {
        super( opt, info );
        setVersion( "1.0.0" );
        //20131212 sendakun
        try {
//            msg = new Message( info, "MESSAGE" );
	...
	public SepoaOut getCsBdPnDescList(Map< String, String > headerData)
	{
        ...
        try {
			...
			sxp = new SepoaXmlParser(this, "getCsBdPnDescList");
