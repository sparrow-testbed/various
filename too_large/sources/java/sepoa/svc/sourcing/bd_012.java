...
public class BD_012 extends SepoaService {
    ...
    public BD_012( String opt, SepoaInfo info ) throws SepoaServiceException {
        super( opt, info );
        setVersion( "1.0.0" );
        //20131212 sendakun
        try {
//            msg = new Message( info, "MESSAGE" );
        	...
        	Logger.sys.println( "BD_012 : " + e.getMessage() );
        }
    }
    ...
    public SepoaOut setPrepare( Map< String, Object > allData ) throws Exception {
        ...
        try {
            ...
            if("B".equals(headerData.get("PROM_CRIT"))){
              ...
              //2015-03-06 향후 AS-IS 사이트 Close 후 하단의 주석 요망!!! 
              ...
              //////////////////////////////////////////////////////
                ...
                //2015-03-06 향후 AS-IS 사이트 Close 후 하단의 주석 제거후 사용 
    		...
    		if(STATUS_FLAG.equals("T") || STATUS_FLAG.equals("TET")) {
        		...
        		sbMsg.append(ucline);						
        		sbMsg.append(ucline);
        		sbMsg.append("내정가격 등록되었습니다.");	
        		UcMessage.DirectSendMessage(info.getSession("ID"), MapUtils.getString( headerData, "ADD_USER_ID"), sbMsg.toString());
        		//////////////////////////////////////////////////////////////////////////////////////////   
