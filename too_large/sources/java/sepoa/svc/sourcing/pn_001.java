...
public class PN_001 extends SepoaService {
    ...
    public PN_001( String opt, SepoaInfo info ) throws SepoaServiceException {
        super( opt, info );
        setVersion( "1.0.0" );
        //20131212 sendakun
        try {
//            msg = new Message( info, "MESSAGE" );
	...
	public SepoaOut getCsBdPnList(Map< String, String > headerData)
	{
        ...
        try {
			...
			sxp = new SepoaXmlParser(this, "getCsBdPnList");
			ssm = new SepoaSQLManager(info.getSession("ID"), this, ctx, sxp);  

            headerData.put( "HOUSE_CODE",	    info.getSession("HOUSE_CODE") );  
            headerData.put( "OPEN_DATE_START",	MapUtils.getString( headerData,"bd_yy", "" ) + MapUtils.getString( headerData,"hy_ds", "" ).substring(0,2) + "00");  
            headerData.put( "OPEN_DATE_END",	MapUtils.getString( headerData,"bd_yy", "" ) + MapUtils.getString( headerData,"hy_ds", "" ).substring(2,4) + "99");          
