...
public class SR_014 extends SepoaService {

    public SR_014(String opt, SepoaInfo info) throws SepoaServiceException {
		super(opt, info);
		setVersion("1.0.0");
	...
	public SepoaOut getTempDetail(String c_template_refitem) {
		setStatus(1);
		setFlag(true);
		...
		try {
			...
			no.put("c_template_refitem", c_template_refitem);
	...
	public SepoaOut setTempInsert(Map<String, Object> data) throws Exception{
		...
		Message msg = null;
		double currVal = getCurrVal("icomvcth", "c_template_refitem");
		int rtn=0;
		setMessage("성공");
		try {
			msg = new Message(info, "SR_014");
			...
			header.put("c_template_refitem", String.valueOf(currVal));
			...
			for(int i=0; i<row_cnt; i++){
				...
				customheader.put("c_template_refitem", header.get("c_template_refitem"));
				
				customheader.put("c_factor_refitem",  ts.nextToken());
	...
	public SepoaOut setTempUpdate(Map<String, Object> data) throws Exception{
	 ...
	 public double getCurrVal(String tableName, String columnName){
		...
		public SepoaOut chkUpdateChkTemp(String s_template_refitem) {
			setStatus(1);
			setFlag(true);
			ConnectionContext ctx = getConnectionContext();
			...
			try {
				...
				HashMap<String, String> no = new HashMap<String, String>();
				no.put("s_template_refitem", s_template_refitem);
