...
public class SR_013 extends SepoaService {

    public SR_013(String opt, SepoaInfo info) throws SepoaServiceException {
		super(opt, info);
		setVersion("1.0.0");
	...
	public SepoaOut getTempList(Map<String, Object> data) {
		setStatus(1);
		setFlag(true);
		...
		try {
			...
			sxp = new SepoaXmlParser(this, "getTempList");
