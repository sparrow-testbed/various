...
public class SR_033 extends SepoaService{
	...
	String QUA_FACTOR_NO_19 = "19";			//재거래 의사
  	...
  	public SR_033( String opt, SepoaInfo sinfo ) throws SepoaServiceException{
      	super( opt, sinfo );
      	setVersion( "1.0.0" );
  	}
...
public SepoaOut getEvalProperty(String eval_refitem){
	...
	public SepoaOut getEvaList(Map<String, Object> data) 
  	{
		...
		try 
		{
			rtn = getEvaList( evalname, vendor_code );
			setValue(rtn);
			setStatus(1);			
		} catch(Exception e) {
			Logger.err.println("Exception e =" + e.getMessage());
	...
	private String getEvaList(String evalname, String vendor_code) throws Exception 
	{
    	String house_code 	= info.getSession("HOUSE_CODE");
    	String user_id 		= info.getSession("ID");
   		String rtn = null;
