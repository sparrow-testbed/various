...
public class SR_027 extends SepoaService{
	...
	String QUA_FACTOR_NO_19 = "19";			//재거래 의사
  	...
  	public SR_027( String opt, SepoaInfo sinfo ) throws SepoaServiceException{
      	super( opt, sinfo );
      	setVersion( "1.0.0" );
  	}
...
public SepoaOut getEvalProperty(String eval_refitem){
	...
	private String getEvaList(String evalname) throws Exception 
	{
    	String house_code 	= info.getSession("HOUSE_CODE");
    	String user_id 		= info.getSession("ID");
   		String rtn = null;
 ...
 */
	...
	public SepoaOut getEvaVendorList(Map<String, String> header) 
	{
		String rtn = null;
		...
		try 
		{
			...
			rtn = et_getEvaVendorList( header);
			setValue(rtn);
			setStatus(1);
	...
	private String et_getEvaVendorList(Map<String, String >header) throws Exception 
	{
   		String rtn = null;
		String house_code = info.getSession("HOUSE_CODE");
