...
public class SR_026 extends SepoaService{
	...
	String QUA_FACTOR_NO_19 = "19";			//재거래 의사
  	...
  	public SR_026( String opt, SepoaInfo sinfo ) throws SepoaServiceException{
      	super( opt, sinfo );
      	setVersion( "1.0.0" );
  	}
...
public SepoaOut getEvalProperty(String eval_refitem){
	...
	public SepoaOut getEvaList(Map<String, Object> data) 
  	{
		...
		String eval_name = header.get("eval_name");

		try 
		{
			rtn = getEvaList( vendor_code, eval_name );
	...
	private String getEvaList(String vendor_code, String eval_name ) throws Exception 
	{
    	String house_code 	= info.getSession("HOUSE_CODE");
    	String user_id 		= info.getSession("ID");
   		String rtn = null;
		...
		header.put("eval_name", eval_name);
