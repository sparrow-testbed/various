...
public class SR_031 extends SepoaService{
	...
	String QUA_FACTOR_NO_19 = "19";			//재거래 의사
  	...
  	public SR_031( String opt, SepoaInfo sinfo ) throws SepoaServiceException{
      	super( opt, sinfo );
      	setVersion( "1.0.0" );
  	}
...
//						}
		...
		public SepoaOut getEvaList(Map<String, Object> data) 
		{
			...
			String eval_item_refitem = (String) data.get("eval_item_refitem");

			try 
			{
				rtn = getEvaList( user_id, eval_item_refitem );
				setValue(rtn);
				setStatus(1);
		...
		private String getEvaList( String user_id, String eval_item_refitem ) throws Exception 
		{
	   		String rtn = null;
			String house_code = info.getSession("HOUSE_CODE");
			...
			header.put("eval_item_refitem", eval_item_refitem);
