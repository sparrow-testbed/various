...
function NextSave()
{
	...
	f.method = "POST";
 	f.target = G_TARGET;
	f.action = "ven_wk_ins2_j_ict_window10.jsp?SOLE_PROPRIETOR_FLAG="+f.SOLE_PROPRIETOR_FLAG.value+"&VENDOR_TYPE="+f.VENDOR_TYPE.value;
...
function Saved(result, status)
{
	if(status == "1")
	{
		...
		if(G_MODE == "irs_no"){
			parent.up.MM_showHideLayers('m1','','show','m2','','hide','m3','','hide','m4','','hide','m5','','hide','m6','','hide','m11','','hide','m22','','show','m33','','hide','m44','','hide','m55','','hide','m66','','hide');
			parent.up.goPage('gl');
		}else{
			parent.up.MM_showHideLayers('m1','','show','m2','','hide','m3','','hide','m4','','hide','m5','','hide','m6','','hide','m11','','hide','m22','','show','m33','','hide','m44','','hide','m55','','hide','m66','','hide')
			parent.up.goPage('gl');
