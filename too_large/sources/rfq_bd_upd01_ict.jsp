...
<%
    ...
    String act_name	      = ("Y".equals(flag))?"견적서 (제출)":"견적포기";
    String display        = ("Y".equals(flag))?"":"style='display:none;'";
...
function doSave(flag) {
	...
	if(flag == "Y"){		
		if(document.getElementById("mdl_id").value == ""){
			alert("모델번호를 입력하세요.");
			document.getElementById("mdl_id").focus();
			return;
		}
		
		if(document.getElementById("mdl_nm").value == ""){
			alert("모델명을 입력하세요.");
			document.getElementById("mdl_nm").focus();
			return;
		}

		if(document.getElementById("attach_no").value == ""){
			alert("견적서를 첨부하세요.");
			return;
		}
	}
	...
	<% if(!"".equals(QTA_NO)){ %>
	var servletUrl = "<%=POASRM_CONTEXT_NAME%>/servlets/ict.supply.bidding.rfq.rfq_bd_upd1";
	<% }else{ %>
	var servletUrl = "<%=POASRM_CONTEXT_NAME%>/servlets/ict.supply.bidding.rfq.rfq_bd_ins1";
	<% } %>
	
	var grid_array = getGridChangedRows(GridObj, "SELECTED");
	var params     = getApprovalSendParam(flag);
...
function getApprovalSendParam(flag){
	...
	inputParam = inputParam + "&I_MFCO_CODE=" + document.getElementById("sel_mfco_code").value;
	...
	<% if(!"".equals(QTA_NO)){ %>
	params = (flag == "Y") ? "mode=setRfqSubmit2" : "mode=setRfqGiveUp2";
	<% }else{ %>
	params = (flag == "Y") ? "mode=setRfqSubmit" : "mode=setRfqGiveUp";
	<% } %>
...
function JavaCall(msg1, msg2, msg3, msg4, msg5) {
	...
	if(msg1 == "t_imagetext") {
		...
		//opener.doSelect();
		//window.close();
		location.href= "/ict/s_kr/bidding/rfq/rfq_bd_lis02_ict.jsp";
	}
...
<table width="100%" border="0" cellspacing="0" cellpadding="1"  <%=display%>>
<tr>
<td>
		   ...
		   <tr>
			...
			<tr>
				<td width="15%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;
					 모델번호<font style="color: red;">*</font>
				</td>
				<td width="35%" class="data_td">
					<input type="text" name="mdl_id" id="mdl_id" style="width:95%;" value="<%=MDL_ID%>" onKeyUp="return chkMaxByte(100, this, '모델번호');">					
				</td>
				<td width="15%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;
					 모델명<font style="color: red;">*</font>
				</td>
				<td width="35%" class="data_td">
					<input type="text" name="mdl_nm" id="mdl_nm" style="width:95%;" value="<%=MDL_NM%>" onKeyUp="return chkMaxByte(100, this, '모델명');">
				</td>
			</tr>
			<tr>
				<td colspan="4" height="1" bgcolor="#dedede"></td>
			...
			<tr>
				<td width="15%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;
					첨부파일<font style="color: red;">*</font>
				</td>
				<td class="data_td">
					<table><tr></tr><td>
				...
				<td width="15%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;
					제조사<font style="color: red;">*</font>
				</td>
				<td width="35%" class="data_td">
					<select name="sel_mfco_code" id="sel_mfco_code" class="inputsubmit">
			        	<option value=''>선택</option>
<%
	String  lb_item_no2 = ListBox(request, "SL0156",info.getSession("HOUSE_CODE") + "#" + "M681_ICT" + "#" + ITEM_NO, MFCO_CODE);
	out.println(lb_item_no2);
%>			                    	
			        </select>
				</td>
			</tr>
		...
		<tr>		 
			<td height="30" align="right">
				<TABLE cellpadding="0">
					<TR>				
						<TD>
							<script language="javascript">btn("javascript:doSave('<%=flag%>')","<%=act_name%>")</script>
						</TD>
					</TR>
				</TABLE>
			</td>
