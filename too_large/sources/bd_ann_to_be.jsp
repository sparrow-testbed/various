...
--%>
		...
		if (eval(X_DOC_SUBMIT_DATE) < eval(current_date)) {
			...
			document.forms[0].X_DOC_SUBMIT_DATE.focus();
			return false;
		} else if (eval(X_DOC_SUBMIT_TIME_HOUR_MINUTE) == eval(current_date)) {
...
<!-- 							</a> -->
					...
					<tr>
						<td  width="20%" height="15px">
							<span class="cell_data_middle">나. 공고번호</span>
						</td>
						<td width="80%">
	...
	<% if(BID_TYPE.equals("D")) { %>
			<table  width="98%" border="0" cellspacing="1" cellpadding="0" style="border-collapse: collapse">
				<tr>
					<td  width="20%" class="cell_title_wrb">2. 입찰에 부치는 사항</td>
					<td  width="80%">
						<table width="100%" border="1" cellspacing="1" cellpadding="0" style="border-collapse: collapse">
							<tr>
								<td  width="20%">
									<span class="cell_data_middle">가. 입찰건명</span>
								</td>
								<td width="80%">
									<input type="text" id="ANN_ITEM" name="ANN_ITEM" size="70" value="<%=ANN_ITEM.replaceAll("\"", "&quot;")%>" class="input_re_2" <%=script%> style="ime-mode:active">
								</td>
							</tr>
							<tr>
								<td width="20%">
									<span class="cell_data_middle">나. 구매수량</span>
								</td>
								<td width="80%">
									<input type="text" id="X_PURCHASE_QTY" name="X_PURCHASE_QTY" size="70" value="<%=X_PURCHASE_QTY%>" class="input_re_2" <%=script%>>
								</td>
							</tr>
							<tr>
								<td width="20%">
									<span class="cell_data_middle">다. 제조사양</span>
								</td>
								<td width="80%">
									<input type="text" id="X_MAKE_SPEC" name="X_MAKE_SPEC" size="70" value="<%=X_MAKE_SPEC%>" class="input_re_2" <%=script%>>
								</td>
							</tr>
							<tr>
								<td width="20%">
									<span class="cell_data_middle">라. 유의사항</span>
								</td>
								<td width="80%">
									<textarea id="X_BASIC_ADD" name="X_BASIC_ADD" cols="70" rows="3" maxlength="500" class="input_re_2" <%=script%> style="ime-mode:active"><%=X_BASIC_ADD%></textarea>
								</td>
							</tr>
							<tr style="display: none;">
								<td width="20%">
									<span class="cell_data_middle">마. 예정가격</span>
								</td>
								<td width="80%">
									<SPAN CLASS=".general_padding_left">공개여부</SPAN> <input type="checkbox" id="X_ESTM_CHECK" name="X_ESTM_CHECK" <% if (X_ESTM_CHECK.equals("Y")) {%>checked<%}%><%=script%>>
								</td>
							</tr>							
						</table>
					</td>
				...
				<tr>
					...
					<td  width="80%">
						<table width="100%" border="1" cellspacing="1" cellpadding="0" style="border-collapse: collapse">
							...
							<tr>
								<td width="20%">
									<span class="cell_data_middle">나. 예정가격</span>
								</td>
								<td width="80%">
									<SPAN CLASS=".general_padding_left">공개여부</SPAN> <input type="checkbox" id="X_ESTM_CHECK" name="X_ESTM_CHECK" <% if (X_ESTM_CHECK.equals("Y")) {%>checked<%}%><%=script%>>
								</td>
							...
							<tr>
								<td width="20%">
									<span class="cell_data_middle">다. 담당기술역</span>
								</td>
								<td width="80%">
									<input type="text"  id="X_PERSON_IN_CHARGE" name="X_PERSON_IN_CHARGE" value="<%=X_PERSON_IN_CHARGE%>" size="70" class="input_re_2" <%=script%>>
								</td>
							</tr>							
						</table>
					</td>
	...
	<table width="98%" border="0" cellspacing="1" cellpadding="0" style="border-collapse: collapse">
		<tr>
			<td  width="20%" class="cell_title_wrb">3. 입찰참가자격</td>
			<td width="80%">
				<table width="100%" border="1" cellspacing="1" cellpadding="0" style="border-collapse: collapse">
					<tr>
						<%
						if(BID_TYPE.equals("D")) {
							...
							<tr>
								<td width="20%">
									<span class="cell_data_middle">참가자격</span>
								</td>
								<td width="80%">
									<textarea id="LIMIT_CRIT" name="LIMIT_CRIT" cols="70" rows="3" maxlength="500" class="input_re_2" <%=script%>><%=LIMIT_CRIT%></textarea>
								</td>
							</tr>
							<%
						} else {
							...
							<tr>
								<td width="20%">
									<span class="cell_data_middle">가. 참가자격</span>
								</td>
								<td width="80%">
									<select id="LIMIT_CRIT" name="LIMIT_CRIT" class="input_re_2" <%=script%>>
										<%
							...
							<tr>
								<td width="20%">
									<span class="cell_data_middle">나. 기타</span>
								</td>
								<td width="80%">
									<textarea id="X_QUALIFICATION" name="X_QUALIFICATION" cols="70" rows="3" maxlength="500" class="input_re_2" <%=script%>><%=X_QUALIFICATION%></textarea>
								</td>
							</tr>									
							<%
						}
	...
	<table  width="98%" border="0" cellspacing="1" cellpadding="0" style="border-collapse: collapse">
		<tr>
		  <td  width="20%" class="cell_title_wrb">4. 제출서류 목록 및<br> 제출기일</td>
		  <td  width="80%">
		  		<table  width="100%" border="1" cellspacing="1" cellpadding="0" style="border-collapse: collapse">
		  			<tr>
		  				<td width="20%">
		  					<span class="cell_data_middle">가. 제출기한</span>
		  				</td>
		  				<td width="80%">
								<s:calendar id="X_DOC_SUBMIT_DATE" default_value="<%=SepoaString.getDateSlashFormat(X_DOC_SUBMIT_DATE) %>"  format="%Y/%m/%d"/>일
								<input type="text" id="X_DOC_SUBMIT_TIME_HOUR_MINUTE" name="X_DOC_SUBMIT_TIME_HOUR_MINUTE" size="4"  value="<%=X_DOC_SUBMIT_TIME_HOUR_MINUTE%>" maxlength="4"  class="input_re" <%=script%> >		  				
...
<%-- 							<input type="text" id="X_DOC_SUBMIT_TIME_HOUR_MINUTE"  name="X_DOC_SUBMIT_TIME_HOUR_MINUTE"  value="<%=X_DOC_SUBMIT_TIME_HOUR_MINUTE%>" size="4"    maxlength="4"  class="input_re_2" <%=script%>> 까지 --%>
					...
					<tr>
		  				<td  width="20%">
		  					<span class="cell_data_middle">나. 제출방법</span>
		  				</td>
		  				<td width="80%">
							<input type="text" id="CONT_PLACE" name="CONT_PLACE" size="70" class="input_re_2" value="<%=CONT_PLACE%>" <%=script%>>
						</td>
					</tr>
					<tr>
		  				<td  width="20%">
		  					<span class="cell_data_middle">다. 제출서류</span>
		  				</td>
		  				<td width="80%">
							<textarea id="BID_JOIN_TEXT" name="BID_JOIN_TEXT" cols="70" rows="7" maxlength="500" class="input_re_2" <%=script%>><%=BID_JOIN_TEXT%></textarea>
						</td>
					</tr>
					<tr>
		  				<td  width="20%">
		  				...
		  				<td width="80%">
							<textarea id="BID_CANCEL_TEXT" name="BID_CANCEL_TEXT" cols="70" rows="3" maxlength="500" class="input_re_2" <%=script%>><%=BID_CANCEL_TEXT%></textarea>
						</td>
					</tr>
				</table>
		  </td>
		...
		<tr>
		  ...
		  <td  width="80%">
		  		<table width="100%" border="1" cellspacing="1" cellpadding="0" style="border-collapse: collapse">
		  			<tr>
		  				<td width="20%">
		  					<span class="cell_data_middle">가. 입찰방법</span>
		  				</td>
		  				<td width="60%">
					...
					<tr id="q1">
		  				<td id="q2" width="20%">
		  					<span id="scoreTitle" class="cell_data_middle">나. 점수비율</span>
		  				</td>						
					...
					<tr id="i11">
						<td class="cell_title_tta" width="15%" id="i12"> <span id="i1">다. 평가서제출일시</span></td>
						<td class="cell_data_tta" width="35%" colspan="3"    id="i13">
							<span id="i5">
							
							<s:calendar id="APP_BEGIN_DATE" default_value="<%=SepoaString.getDateSlashFormat(APP_BEGIN_DATE) %>"  format="%Y/%m/%d"/>일
...
<%-- 							<input type="text" name="APP_END_TIME_HOUR_MINUTE"   value="<%=APP_END_TIME_HOUR_MINUTE%>" size="4" maxlength="4"  class="input_re" <%=script%>  id=i10> --%>
					...
					<tr id="bidTitle">
		  				<td width="20%">
		  					<span class="cell_data_middle">나. 입찰일시</span>
		  				</td>
		  				<td width="80%" colspan="2">
		  				<span id="g5">
							<s:calendar id="BID_BEGIN_DATE" default_value="<%=SepoaString.getDateSlashFormat(BID_BEGIN_DATE) %>"  format="%Y/%m/%d"/>일
							...
							&nbsp;&nbsp;~&nbsp;&nbsp;
							<s:calendar id="BID_END_DATE" default_value="<%=SepoaString.getDateSlashFormat(BID_END_DATE) %>"  format="%Y/%m/%d"/>일 
							<input type="text" name="BID_END_TIME_HOUR_MINUTE" id="BID_END_TIME_HOUR_MINUTE" value="<%=BID_END_TIME_HOUR_MINUTE%>" size="4" maxlength="4" class="input_re" <%=script_c%> onBlur="" style="ime-mode: disabled" onKeyPress="checkNumberFormat('[0-9]');"
						</span>
		  				</td>
					</tr>
					<tr id="openTitle">
		  				<td width="20%">
		  					<span class="cell_data_middle">다. 개찰일시</span>
		  				</td>
		  				<td width="80%" colspan="2">
		  				<span id="g18">
							<s:calendar id="OPEN_DATE" default_value="<%=SepoaString.getDateSlashFormat(OPEN_DATE) %>"  format="%Y/%m/%d"/>일
							<input type="text" name="OPEN_TIME_HOUR_MINUTE" id="OPEN_TIME_HOUR_MINUTE" value="<%=OPEN_TIME_HOUR_MINUTE%>" size="4" maxlength="4" class="input_re" <%=script_c%> style="ime-mode: disabled" onKeyPress="checkNumberFormat('[0-9]');">이후
						</span>
		  				</td>
					</tr>
					<tr>
		  				<td width="20%">
		  					<span class="cell_data_middle">라. 낙찰방법</span>
		  				</td>
		  				<td width="80%" colspan="2">						
							<div>
					...
					<tr>
		  				<td width="20%">
		  					<span class="cell_data_middle">마. 유의사항</span>
		  				</td>
		  				<td width="80%" colspan="2">						
							<textarea id="X_RELATIVE_ADD" name="X_RELATIVE_ADD" cols="70" rows="3" maxlength="500" class="input_re_2" <%=script%>><%=X_RELATIVE_ADD.replaceAll("\"", "&quot;")%></textarea>
						</td>
					</tr>
				</table>
		  </td>
	...
	<table width="98%" border="0" cellspacing="1" cellpadding="0" style="border-collapse: collapse">
		<tr>
			  <td  width="20%" class="cell_title_wrb">6. 입찰이행보증금(서)</td>
			  	<td width="80%">
		  			<table width="100%" border="1" cellspacing="1" cellpadding="0" style="border-collapse: collapse">
		  				<tr>
		  				<td width="20%">
		  					<span class="cell_data_middle"> 내용</span>
		  				</td>
		  				<td width="80%">
		  					<%=pre01%>
			  			</td>
	...
	<table width="98%" border="0" cellspacing="1" cellpadding="0" style="border-collapse: collapse">
		<tr>
			  <td  width="20%" class="cell_title_wrb">7. 차액보증금</td>
			  	<td width="80%">
		  			<table width="100%" border="1" cellspacing="1" cellpadding="0" style="border-collapse: collapse">
		  				<tr>
		  				<td width="20%">
	...
	<table width="98%" border="0" cellspacing="1" cellpadding="0" style="border-collapse: collapse">
		<tr>
			  <td  width="20%" class="cell_title_wrb">8. 계약이행보증금</td>
			  	<td width="80%">
		  			<table width="100%" border="1" cellspacing="1" cellpadding="0" style="border-collapse: collapse">
		  				<tr>
		  				<td width="20%">
	...
	<% if (BID_TYPE.equals("D")) {%>
			<table width="98%" border="0" cellspacing="1" cellpadding="0" style="border-collapse: collapse">
				<tr>
					  <td  width="20%" class="cell_title_wrb">9. 계약관련사항</td>
					  	<td width="80%">
				  			<table width="100%" border="1" cellspacing="1" cellpadding="0" style="border-collapse: collapse">
				  				<tr>
				  				<td width="20%">
				  					<span class="cell_data_middle">가. 납품완료일자(납품기간)</span>  			
				  				</td>
				  				<td width="80%">
				  					<s:calendar id="RD_DATE" default_value="<%=SepoaString.getDateSlashFormat(RD_DATE) %>"  format="%Y/%m/%d"  />
<%-- 									<span class="general_padding_left"> --%>
<%-- 										<input type="text" id="RD_DATE" name="RD_DATE" size="70"   maxlength="100"  class="input_re"   value="<%=RD_DATE%>"  <%=script%>> --%>
<%-- 									</span> --%>
<%-- 									<a href="javascript:Calendar_Open('RD_DATE');" ><span class="image_padding_left"><img src="../../images/button/butt_calender.gif" width="19"   height="19" align="absmiddle" border="0" ></span></a> --%>
							...
							<tr>
				  				<td width="20%">
				  					<span class="cell_data_middle">나. 납품장소</span>
				  				</td>
				  				<td width="80%">
									<input type="text" id="DELY_PLACE" name="DELY_PLACE" size="70" value="<%=DELY_PLACE.replaceAll("\"", "&quot;")%>" class="input_re_2" <%=script%>>
								</td>
							</tr>
							<tr>
				  				<td width="20%">
				  					<span class="cell_data_middle">다. 구매수량</span>
				  				</td>
				  				<td width="80%">
							...
							<tr>
				  				<td width="20%">
				  					<span class="cell_data_middle">라. 대금결제조건</span>
				  				</td>
				  				<td width="80%">
									<% for (int i = 0 ; i < aRadioValues.length ; i++) { %>
										<input type="radio" id="COST_SETTLE_TERMS" name="COST_SETTLE_TERMS" value="<%=i%>" <%if ( COST_SETTLE_TERMS.equals(aRadioValues[i]) ) {%>checked<%}%> onclick="javascript:fnCostSettleTerms(<%=i%>);"><%=aRadioTitles[i]%>
										<br>
									<%}%>
								</td>
							</tr>
							...
							<tr>
				  				<td width="20%">
				  					<span class="cell_data_middle">마. 지체상금</span>
				  				</td>
				  				<td width="80%"><%=pre04%>
								</td>
							</tr>
			...
			<table width="98%" border="0" cellspacing="1" cellpadding="0" style="border-collapse: collapse">
				<tr>
					    <td  width="20%" class="cell_title_wrb">10. 기타사항</td>
					  	<td width="80%">
				  			<table width="100%" border="1" cellspacing="1" cellpadding="0" style="border-collapse: collapse">
				  				<tr>
				  				<td width="20%">
				  					<span class="cell_data_middle">가. 내용</span>
				  				</td>
				  				<td width="80%">
					  				<textarea id="BID_ETC" name="BID_ETC" cols="70" rows="3" maxlength="500" class="input_re_2" <%=script%>><%=BID_ETC%></textarea>
					  			</td>
							    </tr>
							    <tr>
				  				<td width="20%">
				  					<span class="cell_data_middle">나. 품목구분</span>
				  				</td>
				  				<td width="80%">
							    ...
							    <tr>
				  				<td width="20%">
				  					<span class="cell_data_middle">다. 파일첨부</span>
				  				</td>
				  				<td width="80%">
									<TABLE>
										<TR>
...
<script language="javascript">
	btn("javascript:attach_file(document.forms[0].attach_no.value,'BD');document.forms[0].attach_seq.value=1","파일첨부")
							    ...
							    <tr style="display:none;">
							    <td width="20%">
							  		<span class="cell_data_middle">다. 개찰구분</span>
							  	</td>
							  	<td width="80%">
				  ...
				  <td  width="20%" class="cell_title_wrb">9. 계약관련사항</td>
				  	<td width="80%">
			  			<table width="100%" border="1" cellspacing="1" cellpadding="0" style="border-collapse: collapse">
			  				<tr>
			  				<td width="20%">
			  					<span class="cell_data_middle"> 대금지급방법</span>
			  				</td>
			  				<td width="80%">
			  					<input type="text" id="COST_SETTLE_TERMS_C" name="COST_SETTLE_TERMS_C" size="70" value="<%=COST_SETTLE_TERMS.replaceAll("\"", "&quot;")%>" class="input_re_2" <%=script%>>
				  			</td>
						</tr>
					</table>
			  </td>
			...
			<tr>
				...
				<td width="80%">
					<table width="100%" border="1" cellspacing="1" cellpadding="0" style="border-collapse: collapse">
						...
						<tr>
						  	<td width="20%">
						  		<span class="cell_data_middle">다. 첨부파일</span>
						  	</td>						
			  				<td width="80%">
								<TABLE>
									<TR>
...
<%-- 	<% --%>
<!-- // 	// 최초 공고문 작성시, 수정시... 결재라인 표시 -->
<!-- // 	if(  (!SCR_FLAG.equals("I")) &&  (APPV_STATUS.equals("C") || APPV_STATUS.equals("D") || APPV_STATUS.equals("") )  ) -->
<!-- // 	{ -->
<%-- 			%> --%>
<!-- 			<table width="98%" border="0" cellspacing="1" cellpadding="0" style="border-collapse: collapse"> -->
<!-- 				<tr> -->
<!-- 					<td width="20%" class="cell_title_wrb">【 결재사항 】</td> -->
<!-- 					<td width="80%"> -->
<!-- 						<table width="100%" border="1" cellspacing="1" cellpadding="0" style="border-collapse: collapse"> -->
<!-- 							<tr> -->
<!-- 								<td width="20%"> -->
<%-- 									<span class="cell_data_middle">결재자(팀장) 선택</span> --%>
<!-- 								</td> -->
<!-- 								<td width="80%">&nbsp; -->
<%-- 									<select id="selAuth" name="selAuth" class="inputsubmit"> --%>
<!-- 										<option value = "">---------</option> -->
<%-- 										<% --%>
<!-- // 										for (int i = 0; i < 99 ; i++) -->
<!-- // 										{ -->
...
<!-- 			<table width="98%" border="0" cellspacing="1" cellpadding="0" style="border-collapse: collapse"> -->
<!-- 				<tr> -->
<!-- 					<td width="20%" class="cell_title_wrb">【 반려시 의견 】</td> -->
<!-- 					<td width="80%"> -->
<!-- 						<table width="100%" border="1" cellspacing="1" cellpadding="0" style="border-collapse: collapse"> -->
<!-- 							<tr> -->
<!-- 								<td width="20%"> -->
<%-- 									<span class="cell_data_middle">반려시 의견입력</span> --%>
<!-- 								</td> -->
<!-- 								<td width="80%">&nbsp; -->
<!-- 									<textarea id="txtReject" name="txtReject" class="inputsubmit" rows="3" cols="70"></textarea> -->
<!-- 								</td> -->
<!-- 							</tr> -->
<!-- 						</table> -->
<!-- 					</td> -->
...
<%-- 			<script language="Javascript"> --%>
<!-- // 				alert("반려의견이 있습니다. 확인 바랍니다."); -->
<%-- 			</script> --%>
<!-- 			<table width="98%" border="0" cellspacing="1" cellpadding="0" style="border-collapse: collapse"> -->
<!-- 				<tr> -->
<!-- 					<td width="20%" class="cell_title_wrb">【 반려 의견 】</td> -->
<!-- 					<td width="80%"> -->
<!-- 						<table width="100%" border="1" cellspacing="1" cellpadding="0" style="border-collapse: collapse"> -->
<!-- 							<tr> -->
<!-- 								<td width="20%"> -->
<%-- 									<span class="cell_data_middle">반려의견</span> --%>
<!-- 								</td> -->
<!-- 								<td width="80%">&nbsp; -->
...
<!-- 				  		<table> -->
<!-- 				  			<tr>  -->
<%-- 				  				<td><script language="javascript">btn("javascript:doExplanation()",7,"설명회")</script><td> --%>
<%-- 								<td><input type="text" id="szdate" name="szdate" size="8" value="<%=ANNOUNCE_DATE%>" style='border-style: none 0px; border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px' readonly ></td> --%>
<%-- 								<% --%>
<!-- // 								if(SCR_FLAG.equals("I") || SCR_FLAG.equals("U")) { -->
<%-- 									%> --%>
<%-- 									<td height="30"><script language="javascript">btn("javascript:attach_file()",7,"화일첨부")</script></td> --%>
<%-- 									<% --%>
<!-- // 								} else if(SCR_FLAG.equals("C")) { -->
<%-- 									%> --%>
<%-- 									<td><script language="javascript">btn(";",7,"화일첨부")</script></td> --%>
<%-- 									<% --%>
<!-- // 								} -->
<%-- 								%> --%>
...
<!-- // 								if (SCR_FLAG.equals("I") || SCR_FLAG.equals("U")) { -->
<%-- 									%> --%>
<%-- 					  				<td><script language="javascript">btn("javascript:Approval('T')",1,"저 장")</script></td> --%>
<%-- 									<% --%>
<!-- // 								} -->
<%-- 								%> --%>
...
<%-- 									%> --%>
<%-- 					  				<td><script language="javascript">btn("javascript:Approval('A')",1,"결재올림")</script></td> --%>
<%-- 									<% --%>
<!-- // 								} -->
<%-- 								%> --%>

<%-- 								<%if (    (SCR_FLAG.equals("C")) && ( (NEXT_AUTH_ID.equals(info.getSession("ID")) ) )      ) {%> --%>
<%-- 					  				<td><script language="javascript">btn("javascript:Approval('D')",7,"반려")</script></td> --%>
<%-- 					  				<td><script language="javascript">btn("javascript:Approval('C')",7,"확정(결재)")</script></td> --%>
<%-- 								<%}%> --%>

<%-- 	   							<td><script language="javascript">btn("javascript:history.back(-1)",7,"취 소")</script></td> --%>

<%-- 								<% --%>
<!-- // 								if(SCR_FLAG.equals("I") || SCR_FLAG.equals("U")) { -->
<%-- 									%> --%>
<%-- 						 			<td><script language="javascript">btn("javascript:LineDelete()",3,"행삭제")</script></td> --%>
<%-- 									<% --%>
<!-- // 								} -->
<%-- 								%> --%>
<!-- 							</tr> -->
...
<!-- 						<table> -->
<!-- 							<tr> -->
<%-- 								<td><script language="javascript">btn("javascript:setCopy()","copy")</script><td> --%>
<!-- 							</tr> -->
<!-- 						</table> -->
<!-- 						</div> -->
<!-- 					</td> -->
...
-->
											<input 
												...
												size="8" 
												value="<%=ANNOUNCE_DATE%>"
												style='border-style: none 0px; border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px'
												readonly
											>
										</td>
<%
