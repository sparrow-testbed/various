...
<%
	...
	multilang_id.addElement("MA_011_2");
	multilang_id.addElement("BUTTON");
	multilang_id.addElement("MESSAGE");
	
	HashMap text = MessageUtil.getMessage(info,multilang_id);
	
	String screen_id = "MA_011_2";
...
<!-- PROCESS ID 선언 -->
<% String WISEHUB_PROCESS_ID="MA_011_2";%>
<!-- 사용 언어 설정 -->
...
function setHeader() {
	...
	GridObj2.SetColCellRadio("Check", true);

	INDEX_image               = GridObj2.GetColHDIndex("image");
	INDEX_image1              = GridObj2.GetColHDIndex("image1");
...
<s:grid screen_id="MA_011_2" grid_obj="GridObj" grid_box="gridbox"/>
<s:footer/>
</body>
</html>
