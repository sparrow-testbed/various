...
<%
	javax.servlet.ServletRequest pluginfreeRequest = new PluginFreeRequest(request);
 	String user_id = JSPUtil.nullToEmpty(JSPUtil.CheckInjection3(request.getParameter("user_id")));	
...
//	args[1]  = JSPUtil.nullToEmpty(KeyboardSecurity.getTouchEnKey(request, "password"));	
	...
	args2[0] = JSPUtil.nullToEmpty(JSPUtil.CheckInjection3(request.getParameter("user_id")));                                        
