...
<%
	...
	multilang_id.addElement("MA_011_4");
	multilang_id.addElement("BUTTON");
	multilang_id.addElement("MESSAGE");
	
	HashMap text = MessageUtil.getMessage(info,multilang_id);
	
	String screen_id = "MA_011_4";
...
<!-- PROCESS ID 선언 -->
<% String WISEHUB_PROCESS_ID="MA_011_4";%>
<!-- 사용 언어 설정 -->
...
function setHeader() {
	...
	GridObj4.SetColCellRadio("check", true);
	
	INDEX_SEL                    = GridObj4.GetColHDIndex("check") ;
	/* WiseGrid4 세팅 종료 */
...
<s:grid screen_id="MA_011_4" grid_obj="GridObj" grid_box="gridbox"/>
<s:footer/>
</body>
</html>
