...
<%
	...
	multilang_id.addElement("I_DS_001");
	multilang_id.addElement("MESSAGE");
	HashMap text = MessageUtil.getMessage(info, multilang_id);

	//HTML에 쓰일 변수들
	String TITLE = String.valueOf(text.get("I_DS_001.MSG_0104"));// "Q&A 작성";
...
function Create(){
	...
	if (LRTrim(F.SUBJECT.value) == ""){
		alert("<%=text.get("I_DS_001.MSG_0100")%>");
	...
	if (LRTrim(F.CONTENT.value) == ""){
		alert("<%=text.get("I_DS_001.MSG_5000")%>");
 	...
 	F.method = "POST";
    F.target = "childFrame";
    F.action = "write_new_data_store_ict.jsp?con_type="+con_type;
    F.submit();
}
...
function Cancel()
{
    if(!confirm("<%=text.get("I_DS_001.MSG_0101")%>"))//취소 하시겠습니까?
    	return;
	var con_type = "<%=con_type%>";
	go_list('/admin/bulletin_list_new_ict.jsp', 'MUO15070800002', 12, '');
		...
		<TABLE cellpadding="0" cellspacing="0" border="0" width="100%">
         ...
         <table width="100%" border="0" cellspacing="0" cellpadding="1">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
		        	<td width="15%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;<%=text.get("I_DS_001.MSG_0102")%></td>
		            <td class="data_td">
			    ...
			    <tr >
		        <td width="15%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;<%=text.get("I_DS_001.MSG_8801")%></td>
		           <td class="data_td">
			    ...
			    <tr>
		        	<td width="15%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;<%=text.get("I_DS_001.MSG_0106")%></td>
		            <td class="data_td">
			    ...
			    <tr>
		        	<td width="15%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;<%=text.get("I_DS_001.gongji_gubun")%></td>
		            <td class="data_td">
                ...
                <tr>
		        	<td width="15%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;<%=text.get("I_DS_001.MSG_0103")%></td>
		            <td class="data_td">
						 <TABLE >
		      			<TR>
		      				<td>
