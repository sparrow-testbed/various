...
<%
	...
	Object[] obj = {args};
	SepoaOut value = ServiceConnector.doService(info, "I_MT_014", "CONNECTION","setInsertNotice_New", obj);
%>
...
(function Init()
{
	...
	alert("<%=value.message%>");
	parent.go_list('/admin/bulletin_list_new_ict.jsp', 'MUO15070800003', 9, '');
