...
<%
	...
	/* logout 처리 */
	Object[] obj = {info};
	SepoaOut wo = ServiceConnector.doService(info, "CO_004", "TRANSACTION","setScssReqProcess_ICT", obj);
	...
	if ("ICT".equals(info.getSession("FROM_SITE")) ){
		aaserver_name += "/ict/sourcing/bd_ann_list_seller_ict.jsp";
	}
