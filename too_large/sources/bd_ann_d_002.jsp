...
<%
	...
	String ANNOUNCE_BEGIN_DATE				= "";
	String ANNOUNCE_END_DATE				= "";
	String APP_BEGIN_TIME_HOUR         		= "";
	String APP_END_TIME_HOUR         		= "";
	String OPEN_TIME_HOUR         			= "";
	String OPEN_TIME_MINUTE        			= "";
	String APP_BEGIN_TIME_MINUTE        	= "";
	String APP_END_TIME_MINUTE     		   	= "";
	String X_DOC_SUBMIT_TIME_HOUR     	   	= "";
	String X_DOC_SUBMIT_TIME_MINUTE        	= "";
	String CHANGE_DATE       			 	= "";
	String X_ESTM_AMT       			 	= "";
		...
		if(!"".equals(BID_NO)){
		    ...
		    if(wf.getRowCount() > 0) {
				...
				if (!(origin_bid_status).equals("IAR")) { // 입찰공고 작성을 하려는 경우외에는 기존에 data를 조회해 온다.
					...
					APP_BEGIN_TIME_HOUR         	= wf.getValue("APP_BEGIN_TIME_HOUR"     , 0);					
					APP_END_TIME_HOUR         		= wf.getValue("APP_END_TIME_HOUR"       , 0);					
					OPEN_TIME_HOUR  	       		= wf.getValue("OPEN_TIME_HOUR"          , 0);					
					OPEN_TIME_MINUTE        		= wf.getValue("OPEN_TIME_MINUTE"        , 0);					
					APP_BEGIN_TIME_MINUTE        	= wf.getValue("APP_BEGIN_TIME_MINUTE"   , 0);					
					APP_END_TIME_MINUTE       	 	= wf.getValue("APP_END_TIME_MINUTE"     , 0);					
					X_DOC_SUBMIT_TIME_HOUR       	= wf.getValue("X_DOC_SUBMIT_TIME_HOUR"  , 0);
					X_DOC_SUBMIT_TIME_MINUTE		= wf.getValue("X_DOC_SUBMIT_TIME_MINUTE", 0);
					CHANGE_DATE						= wf.getValue("CHANGE_DATE"				, 0);
					X_ESTM_AMT						= wf.getValue("X_ESTM_AMT"				, 0);
	...
	String disp_BID_BEGIN_DATE = "";
	String disp_BID_END_DATE = "";
	String disp_BID_OPEN_DATE = "";
	
	if(CONT_TYPE2.equals("LP") || CONT_TYPE2.equals("RA") || CONT_TYPE2.equals("RL"))
	{
        disp_BID_OPEN_DATE = OPEN_DATE.substring(0, 4) + "년 " + OPEN_DATE.substring(4, 6) + "월 " + OPEN_DATE.substring(6, 8) + "일 " + OPEN_TIME_HOUR + "시 " + OPEN_TIME_MINUTE + "분";
    }


    String disp_APP_BEGIN_DATE = APP_BEGIN_DATE.substring(0, 4) + "년 " + APP_BEGIN_DATE.substring(4, 6) + "월 " + APP_BEGIN_DATE.substring(6, 8) + "일 " + APP_BEGIN_TIME_HOUR + "시 " + APP_BEGIN_TIME_MINUTE + "분";
    String disp_APP_END_DATE = APP_END_DATE.substring(0, 4) + "년 " + APP_END_DATE.substring(4, 6) + "월 " + APP_END_DATE.substring(6, 8) + "일 " + APP_END_TIME_HOUR + "시 " + APP_END_TIME_MINUTE + "분";
    String disp_X_DOC_SUBMIT_DATE = "";
	if ( !(X_DOC_SUBMIT_DATE.equals("")) )
	{
		disp_X_DOC_SUBMIT_DATE = X_DOC_SUBMIT_DATE.substring(0, 4) + "년 " + X_DOC_SUBMIT_DATE.substring(4, 6) + "월 " + X_DOC_SUBMIT_DATE.substring(6, 8) + "일 " + X_DOC_SUBMIT_TIME_HOUR + "시 " + X_DOC_SUBMIT_TIME_MINUTE + "분";
	}


    CONT_TYPE_TEXT 		= CONT_TYPE1_TEXT_D + " (" + CONT_TYPE2_TEXT_D + ")";
    String disp_current_date 	= CHANGE_DATE.substring(0, 4) + "년 " + CHANGE_DATE.substring(4, 6) + "월 " + CHANGE_DATE.substring(6, 8) + "일";
    String disp_ann_date 		= ANN_DATE.substring(0, 4) + "년 " + ANN_DATE.substring(4, 6) + "월 " + ANN_DATE.substring(6, 8) + "일";		// 공고일자(2008-06-05 추가요청)
	
	if (!(ANNOUNCE_PLACE.equals("") || ANNOUNCE_PLACE == null))
	{
		ANNOUNCE_BEGIN_DATE = ANNOUNCE_DATE.substring(0, 4) + "년 " + ANNOUNCE_DATE.substring(4, 6) + "월 " + ANNOUNCE_DATE.substring(6, 8) + "일 " + ANNOUNCE_TIME_FROM.substring(0, 2) + "시 " + ANNOUNCE_TIME_FROM.substring(2, 4) + "분";
		ANNOUNCE_END_DATE = ANNOUNCE_DATE.substring(0, 4) + "년 " + ANNOUNCE_DATE.substring(4, 6) + "월 " + ANNOUNCE_DATE.substring(6, 8) + "일 " + ANNOUNCE_TIME_TO.substring(0, 2) + "시 " + ANNOUNCE_TIME_TO.substring(2, 4) + "분";
	};
...
function fnHtmlDown(){
	...
	//출력물에는 보여주지 않을 요소 제거하기 전에 저장
	var not_print_01 = $("#not_print_td_01").html();
	var not_print_02 = $("#not_print_td_02").html();
	var not_print_03 = $("#not_print_td_03").html();
	var not_print_04 = $("#not_print_td_04").html();
...
//  Some.document.write(document.documentElement.outerHTML) ;
 	...
 	//출력물에는 보여주지 않을 요소를 다시 복구
 	$("#not_print_td_01").html(not_print_01);
 	$("#not_print_td_02").html(not_print_02);
 	$("#not_print_td_03").html(not_print_03);
 	$("#not_print_td_04").html(not_print_04);
// 	$("#btn_td").html(tmp);
							...
							<tr>
								...
								<td  width="80%">
									<table width="100%" border="0" cellspacing="1" cellpadding="0" style="border-collapse: collapse">
										...
										<%-- (WGW)예정가격을 구하는 메소드가 DB에 없어 조회쿼리를 알 수 없어서 일단 안보이게 처리함 --%>
										<tr style="display:none">
											<td width="20%" class="title_td">
												<span>(2) 예정가격</span>
											</td>
											<td width="80%" class="data_td">
												<SPAN CLASS=".general_padding_left"><% if (X_ESTM_CHECK.equals("Y")) {%><%=X_ESTM_AMT%> 원<%} else {%>비공개<%}%></SPAN>
											</td>
										</tr>
										...
										<tr>
							  				...
							  				<% if (!(ANNOUNCE_PLACE.equals("") || ANNOUNCE_PLACE == null)) { %>
												1. 일시: <%=ANNOUNCE_BEGIN_DATE%> ~ <%=ANNOUNCE_END_DATE%><br>
												2. 장소: <%=ANNOUNCE_PLACE%>
											<% } else { %>
												없음.
											<%}%>
							  					...
							  					<table>
							  						<tr>
														...
														<td width="40%" class="data_td" id="comp_td" style="display: none;">
							  							...
							  							<td id="CONT_TYPE_TD"><%=CONT_TYPE1_TEXT_D%>(<%=CONT_TYPE2_TEXT_D%>)</td> 
<%-- 							  							<td id="CONT_TYPE_TD"><%=CONT_TYPE1_TEXT_D%>&nbsp;/&nbsp;<%=CONT_TYPE2_TEXT_D%>&nbsp;/&nbsp;<%=PROM_CRIT_NAME %></td>  --%>
										...
										<tr>
		  									...
		  									<td width="80%" colspan="2" class="data_td">						
												<div>
													가. <%=CONT_TYPE2_TEXT_D%><br>
													나. 입찰금액이 우리은행 내정가격 초과시 유찰로 간주하고 재입찰을 실시할 수 있다.<br>
													다. 낙찰이 될 수 있는 동일가격으로 입찰한 자가 2인 이상일 때에는 즉시 추첨에 의하여 낙찰자를 결정한다.
													<b><font color="red">&nbsp;&nbsp;&nbsp;(단, 전자입찰인 경우 전산시스템에 의해 자동으로 낙찰자가 결정됨)</font></b>
												</div>
											</td>
										</tr>
										<tr>
			  					...
			  					<td width="80%">
		  							<table width="100%" border="0" cellspacing="1" cellpadding="0" style="border-collapse: collapse">
		  								<tr>
		  									...
		  									<td width="80%" class="data_td">
		  										(1)입찰금액의 100분의 5이상 금액을 현금(체신관서 또는 은행법의 적용을 받는 금융기관이 발행한 자기앞수표를 포함한다) <br>
						&nbsp;&nbsp;&nbsp;또는 다음 각 호의 보증서 등으로 우리은행에 납부하여야 한다. <br>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;가. 금융기관이 발행한 지급보증서 <br>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;나. 증권업법시행령 제 84조의 16호에 규정된 유가증권 <br>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;다. 보험업법에 의한 보험사업자가 발행한 보증보험증권 <br>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;라. 금융기관 및 외국금융기관과 체신관서가 발행한 정기예금증서<br>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;마. 건설공제조합법에 의한 건설공제조합, 전문건설공제조합법에 의한<br>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;전문건설공제조합·업종별공제조합, 신용보증기금법에 의한 신용보증<br>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;기금, 신기술사업금융지원에관한 법률에 의한 기술신용보증기금,<br>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;전기통신공사업에 의한 전기통신공제조합, 엔지니어링기술진흥법에<br>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;의한 엔진니어링공제조합 또는 공업발전법에 의한 공제사업단체,<br>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;소프트웨어개발촉진법에 의하여 정보통신부장관이 공고한 공제사업<br>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;기관, 전력기술관리법에 의한 한국전력기술인협회 또는 환경친화적<br>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;산업구조로의 전환촉진에 관한법률에 의하여 환경설비에 대하여<br>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;한국기계공업진흥회가 발행한 채무액 등의 지급을 보증하는 보증서<br>
						(2) 입찰등록마감시한까지 입찰보증금을 납부한 업체만 본 입찰에 참여 가능함.<br>
						(3) 입찰이행보증서 보증기간은 입찰일 이전부터 입찰일 30일 이후일 것.<br>
						(4) 보증내용<br>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;① 피보험자: (주)우리은행<br>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;② 입찰일자: <%=disp_APP_BEGIN_DATE%>&nbsp;~&nbsp;<%=disp_APP_END_DATE%><br>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;③ 입찰건명: <%=ANN_ITEM.replaceAll("\"", "&quot;")%><br>
						(5) 입찰보증금 귀속: 낙찰자가 소정기일 내에 계약을 체결하지 아니할 경우 입찰보증금은 당행에 귀속됩니다.
			  								</td>
										</tr>
									</table>
		  						</td>
			  					...
			  					<td width="80%">
		  							<table width="100%" border="0" cellspacing="1" cellpadding="0" style="border-collapse: collapse">
		  								<tr>
		  									...
		  									<td width="80%" class="data_td">
낙찰자는 다음 각호의 경우에 해당하는 경우 현금 또는 보증서 등으로 차액보증금을 납부하여야 함.<br>
(1) 입찰결과 당행 내정가격의 100분의 85미만으로 낙찰된 경우<br>
&nbsp;&nbsp;&nbsp;&nbsp;① 현금으로 납부하고자 하는 경우에는 내정가격과 낙찰금액의 차액<br>
&nbsp;&nbsp;&nbsp;&nbsp;② 보증서 등으로 납부하고자 하는 경우에는 내정가격과 낙찰금액의 <br>
차액에 상당하는 금액<br>
(2) 입찰결과 당행 내정가격의 100분의 70미만으로 낙찰된 경우<br>
&nbsp;&nbsp;&nbsp;&nbsp;① 내정가격과 낙찰금액의 차액을 현금 또는 차액의 2배에 해당하는 보증서 등으로 납부하여야 함.<br>
			  								</td>
										</tr>
									</table>
		  						</td>
				...
				<tr>
					<td width="100%">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
			  					...
			  					<td width="80%">
		  							<table width="100%" border="0" cellspacing="1" cellpadding="0" style="border-collapse: collapse">
		  								<tr>
		  									...
		  									<td width="80%" class="data_td">
							 가. 입찰결과 낙찰자는 계약체결시 계약금액의 100 분의 10 이상 금액을 현금 (체신관서 또는 은행법의 적용을 받는 금융기관이 발행하는 자기앞 수표를 포함한다) 또는 다음 각호의 보증서등으로 우리은행에 납부하여야 한다.&nbsp;(단, 공사계약에 있어서 연대 보증인이 없는 경우 100분의 20)<br>
							&nbsp;&nbsp;&nbsp;1) 금융기관이 발행한 지급보증서<br>			
							&nbsp;&nbsp;&nbsp;2) 증권업법시행령 제84조의 16호에 규정된 유가증권<br>			
							&nbsp;&nbsp;&nbsp;3) 보험업법에 의한 보험사업자가 발행한 보증보험증권<br>			
							&nbsp;&nbsp;&nbsp;4) 금융기관 및 외국금융기관과 체신관서가 발행한 정기예금증서<br>
							&nbsp;&nbsp;&nbsp;5) 건설공제조합법에 의한 건설공제조합, 전문건설공제조합법에 의한 <br>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;전문건설공제조합·업종별공제조합, 신용보증기금법에 의한 신용보증<br>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;기금, 신기술사업금융지원에관한 법률에 의한 기술신용보증기금,<br>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;전기통신공사업에 의한 전기통신공제조합, 엔지니어링기술진흥법에<br>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;의한 엔진니어링공제조합 또는 공업발전법에 의한 공제사업단체,<br>
							...
							나. 계약상대자가 계약상의 의무를 이행하지 아니할 경우 계약이행 보증금은 당행에 귀속됨<br>
							다. 계약이행기간은 계약기간에 60일 이상을 가산한 기간이어야 함
			  								</td>
										</tr>
									</table>
		  						</td>
				  				...
				  				<td width="80%">
			  						<table width="100%" border="0" cellspacing="1" cellpadding="0" style="border-collapse: collapse">
										...
										<tr>
			  								...
			  								<td width="80%" class="data_td">
												<span class="general_padding_left"><%=X_PURCHASE_QTY%></span>
											</td>
										</tr>
										<tr>
			  								<td width="20%" class="title_td">
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#dedede">
				<tr>
					<td width="100%">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td  width="20%" class="title_td">9. 기타사항</td>
								<td width="80%">
									<table width="100%" border="0" cellspacing="1" cellpadding="0" style="border-collapse: collapse">
										<tr>
											<td width="20%" class="title_td">
...
<table width="300px" cellpadding="0" cellspacing="0" border="0" align="center">
	<tr>
		<td width="150px" id="not_print_td_03" align="right">
			<span style="font-size:15px">공사관련 첨부화일 : </span>
		</td>						
		<td width="100px" id="not_print_td_04">
			<TABLE width="90px" cellpadding="0" cellspacing="0" border="0">
				<TR>
					<td align="center">
						<input type="button" id="btnAttachFrm" name="btnAttachFrm" onClick="fnFiledown('<%=ATTACH_NO%>')" value="화일첨부" style="width:60px; height:20px; text-align:center; border-width:thin;">
<%-- 					<iframe id="attachFrm" name="attachFrm" src="/sepoafw/filelob/file_attach_downloadView.jsp?attach_key=<%=ATTACH_NO%>&view_type=VI" style="width: 98%;height: 15px; border: 0px;" frameborder="0" ></iframe> --%>
					</td>
					<td align="left">
						<div id="attach_no_text"></div>
						<input type="hidden" name="attach_no" id="attach_no" value="<%=ATTACH_NO%>">
						<input type="text" name="attach_cnt" id="attach_cnt" class="input_empty" style="width:10px" value="<%=ATTACH_CNT%>">
					</td>
				</TR>
			</TABLE>
		</td>
...
<table width="200px" cellpadding="0" cellspacing="0" border="0" align="center">
	...
	<tr>
		<td width="200px" align="center">
			<span style="font-size:11px"><%=disp_ann_date%></span>
		</td>
	</tr>
	<tr>
		<td>
	...
	<tr>
		<td width="200px" align="center">
			<span style="font-size:17px">주식회사 우리은행</span>
		</td>
	</tr>
	<tr>
		<td>
	...
	<tr>
		<td width="200px" align="center">
			<span style="font-size:17px">총무부</span>
		</td>
	</tr>
</table>
...
<div width="100%" height="250" id="supiFlameDiv" name="supiFlameDiv">
	<iframe src="<%=POASRM_CONTEXT_NAME%>/sourcing/rfq_req_sellersel_botton_vi.jsp" name="supiFlame" id="supiFlame" width="0%" height="0" border="0" scrolling="no" frameborder="0"></iframe>
...
<div id="pagingArea"  style="display:none"></div>
