...
<%
	...
	multilang_id.addElement("I_RQ_448");
	multilang_id.addElement("BUTTON");
	multilang_id.addElement("MESSAGE");
	
	HashMap text = MessageUtil.getMessage(info,multilang_id);
	
	String screen_id = "I_RQ_448";
	...
	String WISEHUB_PROCESS_ID="I_RQ_448";
    ...
    String item_no        = JSPUtil.nullToRef(request.getParameter("sel_item_no"),"");
    String mfco_code      = "";
...
function doSelect(){
	...
	if(LRTrim(form1.start_mem.value) != "" || LRTrim(form1.end_mem.value) != "" ) {
		if(LRTrim(form1.start_mem.value) == "") {
			alert("MEM 입력하셔야 합니다.");
			form1.start_mem.select();	
			return;
		}
		if(LRTrim(form1.end_mem.value) == "") {
			alert("MEM 입력하셔야 합니다.");
			form1.end_mem.select();	
			return;
		}
		if(!IsNumber(form1.start_mem.value)){
			alert("MEM 숫자만 입력 가능합니다.");
			form1.start_mem.select();
			return;
		}
		if(!IsNumber(form1.end_mem.value)){
			alert("MEM 숫자만 입력 가능합니다.");
			form1.end_mem.select();
			return;
		}
	...
	if(LRTrim(form1.start_usable_cpt_cn.value) != "" || LRTrim(form1.end_usable_cpt_cn.value) != "" ) {
		if(LRTrim(form1.start_usable_cpt_cn.value) == "") {
			alert("Usable 용량을 입력하셔야 합니다.");
			form1.start_usable_cpt_cn.select();	
			return;
		}
		if(LRTrim(form1.end_usable_cpt_cn.value) == "") {
			alert("Usable 용량을 입력하셔야 합니다.");
			form1.end_usable_cpt_cn.select();	
			return;
		}
		if(!IsNumber(form1.start_usable_cpt_cn.value)){
			alert("Usable 용량은 숫자만 입력 가능합니다.");
			form1.start_usable_cpt_cn.select();
			return;
		}
		if(!IsNumber(form1.end_usable_cpt_cn.value)){
			alert("Usable 용량은 숫자만 입력 가능합니다.");
			form1.end_usable_cpt_cn.select();
			return;
		}
	...
	var param = "mode=getRfqList4&grid_col_id="+grid_col_id;
	    param += dataOutput();
	var url = "<%=POASRM_CONTEXT_NAME%>/servlets/ict.dt.rfq.rfq_bd_lis4";
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td width="15%" class="title_td">
											&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;견적업체
										</td>
										<td width="35%" class="data_td">
											<input type="text"  onkeydown='entKeyDown()'  name="settle_vendor_code" id="settle_vendor_code" size="15" class="input_data2" maxlength="10" readonly>
											...
											<input type="text"  onkeydown='entKeyDown()'  name="settle_vendor" id="settle_vendor" size="20" class="input_data2" readonly>
										</td>																
									</tr>
									<tr>
...
%>
										...
										<td class="data_td">
											<select name="sel_mfco_code" id="sel_mfco_code" class="inputsubmit">
			                    	<option value="">전체</option>
<%
	String  lb_mfco_code = ListBox(request, "SL0019",info.getSession("HOUSE_CODE") + "#" + "M681_ICT" + "#" + "0", mfco_code);
	out.println(lb_mfco_code);
%>			                    	
			                                 </select>
										</td>										
									</tr>
									...
									<tr>
									    <td width="15%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;운영구분</td>
										<td width="35%" class="data_td">
											<select name="sel_op_dis" id="sel_op_dis" class="inputsubmit">
									<option value="">전체</option>
<%
	String  lb_op_dis = ListBox(request, "SL0018",info.getSession("HOUSE_CODE") + "#" + "M663_ICT", op_dis);
	out.println(lb_op_dis);
%>
					                        </select>
										</td>			
										<td width="15%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;Disk타입</td>
										<td width="35%" class="data_td">
											<select name="sel_disk_type" id="sel_disk_type" class="inputsubmit">
									<option value="">전체</option>
<%
	String  lb_disk_type = ListBox(request, "SL0018",info.getSession("HOUSE_CODE") + "#" + "M674_ICT", disk_type);
	out.println(lb_disk_type);
%>
					                        </select>
										</td>																
									</tr>
									...
									<tr>
									    <td width="15%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;CPU/Core</td>
										<td width="35%" class="data_td">
											<input type="text" id="cpu" name="cpu" style="width:95%;ime-mode:inactive;" class="inputsubmit" maxlength="20"  onkeydown='entKeyDown()' >
										</td>
										<td width="15%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;MEM(GB)</td>
										<td class="data_td">
											<input type="text" id="start_mem" name="start_mem" style="width:25%" class="inputsubmit" maxlength="20"  onkeydown='entKeyDown()'>
											~
											<input type="text" id="end_mem" name="end_mem" style="width:25%" class="inputsubmit" maxlength="20"  onkeydown='entKeyDown()'>
										</td>										
									</tr>
									<tr>
										<td colspan="4" height="1" bgcolor="#dedede"></td>
									...
									<tr>
									    <td width="15%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;Usable 용량</td>
										<td class="data_td" colspan="3">
											<input type="text" id="start_usable_cpt_cn" name="start_usable_cpt_cn" style="width:10%" class="inputsubmit" maxlength="20"  onkeydown='entKeyDown()'>
											~
											<input type="text" id="end_usable_cpt_cn" name="end_usable_cpt_cn" style="width:10%" class="inputsubmit" maxlength="20"  onkeydown='entKeyDown()'>
										</td>										
									</tr>
									<tr>
										<td colspan="4" height="1" bgcolor="#dedede"></td>
...
<%-- <s:grid screen_id="I_RQ_448" grid_obj="GridObj" grid_box="gridbox"/> --%>
