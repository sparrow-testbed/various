...
function Init()
{
	...
	document.forms[0].irs_no2.value     = G_IRS_NO;
	...
	if(flag=="update" || "<%=status%>"=="T" || "<%=vendor_code%>" != "") {
		...
		*/
		...
		//alert(G_MODE);
		if(G_MODE == "irs_no"){
			document.forms[0].ENTRY_TEL.value = G_IRS_NO;
			/*
			document.forms[0].ENTRY_TEL.disabled  = true;
			document.forms[0].ENTRY_TEL.style.backgroundColor = "DCDCDC";
			*/
			/*
...
function NextSave()
{
	...
	f.method = "POST";
 	f.target = G_TARGET;
	f.action = "ven_wk_ins2_j_ict.jsp?SOLE_PROPRIETOR_FLAG="+f.SOLE_PROPRIETOR_FLAG.value+"&VENDOR_TYPE="+f.VENDOR_TYPE.value;
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<% if(!ctrl_code.equals("P99")){ %>
								<tr>
									...
									<td class="title_td">
										&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;가입번호
									</td>
									<td class="data_td" >
										<input type="text" 		id="irs_no2" name="irs_no2" value="<%=IRS_NO%>" size="11" maxlength="20" class="input_data2" readOnly>			
									</td>										
								</tr>
								<tr>
									...
									<tr>
										...
										<td class="data_td">
											<table cellpadding="0">
												<tr>
													<td> 
														<input type="text" id="USER_ID" name="USER_ID" size="20" maxlength="10" value="" style="ime-mode: disabled;" class="input_re" onKeyUp="return chkMaxByte(10, this, '사용자ID');"  data-enc="on">
													</td>
								...
								<tr>
									...
									<td class="data_td">
										<input type="text" id="INDUSTRY_TYPE" name="INDUSTRY_TYPE" value="" size="33" class="input_re" onKeyUp="return chkMaxByte(100, this, '업종');" maxlength="100">
