...
<%
	...
	multilang_id.addElement("I_CO_008");
	multilang_id.addElement("BUTTON");
	multilang_id.addElement("MESSAGE");
	
	HashMap text = MessageUtil.getMessage(info,multilang_id);
	
	String  screen_id      = "I_CO_008";
	...
	String	style       = (readOnly != null && "readOnly".equals(readOnly))?"input_data4":"inputsubmit";
...
function fnSelect(){
    ...
    params += dataOutput();
    GridObj.post("<%=POASRM_CONTEXT_NAME%>/servlets/ict.sepoa.svl.co.I_CO_008_Servlet", params );
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td class="data_td" width="30%">
											<input type="text" id="deptCd" name="deptCd" size="15" class="<%=style%>" value='<%=info.getSession("DEPARTMENT")%>' style="ime-mode:inactive" onkeydown="javascript:entKeyDown();"  <%=readOnly%>>
										</td>
										<td width="20%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;부서명</td>
										<td class="data_td" width="30%">
											<input type="text" name="deptNm" id="deptNm" size="20" maxlength="500" class="<%=style%>" value='<%=info.getSession("DEPARTMENT_NAME_LOC")%>' onkeydown="javascript:entKeyDown();"  <%=readOnly%>>
										</td>
									</tr>	
									<tr>
...
<s:grid screen_id="I_CO_008" grid_obj="GridObj" grid_box="gridbox"/>
<s:footer/>
</body>
</html>