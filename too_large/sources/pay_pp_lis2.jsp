...
function doInsert(){
	...
	var jumJumCdIndex = GridObj.getColIndexById("JUMJUMCD");
	var pmkPmkCdIndex = GridObj.getColIndexById("PMKPMKCD");
	...
	var DOSUNQNO = GD_GetCellValueIndex(GridObj, iCheckedRow, dosUnqNoIndex);
	var JUMJUMCD = GD_GetCellValueIndex(GridObj, iCheckedRow, jumJumCdIndex);
	var PMKPMKCD = GD_GetCellValueIndex(GridObj, iCheckedRow, pmkPmkCdIndex);
		
	DOSUNQNO_VAL = DOSUNQNO;
			
	parent.opener.eps0024Insert("row", "DOSUNQNO", DOSUNQNO_VAL);
	parent.window.close();
}
</script>
</head>
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td width="35%" class="data_td" >
											<input type="text"    name="jumjumnm" id="jumjumnm" value="<%=jumjumNm%>">
										...
										<td width="35%" class="data_td" >
											<input type="text"    name="pmkpmknm" id="pmkpmknm" value="<%=pmkpmkNm%>">
