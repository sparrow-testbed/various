...
<%
	...
	multilang_id.addElement("SPN_002");
	multilang_id.addElement("BUTTON");
	multilang_id.addElement("MESSAGE");
	
	HashMap text = MessageUtil.getMessage(info,multilang_id);
	
	String screen_id = "SPN_002";
	String grid_obj  = "GridObj";
	boolean isSelectScreen = false;

	String WISEHUB_PROCESS_ID="SPN_002";
...
function doQuery() {
	G_SERVLETURL   = "<%=POASRM_CONTEXT_NAME%>/servlets/sepoa.svl.sourcing.cs_bd_pn_desc_list_seller";
			
	var grid_col_id = "<%=grid_col_id%>";
	var params = "mode=getCsBdPnDescListSeller";
...
<s:grid screen_id="SPN_002" grid_obj="GridObj" grid_box="gridbox"/>
<s:footer/>
</body>
</html>