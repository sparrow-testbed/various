...
<%
	...
	multilang_id.addElement("I_BD_007");
	multilang_id.addElement("BUTTON");
	multilang_id.addElement("MESSAGE");
	
	HashMap text = MessageUtil.getMessage(info,multilang_id);
	
	String screen_id = "I_BD_007";
...
var G_SERVLETURL   = "<%=POASRM_CONTEXT_NAME%>/servlets/ict.sepoa.svl.sourcing.bd_confirm_popup_ict";
...
<%  
	...
	thisWindowPopupScreenName = "입찰서류동의서확인";
%>
...
<tr>
	<td height="30" align="right">
		...
		<TR>
			...
			<TD><script language="javascript">btn("javascript:doBidStatus('RC');", "확 인")</script></TD>
...
<%-- <s:grid screen_id="I_BD_007" grid_obj="GridObj" grid_box="gridbox"/> --%>
