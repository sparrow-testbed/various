...
<%
	...
	multilang_id.addElement("DS_001");
	multilang_id.addElement("MESSAGE");
	HashMap text = MessageUtil.getMessage(info, multilang_id);

	//HTML에 쓰일 변수들
	String TITLE = String.valueOf(text.get("DS_001.MSG_0104"));// "Q&A 작성";
...
function Create(){
	...
	if (LRTrim(F.SUBJECT.value) == ""){
		alert("<%=text.get("DS_001.MSG_0100")%>");
	...
	if (LRTrim(F.CONTENT.value) == ""){
		alert("<%=text.get("DS_001.MSG_5000")%>");
 	...
 	F.method = "POST";
    F.target = "childFrame";
    F.action = "write_new_data_store.jsp?con_type="+con_type;
    F.submit();
    
    <%--
	var jqa = new jQueryAjax();
	jqa.action = "bulletin_write_wk_new.jsp";
...
function Cancel()
{
    if(!confirm("<%=text.get("DS_001.MSG_0101")%>"))//취소 하시겠습니까?
    	return;
	var con_type = "<%=con_type%>";
	go_list('/admin/bulletin_list_new.jsp', 'MUO140100005', 7, '');
//     location.href = "bulletin_write_new.jsp?con_type="+con_type;
  ...
  <tr>
    <td width="100%" valign="top">
		<TABLE cellpadding="0" cellspacing="0" border="0" width="100%">
         ...
         <table width="100%" border="0" cellspacing="0" cellpadding="1">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
		        	<td width="15%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;<%=text.get("DS_001.MSG_0102")%></td>
		            <td class="data_td">
			        <input type="text" name="SUBJECT" id="SUBJECT" class="inputsubmit" style="width:98%">
			      </td>
			    </tr>
			    <tr>
			    ...
			    <tr >
		        <td width="15%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;<%=text.get("DS_001.MSG_8801")%></td>
		           <td class="data_td">
			    ...
			    <tr>
		        	<td width="15%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;<%=text.get("DS_001.MSG_0106")%></td>
		            <td class="data_td">
			        	<select name="DEPT_TYPE" id="DEPT_TYPE" class="input_re">
						<%  
						String country = ListBox(request, "SL0018",  info.getSession("HOUSE_CODE")+"#M216", "");
						out.println(country);
						%>
						</select>
			      </td>
			    ...
			    <tr>
		        	<td width="15%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;<%=text.get("DS_001.gongji_gubun")%></td>
		            <td class="data_td">
						<select name="GONGJI_GUBUN" id="GONGJI_GUBUN" class="input_re">
								<%  
								
									String gongji = ListBox(request, "SL0018",  info.getSession("HOUSE_CODE")+"#M222", "");
								     	out.println(gongji);
								%>
						</select>	
			      </td>
			    ...
			    <input type="hidden" name="pop_chk" id="pop_chk">
			    <input type="hidden" name="to_date" id="to_date">
			    <input type="hidden" name=COMPANY_CODE id="COMPANY_CODE" value="<%=info.getSession("COMPANY_CODE")%>">
			    <input type="hidden" name=GONGJI_GUBUN id="GONGJI_GUBUN" value="R">
			    <tr>
					<td colspan="4" height="1" bgcolor="#dedede"></td>
				</tr> 
                <tr>
		        	<td width="15%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;<%=text.get("DS_001.MSG_0103")%></td>
		            <td class="data_td">
						 <TABLE >
		      			<TR>
		      				<td>
	    ...
	    <table width="100%" border="0" cellpadding="0" cellspacing="0">
	      <tr align="center">
	 	 	 <td >
	 	 	 <textarea name="CONTENT" id="CONTENT" class="inputsubmit" cols="10" style="width:99%;height:100%" rows="30"></textarea>
	 	 	 </td>
	 	  </tr>
	    </table>
