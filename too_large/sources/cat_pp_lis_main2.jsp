...
<%
	...
	HashMap text               = null;
	String  screen_id          = "PR_013";
	String  grid_obj           = "GridObj";
	String  WISEHUB_PROCESS_ID = "PR_013";
	String  isSingle           = request.getParameter("isSingle");
	boolean isSelectScreen     = false;
	
	multilang_id.addElement("PR_013");
	...
	String LB_MATERIAL_TYPE = ListBox(request, "SL0518", info.getSession("HOUSE_CODE") + "#M040", "");
%>
<html>
<head>
...
function MATERIAL_TYPE_Changed() {
	...
	doRequestUsingPOST( 'SL0509', param ,'MATERIAL_CTRL_TYPE', '', false);	//false:동기, true:비동기모드
...
function MATERIAL_CTRL_TYPE_Changed()
{
    ...
    doRequestUsingPOST( 'SL0519', param ,'MATERIAL_CLASS1', '', false);
...
function MATERIAL_CLASS1_Changed()
{
    ...
    doRequestUsingPOST( 'SL0589', param ,'MATERIAL_CLASS2', '', false);
...
<%-- <s:grid screen_id="PR_013" grid_obj="GridObj" grid_box="gridbox"/> --%>
<s:footer/>
</body>
</html>