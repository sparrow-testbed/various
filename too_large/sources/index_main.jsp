...
var _login_gb;
//전자입찰
function os_select(event,login_gb)
{
	_login_gb = login_gb;
...
function open_idpwd()
{
	if(signform.rdoWin7.checked){
	    MM_openBrWindow("common/idpwd.jsp", "login_idpwd", "540", "400");
	}else{
		MM_openBrWindow("common/idpwd2.jsp", "login_idpwd", "540", "400");	
	}
}

function open_idpwd2()
{
	MM_openBrWindow("common/idpwd2.jsp", "login_idpwd", "440", "380");
...
{
	MM_openBrWindow("business_pic.jsp?lang=<%=browser_language%>", "business_pic", "450", "320");
}

function open_system_pic()
{
	MM_openBrWindow("system_pic.jsp?lang=<%=browser_language%>", "system_pic", "450", "320");
}

function find_id()
{
	//MM_openBrWindow("admin/find_and_confirm.jsp?lang=<%=browser_language%>", "system_pic", "600", "350");
	MM_openBrWindow("/kr/master/user/find_id.jsp?lang=<%=browser_language%>", "system_pic", "550", "580");
}
...
function open_popup1(edagGuidYn)
{
	if(edagGuidYn == 'N'){
		retrun;
	}
	var notice99 = getCookie("notice99");
	...
	if(notice99 != "no") {
	    ...
	    //document.getElementById("divPopup1").style.top = "0px";
	    //document.getElementById("divPopup1").style.left = "0px";
...
{	
	if( typeof(flag) != "undefined" && document.signform.chkClose1.checked ) {
		setCookie2("notice99", "no", 1);
	}
...
{
	var notice88 = getCookie("notice88");
...
{	
	if( typeof(flag) != "undefined" && document.signform.chkClose2.checked ) {
		setCookie2("notice88", "no", 1);
	}
...
<BODY topmargin="40" leftmargin="0" onload="javascript:open_popup1('<%=edagGuidYn%>');open_popup2();">
<!--//전자서명 start -->
...
function SignDataCMS_callback(aResult) {
    ...
    document.getElementById ("signform").signed_msg.value = aResult;
...
<form name="signform" id="signform"  method=post action='/common/sign_result.jsp'>
...
<input type="hidden" name='browser_language' id="browser_language" />
  ...
  <table width="1025" style="height:750px;" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="90" colspan="3" align="left" valign="bottom"><img src="/images/intro/logo.gif" width="364" height="45"></td>
    </tr>
    <tr>
      <td width="258" rowspan="2" valign="top"><table width="258" height="500" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="193" valign="top"><table width="258" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <%-- td align="left" valign="top" style="height:95px"><img src="/images/intro/btn_login_bidding.gif" width="122" height="79" border="0" onclick="javascript:os_select(event,1);"></td --%>
              <td align="left" valign="top" style="height:95px"><img src="/images/intro/btn_login_bidding.gif" width="122" height="79" border="0" onclick="javascript:MM_openBrWindow('common/idpwd2.jsp', 'login_idpwd', '540', '400');"></td>              
              <%-- td align="right" valign="top" style="height:95px"><img src="/images/intro/btn_login_procurement.gif" width="122" height="79" border="0" onclick="javascript:os_select(event,2);" --%>
              <td align="right" valign="top" style="height:95px"><img src="/images/intro/btn_login_procurement.gif" width="122" height="79" border="0" onclick="javascript:fnXecureLogin();">                           
        ...
        <tr>
          <td valign="top"><table width="258" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td height="84" align="left" valign="top"><a href="javascript:goRegister();"><img src="/images/intro/banner1.gif" width="126" height="77"  border="0"></a></td>
              <td align="right" valign="top"><a href="https://www.tradesign.net/ra/wooribank.jsp" target="blank"><img src="/images/intro/banner2.gif" width="126" height="77"  border="0"></a></td>
            </tr>
            <tr>
...
<div id="divOS" style="POSITION:absolute; WIDTH:320px; HEIGHT:200px; VISIBILITY:hidden; TOP:200px; LEFT:320px">
	<table style="BORDER-BOTTOM: black thin solid; BORDER-LEFT: black thin solid; BACKGROUND-COLOR: #ffffff; BORDER-TOP: black thin solid; BORDER-RIGHT: black thin solid">
		...
		<tr>
			...
			<td align="right">
				<script language="javascript">btn("javascript:target_login()"		, "선 택")	</script>				
			</td>
			<td align="left">
...
<div id="divPopup1" style="POSITION:absolute; WIDTH:910px; HEIGHT:750px; VISIBILITY:hidden; Z-INDEX:999999; BORDER-BOTTOM: black thin solid; BORDER-LEFT: black thin solid; BORDER-TOP: black thin solid; BORDER-RIGHT: black thin solid; ">
	...
	<div style="POSITION:absolute; WIDTH:910px; HEIGHT:710px; OVERFLOW:auto;">
		<table style="BACKGROUND-COLOR: #ffffff;" width="890px">
			...
			<tr>
			    <td align="middle">
					&nbsp;<span style="font-size:18px; color:red">반드시 </span> <span style="font-size:18px; font-weight:bold; color:red">[팝업차단 해제]</span><span style="font-size:18px; color:red"> 후 우리은행 전자구매시스템 이용 바랍니다.</span>								
				</td>				
			</tr>
			<tr>
			    <td align="middle">
...
<div id="divPopup2" style="POSITION:absolute; WIDTH:510px; HEIGHT:450px; VISIBILITY:hidden; Z-INDEX:999998; BORDER-BOTTOM: black thin solid; BORDER-LEFT: black thin solid; BORDER-TOP: black thin solid; BORDER-RIGHT: black thin solid; ">
	<table style="BACKGROUND-COLOR: #004C99; BORDER-BOTTOM: black thin solid;" width="510px" height="40px">
		<tr>
			<td align="middle" width="475px">
				<span style="font-size:16px; font-weight:bold; color:white">우리은행&nbsp;&nbsp;전자구매시스템&nbsp;&nbsp;이용안내</span>				
			</td>				
            <td align="right" width="35px">
	...
	<div style="POSITION:absolute; WIDTH:510px; HEIGHT:410px; OVERFLOW:auto;">
		<table style="BACKGROUND-COLOR: #ffffff;" width="510px">
			<tr>
				<td height="10px"></td>				
			</tr>
			<tr>
			...
			<tr>
				<td><span style="font-size:14px; font-weight:bold; color:black">
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;■ 아이디/패스워드 로그인	</span>						
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td><span style="font-size:14px; color:black">
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- 전자입찰,견적,실사 업무만 사용</span>
					</span>				
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td><span style="font-size:14px; font-weight:bold; color:black">
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;■ 공인인증서 로그인</span> <span style="font-size:13px; font-weight:bold; color:black">(</span><span style="font-size:13px; font-weight:bold; color:red">&quot;범용기업&quot;</span><span style="font-size:13px; font-weight:bold; color:black">만 사용가능)</span>				
				</td>
			</tr>
			<tr>
				<td height="5px"></td>
			...
			<tr>
				<td><span style="font-size:14px; color:black">
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- 전자입찰,견적,실사,전자계약,수주/납품,세금계산서 등<br> 
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;구매업무 전체 사용</span>							
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td><span style="font-size:15px; font-weight:bold; color:red">
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="manual.zip">☞ 전자구매 메뉴 접속방법 보기 (매뉴얼 다운로드)</a></span>				
				</td>
			</tr>			
			<tr>
				<td height="30px"></td>
