...
<%
	HashMap text = MessageUtil.getMessageMap( info, "MESSAGE", "BUTTON", "I_SBD_009" );
	
	String screen_id = "I_SBD_009";
    ...
    String ANN_COUNT     = request.getParameter("ANN_COUNT");   
    
    if(ANN_NO == null) ANN_NO ="";
    if(ANN_COUNT == null) ANN_COUNT ="";
	...
	mapData.put( "ANN_NO", ANN_NO );
	mapData.put( "ANN_COUNT", ANN_COUNT );
	
	Object[]    obj = { mapData };
	SepoaOut    so  = ServiceConnector.doService( info, "I_SBD_008", "CONNECTION", "getBDHeader", obj );
	SepoaFormater wf = new SepoaFormater( so.result[0] );
        ...
        so  = ServiceConnector.doService( info, "I_SBD_009", "CONNECTION", "getBDHD_VnInfo", obj );
...
var G_SERVLETURL   = "<%=POASRM_CONTEXT_NAME%>/servlets/ict.sepoa.svl.sourcing.bd_price_seller2_insert_ict";
...
//      var Message = "부가세 포함금액 "+AMT_VALUE+" 원 ("+AMT_VALUE_H+")으로 \n\n제출 하시겠습니까?";
    	...
    	$.post(
    		G_SERVLETURL,
    		{
    			...
    			ann_count      	: document.getElementById("ann_count").value,
    		...
    		function(arg){
    			...
    			if(result[1] == "true"){
    				alert(result[0]);
	    			location.href="bd_join_list_seller2_ict.jsp";
    			}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td width="15%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;공고명</td>
      <td width="35%" class="data_td">
        <%=ANN_ITEM%>
      </td>
    </tr>
    ...
    <tr>
      ...
      -->
      <td class="title_td" width="15%">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;제출서류</td>
      <td width="35%" class="data_td">      	
      	<pre><%=BID_JOIN_TEXT%> </pre>
      </td>      
      <td class="title_td" width="15%">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;공고 담당자</td>
      <td width="35%" class="data_td">
    ...
    <tr>
      <td class="title_td" width="15%">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;제출서류 첨부<img src='/images/mail_point.gif'' border='0'></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="15%" class="title_td">&nbsp;<img src="/images/blt_srch.gif" width="7" height="7" align="absmiddle">&nbsp;&nbsp;공고 담당자<img src='/images/mail_point.gif'' border='0'></td>
...
<table cellspacing="0" cellpadding="0"  style="display:none; WIDTH: 830px;BORDER-BOTTOM: black thin solid; BORDER-LEFT: black thin solid; BACKGROUND-COLOR: #ffffff; BORDER-TOP: black thin solid; BORDER-RIGHT: black thin solid" bordercolor="black">
<tr><td>
...
<table border="0" cellspacing="0" cellpadding="0" style="WIDTH: 830px"" bordercolor="black">
	<tr align="center">
		<td height="40">
			<input type="checkbox" id="chkOK1" name="chkOK1" checked class="input_data0"> <b>위의 내용에 동의합니다.</b>
...
<table border="0" cellspacing="0" cellpadding="0" style="WIDTH: 830px"" bordercolor="black">
	<tr align="center">
		<td height="40">
			<input type="checkbox" id="chkOK2" name="chkOK2" checked class="input_data0"> <b>위의 내용에 동의합니다.</b>
...
<table border="0" cellspacing="0" cellpadding="0" style="WIDTH: 830px"" bordercolor="black">
	<tr align="center">
		<td height="40">
			<input type="checkbox" id="chkOK3" name="chkOK3" checked class="input_data0"> <b>위의 내용에 동의합니다.</b>
...
<br>
<br>
<table width="100%" class="board-search" style="display:none;" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td>
...
<table width="98%" style="display:none;" border="0" cellspacing="0" cellpadding="0" >
    <tr>
      <td>
		<b>신청인 : <%=VENDOR_NAME%> </b>
      </td>
