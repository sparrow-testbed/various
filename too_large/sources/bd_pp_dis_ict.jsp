...
<%
	...
	multilang_id.addElement("I_BD_014_1");
	multilang_id.addElement("BUTTON");
	multilang_id.addElement("MESSAGE");
	
	HashMap text = MessageUtil.getMessage(info,multilang_id);
	
	String screen_id = "I_BD_014_1";
	String grid_obj  = "GridObj";
	boolean isSelectScreen = false;

	String WISEHUB_PROCESS_ID="I_BD_014_1";
...
function doSelect() {
	G_SERVLETURL   = "<%=POASRM_CONTEXT_NAME%>/servlets/ict.sepoa.svl.sourcing.bd_open_list_ict";
...
<s:grid screen_id="I_BD_014_1" grid_obj="GridObj" grid_box="gridbox"/>
<s:footer/>
</body>
</html>