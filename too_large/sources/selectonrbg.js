var __selectonrbg = function(__SANDBOX) {
...
XWC.getLocaleResource("selectonrbg", XWC.lang());

function onload(aDialogObj){
	gDialogObj = aDialogObj;
	gDialogParam = aDialogObj.args;

	XWC.UI.setDragAndDrop(__2);
	
	if (gDialogParam.exportEnable == false) {
		__9.disabled = true;
	}
	
	if (gDialogParam.importEnable == false) {
		__12.disabled = true;
	}
...
function onOKButtonClick(){
	...
	if (__9.checked == true) {
		aResult = "onExportAction";
	} else if (__12.checked == true) {
		aResult = "onImportAction";
	} else {
		alert(XWC.S.no_checked);
		return;
	}
...
var __6 = XWC.UI.createElement('FIELDSET');
__6.className = 'importexport';
var __7 = XWC.UI.createElement('LEGEND');
if (__SANDBOX.IEVersion == 8) {
__7.style.display = 'block';
}
__7.appendChild(document.createTextNode(XWC.S.desc));
__6.appendChild(__7);
var __8 = XWC.UI.createElement('DIV');
var __9 = XWC.UI.createElement('INPUT');
__9.setAttribute('tabindex', '4', 0);
if (__SANDBOX.IEVersion <= 8) {
__9.mergeAttributes(XWC.UI.createElement("<INPUT name='importexport'>"),false);
} else {
__9.setAttribute('name', 'importexport', 0);
}
__9.setAttribute('id', 'xwup_selectrbg_export', 0);
__9.setAttribute('type', 'radio', 0);
__8.appendChild(__9);
var __10 = XWC.UI.createElement('LABEL');
__10.htmlFor = 'xwup_selectrbg_export';
__10.appendChild(document.createTextNode(XWC.S.export_item));
__8.appendChild(__10);
__6.appendChild(__8);
var __11 = XWC.UI.createElement('DIV');
var __12 = XWC.UI.createElement('INPUT');
__12.setAttribute('tabindex', '4', 0);
if (__SANDBOX.IEVersion <= 8) {
__12.mergeAttributes(XWC.UI.createElement("<INPUT name='importexport'>"),false);
} else {
__12.setAttribute('name', 'importexport', 0);
}
__12.setAttribute('id', 'xwup_selectrbg_import', 0);
__12.setAttribute('type', 'radio', 0);
__11.appendChild(__12);
var __13 = XWC.UI.createElement('LABEL');
__13.htmlFor = 'xwup_selectrbg_import';
__13.appendChild(document.createTextNode(XWC.S.import_item));
__11.appendChild(__13);
__6.appendChild(__11);
__5.appendChild(__6);
__4.appendChild(__5);
var __14 = XWC.UI.createElement('DIV');
__14.className = 'xwup-buttons-layout';
var __15 = XWC.UI.createElement('BUTTON');
__15.setAttribute('tabindex', '4', 0);
__15.setAttribute('type', 'button', 0);
__15.setAttribute('id', 'xwup_ok', 0);
__15.onclick = function(event) {onOKButtonClick()};
__15.appendChild(document.createTextNode(XWC.S.button_ok));
__14.appendChild(__15);
var __16 = XWC.UI.createElement('BUTTON');
__16.setAttribute('tabindex', '4', 0);
__16.setAttribute('type', 'button', 0);
__16.setAttribute('id', 'xwup_cancel', 0);
__16.onclick = function(event) {onCancelButtonClick()};
__16.appendChild(document.createTextNode(XWC.S.button_cancel));
__14.appendChild(__16);
__4.appendChild(__14);
__1.appendChild(__4);
__1.onload = onload;
