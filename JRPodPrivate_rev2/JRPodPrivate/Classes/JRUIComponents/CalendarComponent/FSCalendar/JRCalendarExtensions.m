...
@implementation UIView (JRCalendarExtensions)
...
@implementation CALayer (JRCalendarExtensions)
...
@interface NSCalendar (JRCalendarExtensionsPrivate)

@property (readonly, nonatomic) NSDateComponents *fs_privateComponents;

@end

@implementation NSCalendar (JRCalendarExtensions)
...
@implementation NSMapTable (JRCalendarExtensions)
...
@implementation NSCache (JRCalendarExtensions)
...
@implementation NSObject (JRCalendarExtensions)
