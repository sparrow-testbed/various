...
@class JRCalendar, JRCalendarAppearance, JRCalendarEventIndicator;
 ...
 */
@property (weak, nonatomic) JRCalendarEventIndicator *eventIndicator;
...
@property (assign, nonatomic) JRCalendarMonthPosition monthPosition;
...
@interface JRCalendarEventIndicator : UIView
...
@interface JRCalendarBlankCell : UICollectionViewCell
